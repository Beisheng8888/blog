...
<p><img src="@source/基础框架/assets/image-20210804185234370.png" alt="image-20210804185234370"></p>
...
<p><img src="@source/基础框架/assets/image-20210804191218260.png" alt="image-20210804191218260"></p>
...
<p><img src="@source/基础框架/assets/image-20210804193122709.png" alt="image-20210804193122709"></p>
...
<p><img src="@source/基础框架/assets/image-20210804193327981.png" alt="image-20210804193327981"></p>
...
<p><img src="@source/基础框架/assets/image-20210804194952058.png" alt="img"></p>
...
<p><img src="@source/基础框架/assets/image-20210805150044862.png" alt="image-20210805150044862"></p>
...
<p><img src="@source/基础框架/assets/image-20210805150206831.png" alt="image-20210805150206831"></p>
<h5 id="_5-3-3-保存当前请求" tabindex="-1"><a class="header-anchor" href="#_5-3-3-保存当前请求" aria-hidden="true">#</a> 5.3.3 保存当前请求</h5>
<p><img src="@source/基础框架/assets/image-20210805150417692.png" alt="image-20210805150417692"></p>
<blockquote>
...
<p><img src="@source/基础框架/assets/image-20210805102858905.png" alt="image-20210805102858905"></p>
...
<p><img src="@source/基础框架/assets/image-20210805103041922.png" alt="image-20210805103041922"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//普通参数：请求参数与形参名称对应即可完成参数传递</span>
<span class="token annotation punctuation">@RequestMapping</span><span class="token punctuation">(</span><span class="token string">"/commonParam"</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@ResponseBody</span>
<span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">commonParam</span><span class="token punctuation">(</span><span class="token class-name">String</span> name <span class="token punctuation">,</span><span class="token keyword">int</span> age<span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<p><img src="@source/基础框架/assets/image-20210805104824258.png" alt="image-20210805104824258"></p>
...
<p><img src="@source/基础框架/assets/image-20210805105056731.png" alt="image-20210805105056731"></p>
...
<p><img src="@source/基础框架/assets/image-20210805105505625.png" alt="image-20210805105505625"></p>
...
<p><img src="@source/基础框架/assets/image-20210805105825688.png" alt="image-20210805105825688"></p>
...
<p><img src="@source/基础框架/assets/image-20210805105957957.png" alt="image-20210805105957957"></p>
...
<p><img src="@source/基础框架/assets/image-20210805110937684.png" alt="image-20210805110937684"></p>
<ol start="3">
...
<p><img src="@source/基础框架/assets/image-20210805111544701.png" alt="image-20210805111544701"></p>
...
<p><img src="@source/基础框架/assets/image-20210805111626095.png" alt="image-20210805111626095"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//集合参数：json格式</span>
<span class="token comment">//1.开启json数据格式的自动转换，在配置类中开启@EnableWebMvc</span>
...
<p><img src="@source/基础框架/assets/image-20210805113333189.png" alt="image-20210805113333189"></p>
...
<p><img src="@source/基础框架/assets/image-20210805120253164.png" alt="image-20210805120253164"></p>
...
<p><img src="@source/基础框架/assets/image-20210805132351738.png" alt="image-20210805132351738"></p>
<blockquote>
...
<p><img src="@source/基础框架/assets/image-20210805140535262.png" alt="image-20210805140535262"></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BookController</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/基础框架/assets/image-20210805140307371.png" alt="image-20210805140307371"></p>
