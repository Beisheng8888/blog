...
<p><img src="@source/基础框架/assets/image-20210811205020792.png" alt="image-20210811205020792"></p>
...
<p><img src="@source/基础框架/assets/image-20210811183922621.png" alt="image-20210811183922621"></p>
<p>②：选择当前模块需要使用的技术集</p>
<p><img src="@source/基础框架/assets/image-20210811183956586.png" alt="image-20210811183956586"></p>
<p>③：开发控制器类</p>
...
<p><img src="@source/基础框架/assets/image-20210811184126747.png" alt="image-20210811184126747"></p>
<ul>
...
<p><img src="@source/基础框架/assets/image-20210811184326884.png" alt="image-20210811184326884"></p>
...
<p><img src="@source/基础框架/assets/image-20210811184424903.png" alt="image-20210811184424903"></p>
...
<p>http://localhost:8080/books/1		&gt;&gt;&gt;		http://localhost/books/1</p>
...
<p>操作步骤：</p>
<p><img src="@source/基础框架/assets/image-20210811211456419.png" alt="image-20210811211456419"></p>
<p><img src="@source/基础框架/assets/image-20210811211507840.png" alt="image-20210811211507840"></p>
<p><img src="@source/基础框架/assets/image-20210811211516197.png" alt="image-20210811211516197"></p>
<p><img src="@source/基础框架/assets/image-20210811211525671.png" alt="image-20210811211525671"></p>
<p><img src="@source/基础框架/assets/image-20210811211548589.png" alt="image-20210811211548589"></p>
<p><img src="@source/基础框架/assets/image-20210811211556445.png" alt="image-20210811211556445"></p>
...
<p><img src="@source/基础框架/assets/image-20210811195722156.png" alt="image-20210811195722156"></p>
...
<p><img src="@source/基础框架/assets/image-20210811195801430.png" alt="image-20210811195801430"></p>
<ul>
<li>封装全部数据到Environment对象</li>
</ul>
<p><img src="@source/基础框架/assets/image-20210811195823054.png" alt="image-20210811195823054"></p>
<ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/基础框架/assets/image-20210811195844691.png" alt="image-20210811195844691"></p>
<ul>
<li>自定义对象封装数据警告解决方案</li>
</ul>
<p><img src="@source/基础框架/assets/image-20210815102251887.png" alt="image-20210815102251887"></p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>org.springframework.boot<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
...
<p><img src="@source/基础框架/assets/image-20210811195942997.png" alt="image-20210811195942997"></p>
<p><img src="@source/基础框架/assets/image-20210811200002937.png" alt="image-20210811200002937"></p>
<p><img src="@source/基础框架/assets/image-20210811200030710.png" alt="image-20210811200030710"></p>
<ul>
...
<p><img src="@source/基础框架/assets/image-20210811200354075.png" alt="image-20210811200354075"></p>
...
<p><img src="@source/基础框架/assets/image-20210811200516648.png" alt="image-20210811200516648"></p>
<p>③：执行Maven打包指令</p>
<ul>
<li>Maven指令执行完毕后，生成了对应的包，其中类参与编译，但是配置文件并没有编译，而是复制到包中</li>
</ul>
<p><img src="@source/基础框架/assets/image-20210811200646189.png" alt="image-20210811200646189"></p>
<ul>
...
<p><img src="@source/基础框架/assets/image-20210811200628431.png" alt="image-20210811200628431"></p>
...
<p><img src="@source/基础框架/assets/image-20210811200723514.png" alt="image-20210811200723514"></p>
...
<p><img src="@source/基础框架/assets/image-20210811200833143.png" alt="image-20210811200833143"></p>
...
<p>①：创建新模块，选择Spring初始化，并配置模块相关基础信息</p>
<p><img src="@source/基础框架/assets/image-20210811201314649.png" alt="image-20210811201314649"></p>
<p>②：选择当前模块需要使用的技术集（MyBatis、MySQL）</p>
<p><img src="@source/基础框架/assets/image-20210811201328652.png" alt="image-20210811201328652"></p>
<p>③：设置数据源参数</p>
