...
<p><img src="@source/JavaWeb/assets/image-20210724104749122.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724114548170.png" alt="img"></p>
<p>从上面的结果可以看到，字段 <code v-pre>id</code> 不能为null。那我们重新添加一条数据，如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">INSERT</span> <span class="token keyword">INTO</span> emp<span class="token punctuation">(</span>id<span class="token punctuation">,</span>ename<span class="token punctuation">,</span>joindate<span class="token punctuation">,</span>salary<span class="token punctuation">,</span>bonus<span class="token punctuation">)</span> <span class="token keyword">values</span><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span><span class="token string">'张三'</span><span class="token punctuation">,</span><span class="token string">'1999-11-11'</span><span class="token punctuation">,</span><span class="token number">8800</span><span class="token punctuation">,</span><span class="token number">5000</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>执行结果如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210724114805350.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724115024106.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724115149415.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724115336916.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724115547951.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724115826516.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724120904180.png" alt="img"></p>
...
<li>
<p>软件的研发步骤</p>
<p><img src="@source/JavaWeb/assets/image-20210724130925801.png" alt="img"></p>
</li>
<li>
<p>数据库设计概念</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724131210759.png" alt="img"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210724133015129.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724133443094.png" alt="img"></p>
</li>
</ul>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210724133704682.png" alt="img"></p>
</li>
</ul>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724134145803.png" alt="img"></p>
<p>经过分析发现，员工表属于多的一方，而部门表属于一的一方，此时我们会在员工表中添加一列（dep_id），指向于部门表的主键（id）：</p>
<p><img src="@source/JavaWeb/assets/image-20210724134318685.png" alt="img"></p>
<p>建表语句如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 删除表</span>
...
<p><img src="@source/JavaWeb/assets/image-20210724140456921.png" alt="img"></p>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724134735939.png" alt="img"></p>
<p>经过分析发现，订单表和商品表都属于多的一方，此时需要创建一个中间表，在中间表中添加订单表的外键和商品表的外键指向两张表的主键：</p>
<p><img src="@source/JavaWeb/assets/image-20210724135054834.png" alt="img"></p>
<p>建表语句如下：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 删除表</span>
...
<p><img src="@source/JavaWeb/assets/image-20210724140307910.png" alt="img"></p>
</li>
</ul>
<blockquote>
...
<p>唯一外键：==在任意一方加入外键，关联另一方主键，并且设置外键为唯一(UNIQUE)==</p>
</li>
<li>
<p>案例</p>
<p>我们以 <code v-pre>用户表</code> 举例：</p>
<p><img src="@source/JavaWeb/assets/image-20210724135346913.png" alt="img"></p>
<p>而在真正使用过程中发现 id、photo、nickname、age、gender 字段比较常用，此时就可以将这张表查分成两张表。</p>
</li>
</ul>
<p>​	<img src="@source/JavaWeb/assets/image-20210724135649341.png" alt="img"></p>
<p>​</p>
<p>​	建表语句如下：</p>
...
<p><img src="@source/JavaWeb/assets/image-20210724141445785.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724141822204.png" alt="img"></p>
<p>经过分析，我们分为 <code v-pre>专辑表</code>  <code v-pre>曲目表</code>  <code v-pre>短评表</code>  <code v-pre>用户表</code>   4张表。</p>
<p><img src="@source/JavaWeb/assets/image-20210724141550446.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724142550839.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724173630506.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724174212443.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724174717647.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724175344508.png" alt="img"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210724175518159.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724180103531.png" alt="img"></p>
</li>
</ul>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/image-20210724180542757.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724180613494.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724224955876.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724225537533.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210724230250263.png" alt="img"></p>
</li>
<li>
<p>添加事务sql如下：</p>
