...
<ul>
<li>
<p>会话:用户打开浏览器，访问web服务器的资源，会话建立，直到有一方断开连接，会话结束。在一次会话中可以包含==多次==请求和响应。</p>
<ul>
...
<p>思考:下图中总共建立了几个会话?</p>
<p><img src="@source/JavaWeb/assets/1629382713180.png" alt="1629382713180"></p>
<p>每个浏览器都会与服务端建立了一个会话，加起来总共是==3==个会话。</p>
</li>
<li>
<p>会话跟踪:一种维护浏览器状态的方法，服务器需要识别多次请求是否来自于同一浏览器，以便在同一次会话的多次请求间==共享数据==。</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/1629383655260.png" alt="1629383655260"></p>
</li>
<li>
<p>页面展示用户登录信息:很多网站，登录后访问多个功能发送多次请求后，浏览器上都会有当前登录用户的信息[用户名]，比如百度、京东、码云等。</p>
<p><img src="@source/JavaWeb/assets/1629383767654.png" alt="1629383767654"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/1629383921990.png" alt="1629383921990"></p>
</li>
<li>
<p>登录页面的验证码功能:生成验证码和输入验证码点击注册这也是两次请求，这两次请求的数据之间要进行对比，相同则允许注册，不同则拒绝注册，该功能的实现也需要在同一次会话中共享数据。</p>
<p><img src="@source/JavaWeb/assets/1629384004179.png" alt="1629384004179"></p>
</li>
</ul>
</li>
</ul>
...
<p>(1)客户端会话跟踪技术：==Cookie==</p>
<p>(2)服务端会话跟踪技术：==Session==</p>
...
<p><img src="@source/JavaWeb/assets/1629386230207.png" alt="1629386230207"></p>
<ul>
...
<p>对于Cookie的使用，我们更关注的应该是后台代码如何操作Cookie，对于Cookie的操作主要分两大类，本别是==发送Cookie==和==获取Cookie==,对于上面这两块内容，分别该如何实现呢?</p>
<p>3.1 发送Cookie</p>
<ul>
...
<p>方式一:</p>
<p><img src="@source/JavaWeb/assets/1629389317463.png" alt="1629389317463"></p>
<p>方式二:选中打开开发者工具或者 使用快捷键F12 或者 Ctrl+Shift+I</p>
<p><img src="@source/JavaWeb/assets/1629390237936.png" alt="1629390237936"></p>
<p>3.2 获取Cookie</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/1629391020081.png" alt="1629391020081"></p>
<p>在IDEA控制台就能看到输出的结果:</p>
<p><img src="@source/JavaWeb/assets/1629391061140.png" alt="1629391061140"></p>
<p>==思考:==测试的时候</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/1629393289338.png" alt="1629393289338"></p>
<ul>
...
<p>使用Chrom浏览器打开开发者工具(F12或Crtl+Shift+I)进行查看==响应头==中的数据</p>
<p><img src="@source/JavaWeb/assets/1629393428733.png" alt="1629393428733"></p>
<p>（2）访问BServlet对应的地址`http://localhost:8080/cookie-demo/bServlet</p>
<p>使用Chrom浏览器打开开发者工具(F12或Crtl+Shift+I)进行查看==请求头==中的数据</p>
<p><img src="@source/JavaWeb/assets/1629393578667.png" alt="1629393578667"></p>
...
<p>前面让大家思考过一个问题:</p>
<p><img src="@source/JavaWeb/assets/1629423321737.png" alt="1629423321737"></p>
...
<p>==注意：浏览器关闭再打开不是指打开一个新的选显卡，而且必须是先关闭再打开，顺序不能变。==</p>
...
<p><img src="@source/JavaWeb/assets/1629423629887.png" alt="1629423629887"></p>
...
<p>Cookie其实已经为我们提供好了对应的API来完成这件事，这个API就是==setMaxAge==,</p>
<ul>
<li>设置Cookie存活时间</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/1629424844041.png" alt="1629424844041"></p>
...
<p><img src="@source/JavaWeb/assets/1629425945465.png" alt="1629425945465"></p>
...
<p><img src="@source/JavaWeb/assets/1629427173389.png" alt="1629427173389"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/1629428292373.png" alt="1629428292373"></p>
...
<p>(1)前提条件</p>
<p><img src="@source/JavaWeb/assets/1629429063101.png" alt="1629429063101"></p>
...
<p><img src="@source/JavaWeb/assets/1629429239409.png" alt="1629429239409"></p>
<p>通过打印可以得到如下结论:</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/1629429788264.png" alt="1629429788264"></p>
...
<p><img src="@source/JavaWeb/assets/1629430754825.png" alt="1629430754825"></p>
...
<p><img src="@source/JavaWeb/assets/1629430891071.png" alt="1629430891071"></p>
<p>(2)使用chrome浏览器再次访问<code v-pre>http://localhost:8080/cookie-demo/demo2</code>，查看==请求头(Request Headers)==数据:</p>
<p><img src="@source/JavaWeb/assets/1629431299195.png" alt="1629431299195"></p>
<p><strong>小结</strong></p>
...
<p><img src="@source/JavaWeb/assets/1629438984314.png" alt="1629438984314"></p>
...
<p>==启动==:进入到项目pom.xml所在目录，执行<code v-pre>tomcat7:run</code></p>
<p><img src="@source/JavaWeb/assets/1629439800328.png" alt="1629439800328"></p>
<p>==停止==:在启动的命令行界面，输入<code v-pre>ctrl+c</code></p>
<p><img src="@source/JavaWeb/assets/1629439879596.png" alt="1629439879596"></p>
...
<p><img src="@source/JavaWeb/assets/1629440018238.png" alt="1629440018238"></p>
...
<p><img src="@source/JavaWeb/assets/1629440576828.png" alt="1629440576828"></p>
</li>
</ul>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/1629441687613.png" alt="1629441687613"></p>
</li>
</ul>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/1629441900843.png" alt="1629441900843"></p>
</li>
<li>
