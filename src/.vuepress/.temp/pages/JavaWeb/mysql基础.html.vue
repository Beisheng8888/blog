...
<p><img src="@source/JavaWeb/assets/image-20210721185923635.png" alt="image-20210721185923635"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721184354001.png" alt="image-20210721184354001"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721185303106.png" alt="image-20210721185303106"></p>
...
<p>点开上面的链接就能看到如下界面：</p>
<p><img src="@source/JavaWeb/assets/image-20210404200055449.png" alt="image-20210404200055449"></p>
...
<p><img src="@source/JavaWeb/assets/image-20201109134805641.png" alt="image-20201109134805641"></p>
...
<hr>
<p><img src="@source/JavaWeb/assets/image-20201109134948046.png" alt="image-20201109134948046"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/1556823-20181220222924783-57600848.png" alt="img"></p>
<ol start="2">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/1556823-20181220223025128-587235464.png" alt="img"></p>
<ol start="3">
...
<p><img src="@source/JavaWeb/assets/1556823-20181220220242472-524708778.png" alt="img"></p>
<p>点击<code v-pre>环境变量</code></p>
<p><img src="@source/JavaWeb/assets/1556823-20181220220359609-736422950.png" alt="img"></p>
<p>在<code v-pre>系统变量</code>中新建MYSQL_HOME</p>
<p><img src="@source/JavaWeb/assets/image-20201109140222488.png" alt="img"></p>
<p>在<code v-pre>系统变量</code>中找到并<strong>双击</strong><code v-pre>Path</code>
<img src="@source/JavaWeb/assets/1556823-20181220220551145-1198958872.png" alt="img"></p>
<p>点击<code v-pre>新建</code></p>
<p><img src="@source/JavaWeb/assets/image-20201109135248104.png" alt="img"></p>
<p>最后点击确定。</p>
...
<p><img src="@source/JavaWeb/assets/image-20201109142704951.png" alt="image-20201109142704951"></p>
<p><img src="@source/JavaWeb/assets/image-20201109142737584.png" alt="image-20201109142737584"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/image-20201109140955772.png" alt="image-20201109140955772"></p>
<p>tips：如果出现如下错误</p>
<p><img src="@source/JavaWeb/assets/image-20201109135848054.png" alt="image-20201109135848054"></p>
<p>是由于权限不足导致的，去<code v-pre>C:\Windows\System32</code> 下以管理员方式运行 cmd.exe</p>
<p><img src="@source/JavaWeb/assets/image-20201109140423691.png" alt="image-20201109140423691"></p>
<p><img src="@source/JavaWeb/assets/image-20201109140001186.png" alt="image-20201109140001186"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/image-20201109141325810.png" alt="image-20201109141325810"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/1556823-20181221093036851-1317238155.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/1556823-20181221093251250-819416425.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/JavaWeb/assets/1556823-20181220222422178-61579658.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721205130231.png" alt="image-20210721205130231"></p>
<p>接下来看关系型数据库的优点：</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210721212754568.png" alt="img"></p>
<p>如上图，我们通过客户端可以通过数据库管理系统创建数据库，在数据库中创建表，在表中添加数据。创建的每一个数据库对应到磁盘上都是一个文件夹。比如可以通过SQL语句创建一个数据库（数据库名称为db1），语句如下。该语句咱们后面会学习。</p>
<p><img src="@source/JavaWeb/assets/image-20210721213349761.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721214029913.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721215223872.png" alt="img"></p>
<p>如上，以分号结尾才是一个完整的sql语句。</p>
</li>
<li>
<p>MySQL 数据库的 SQL 语句不区分大小写，关键字建议使用大写。</p>
<p>同样的一条sql语句写成下图的样子，一样可以运行处结果。</p>
<p><img src="@source/JavaWeb/assets/image-20210721215328410.png" alt="img"></p>
</li>
<li>
<p>注释</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210721215517293.png" alt="img"></p>
<p><img src="@source/JavaWeb/assets/image-20210721215556885.png" alt="img"></p>
<blockquote>
...
<p><img src="@source/JavaWeb/assets/image-20210721220032047.png" alt="img"></p>
</li>
<li>
<p>DML(Data Manipulation Language) 数据操作语言，用来对数据库中表的数据进行增删改</p>
<p>DML简单理解就对表中数据进行增删改</p>
<p><img src="@source/JavaWeb/assets/image-20210721220132919.png" alt="img"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210721221107014.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721223450755.png" alt="img"></p>
<p>而在创建数据库的时候，我并不知道db1数据库有没有创建，直接再次创建名为db1的数据库就会出现错误。</p>
<p><img src="@source/JavaWeb/assets/image-20210721223745490.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721224056476.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721224435251.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721224720841.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721230202814.png" alt="image-20210721230202814"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210721230332428.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721230824097.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721231142326.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721235108267.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210721235928346.png" alt="img"></p>
<p>第二步：填写连接数据库必要的信息</p>
<p><img src="@source/JavaWeb/assets/image-20210722000116080.png" alt="img"></p>
<p>以上操作没有问题就会出现如下图所示界面：</p>
<p><img src="@source/JavaWeb/assets/image-20210722000345349.png" alt="img"></p>
<h4 id="_6-3-2-操作" tabindex="-1"><a class="header-anchor" href="#_6-3-2-操作" aria-hidden="true">#</a> 6.3.2  操作</h4>
<p>连接成功后就能看到如下图界面：</p>
<p><img src="@source/JavaWeb/assets/image-20210722000521997.png" alt="img"></p>
<ul>
<li><strong>修改表结构</strong></li>
</ul>
<p>通过下图操作修改表结构：</p>
<p><img src="@source/JavaWeb/assets/image-20210722000740661.png" alt="img"></p>
<p>点击了设计表后即出现如下图所示界面，在图中红框中直接修改字段名，类型等信息：</p>
<p><img src="@source/JavaWeb/assets/image-20210722000929075.png" alt="img"></p>
<ul>
<li><strong>编写SQL语句并执行</strong></li>
</ul>
<p>按照如下图所示进行操作即可书写SQL语句并执行sql语句。</p>
<p><img src="@source/JavaWeb/assets/image-20210722001333817.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210722204233305.png" alt="image-20210722204233305"></p>
</li>
</ul>
</li>
</ul>
...
<p>下面是展示试题库数据的页面</p>
<p><img src="@source/JavaWeb/assets/image-20210722215838144.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210722220139174.png" alt="image-20210722220139174"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210722221534870.png" alt="img"></p>
</li>
<li>
<p>查询地址信息</p>
...
<p><img src="@source/JavaWeb/assets/image-20210722221756380.png" alt="image-20210722221756380"></p>
...
<p>条件列表可以使用以下运算符</p>
<p><img src="@source/JavaWeb/assets/image-20210722190508272.png" alt="img"></p>
...
<p>如何理解呢？假设有如下表</p>
<p><img src="@source/JavaWeb/assets/image-20210722194410628.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210722230330366.png" alt="img"></p>
<p>接下来我们先说分页查询的语法。</p>
