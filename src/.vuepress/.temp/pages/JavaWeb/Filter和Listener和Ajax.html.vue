...
<p><img src="@source/JavaWeb/assets/image-20210823184519509.png" alt="img"></p>
<p>而在访问到这些资源之前可以使过滤器拦截来下，也就是说在访问资源之前会先经过 Filter，如下图</p>
<p><img src="@source/JavaWeb/assets/image-20210823184657328.png" alt="img"></p>
<p>拦截器拦截到后可以做什么功能呢？</p>
...
<p><img src="@source/JavaWeb/assets/image-20210823185720197.png" alt="img"></p>
<p>当我点击该按钮，居然可以看到品牌的数据</p>
<p><img src="@source/JavaWeb/assets/image-20210823185932418.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823191006878.png" alt="img"></p>
</li>
<li>
<p>配置Filter拦截资源的路径：在类上定义 <code v-pre>@WebFilter</code> 注解。而注解的 <code v-pre>value</code> 属性值 <code v-pre>/*</code> 表示拦截所有的资源</p>
<p><img src="@source/JavaWeb/assets/image-20210823191037163.png" alt="img"></p>
</li>
<li>
<p>在doFilter方法中输出一句话，并放行</p>
<p><img src="@source/JavaWeb/assets/image-20210823191200201.png" alt="img"></p>
<blockquote>
...
<p><img src="@source/JavaWeb/assets/image-20210823191855765.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823192353031.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823193759365.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823194830074.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823195434581.png" alt="img"></p>
<p>接下来我们通过代码验证一下，在 <code v-pre>doFilter()</code> 方法前后都加上输出语句，如下</p>
<p><img src="@source/JavaWeb/assets/image-20210823195828596.png" alt="img"></p>
<p>同时在 <code v-pre>hello.jsp</code> 页面加上输出语句，如下</p>
<p><img src="@source/JavaWeb/assets/image-20210823200028284.png" alt="img"></p>
<p>执行访问该资源打印的顺序是按照我们标记的标号进行打印的话，说明我们上边总结出来的流程是没有问题的。启动服务器访问 <code v-pre>hello.jsp</code> 页面，在控制台打印的内容如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210823200202153.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823215835812.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823221222468.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20211222103050565.png" alt="img"></p>
</blockquote>
<p>责任链设计模式：</p>
<p>优点：</p>
<p>各个节点互相独立，解耦性强。</p>
...
<p><img src="@source/JavaWeb/assets/image-20210823223214525.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823224843179.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823225411925.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823230820586.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823235114367.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210823235006847.png" alt="img"></p>
<ol start="2">
<li><strong>异步交互</strong>：可以在==不重新加载整个页面==的情况下，与服务器交换数据并==更新部分网页==的技术，如：搜索联想、用户名是否可用校验，等等…</li>
</ol>
<p><img src="@source/JavaWeb/assets/image-20210824000706401.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210824001015706.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210824001443897.png" alt="img"></p>
<p>​	浏览器页面在发送请求给服务器，在服务器处理请求的过程中，浏览器页面不能做其他的操作。只能等到服务器响应结束后才能，浏览器页面才能继续做其他的操作。</p>
<ul>
<li>
<p>异步发送请求过程如下</p>
<p><img src="@source/JavaWeb/assets/image-20210824001608916.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210824005956117.png" alt="img"></p>
<p>我们可以通过 <code v-pre>开发者模式</code> 查看发送的 AJAX 请求。在浏览器上按 <code v-pre>F12</code> 快捷键</p>
<p><img src="@source/JavaWeb/assets/image-20210824010247642.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210824010438260.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210824201415745.png" alt="img"></p>
...
<p>整体流程如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210829183854285.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210830232718632.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210831223339530.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210831104901912.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210830234803335.png" alt="img"></p>
<h3 id="_6-2-查询所有功能" tabindex="-1"><a class="header-anchor" href="#_6-2-查询所有功能" aria-hidden="true">#</a> 6.2  查询所有功能</h3>
<p><img src="@source/JavaWeb/assets/image-20210831085332612.png" alt="image-20210831085332612"></p>
<p>如上图所示就该功能的整体流程。前后端需以 JSON 格式进行数据的传递；由于此功能是查询所有的功能，前端发送 ajax 请求不需要携带参数，而后端响应数据需以如下格式的 json 数据</p>
<p><img src="@source/JavaWeb/assets/image-20210831090839336.png" alt="image-20210831090839336"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210831091604457.png" alt="img"></p>
<p>==注意：==</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210831093617083.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210831093938057.png" alt="img">
...
<p><img src="@source/JavaWeb/assets/image-20210831100117014.png" alt="image-20210831100117014"></p>
...
<p>具体的前后端交互的流程如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210831100329698.png" alt="image-20210831100329698"></p>
<p>==说明：==</p>
<p>前端需要将用户输入的数据提交到后端，这部分数据需要以 json 格式进行提交，数据格式如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210831101234467.png" alt="image-20210831101234467"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210831103843798.png" alt="img"></p>
