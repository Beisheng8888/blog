<template><div><h1 id="maven-mybatis" tabindex="-1"><a class="header-anchor" href="#maven-mybatis" aria-hidden="true">#</a> Maven&amp;MyBatis</h1>
...
<p>项目结构我们都知道，每一个开发工具（IDE）都有自己不同的项目结构，它们互相之间不通用。我再eclipse中创建的目录，无法在idea中进行使用，这就造成了很大的不方便，如下图:
前两个是以后开发经常使用的开发工具</p>
<p><img src="@source/JavaWeb/assets/image-20210726153521381.png" alt="img"></p>
<p>而Maven提供了一套标准化的项目结构，所有的IDE使用Maven构建的项目完全一样，所以IDE创建的Maven项目可以通用。如下图右边就是Maven构建的项目结构。</p>
<p><img src="@source/JavaWeb/assets/image-20210726153815028.png" alt="img"></p>
<p><strong>标准化的构建流程：</strong></p>
<p><img src="@source/JavaWeb/assets/image-20210726154144488.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726154753631.png" alt="img"></p>
<p>而Maven使用标准的 ==坐标== 配置来管理各种依赖，只需要简单的配置就可以完成依赖管理。</p>
<p><img src="@source/JavaWeb/assets/image-20210726154922337.png" alt="img"></p>
<p>如上图右边所示就是mysql驱动包的坐标，在项目中只需要写这段配置，其他都不需要我们担心，Maven都帮我们进行操作了。</p>
<p>市面上有很多构建工具，而Maven依旧还是主流构建工具，如下图是常用构建工具的使用占比</p>
<p><img src="@source/JavaWeb/assets/image-20210726155212733.png" alt="image-20210726155212733"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726155759621.png" alt="img"></p>
<p>如上图所示就是Maven的模型，而我们先看紫色框框起来的部分，他就是用来完成 <code v-pre>标准化构建流程</code>
。如我们需要编译，Maven提供了一个编译插件供我们使用，我们需要打包，Maven就提供了一个打包插件提供我们使用等。</p>
<p><img src="@source/JavaWeb/assets/image-20210726160928515.png" alt="img"></p>
<p>上图中紫色框起来的部分，项目对象模型就是将我们自己抽象成一个对象模型，有自己专属的坐标，如下图所示是一个Maven项目：</p>
<p><img src="@source/JavaWeb/assets/image-20210726161340796.png" alt="img"></p>
<p>依赖管理模型则是使用坐标来描述当前项目依赖哪儿些第三方jar包，如下图所示</p>
<p><img src="@source/JavaWeb/assets/image-20210726161616034.png" alt="image-20210726161616034"></p>
...
<ul>
<li>地址： https://repo1.maven.org/maven2/</li>
</ul>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210726162605394.png" alt="img"></p>
<p>如果还可以搭建远程仓库，将来jar包的查找顺序则变为：</p>
<blockquote>
<p>本地仓库 --&gt; 远程仓库--&gt; 中央仓库</p>
</blockquote>
<p><img src="@source/JavaWeb/assets/image-20210726162815045.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726163219682.png" alt="img"></p>
<blockquote>
<p>建议解压缩到没有中文、特殊字符的路径下。如中解压缩到 <code v-pre>D:\software</code> 下。</p>
</blockquote>
<p>解压缩后的目录结构如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210726163518885.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210726164058589.png" alt="img"></p>
<p>在 <code v-pre>Path</code> 中进行配置</p>
<p><img src="@source/JavaWeb/assets/image-20210726164146832.png" alt="img"></p>
<p>打开命令提示符进行验证，出现如图所示表示安装成功</p>
<p><img src="@source/JavaWeb/assets/image-20210726164306480.png" alt="img"></p>
</li>
<li>
<p>配置本地仓库</p>
<p>修改 conf/settings.xml 中的 <code v-pre>&lt;localRepository&gt;</code> 为一个指定目录作为本地仓库，用来存储jar包。</p>
<p><img src="@source/JavaWeb/assets/image-20210726164348048.png" alt="img"></p>
</li>
<li>
<p>配置阿里云私服</p>
<p>中央仓库在国外，所以下载jar包速度可能比较慢，而阿里公司提供了一个远程仓库，里面基本也都有开源项目的jar包。</p>
<p>修改 conf/settings.xml 中的 <code v-pre>&lt;mirrors&gt;</code>标签，为其添加如下子标签：</p>
...
<p><img src="@source/JavaWeb/assets/image-20210726170404545.png" alt="img"></p>
<p>而我们使用上面命令需要在磁盘上进入到项目的 <code v-pre>pom.xml</code> 目录下，打开命令提示符</p>
<p><img src="@source/JavaWeb/assets/image-20210726170549907.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726171047324.png" alt="img"></p>
<p>同时在项目下会出现一个 <code v-pre>target</code> 目录，编译后的字节码文件就放在该目录下</p>
<p><img src="@source/JavaWeb/assets/image-20210726171346824.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726171558786.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726171747125.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726172343933.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726172709112.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726173153576.png" alt="img"></p>
<p>当我们执行 <code v-pre>install</code>（安装）命令时，它会先执行 <code v-pre>compile</code>命令，再执行 <code v-pre>test </code> 命令，再执行 <code v-pre>package</code> 命令，最后执行 <code v-pre>install</code>
命令。</p>
...
<p><img src="@source/JavaWeb/assets/image-20210726173619353.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726174202898.png" alt="img"></p>
</li>
<li>
<p>搜索 maven</p>
<p><img src="@source/JavaWeb/assets/image-20210726174229396.png" alt="img"></p>
</li>
<li>
<p>设置 IDEA 使用本地安装的 Maven，并修改配置文件路径</p>
<p><img src="@source/JavaWeb/assets/image-20210726174248050.png" alt="img"></p>
</li>
</ul>
...
<p>如下图就是使用坐标表示一个项目：</p>
<p><img src="@source/JavaWeb/assets/image-20210726174718176.png" alt="image-20210726174718176"></p>
<blockquote>
<p>==注意：==</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210726175049876.png" alt="img"></p>
</li>
<li>
<p>填写模块名称，坐标信息，点击finish，创建完成</p>
<p><img src="@source/JavaWeb/assets/image-20210726175109822.png" alt="img"></p>
<p>创建好的项目目录结构如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210726175244826.png" alt="image-20210726175244826"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210726182702336.png" alt="img"></p>
</li>
<li>
<p>选中对应项目的pom.xml文件，双击即可</p>
<p><img src="@source/JavaWeb/assets/image-20210726182648891.png" alt="img"></p>
</li>
<li>
<p>如果没有Maven面板，选择</p>
<p>View --&gt; Appearance --&gt; Tool Window Bars</p>
<p><img src="@source/JavaWeb/assets/image-20210726182634466.png" alt="img"></p>
</li>
</ul>
<p>可以通过下图所示进行命令的操作：</p>
<p><img src="@source/JavaWeb/assets/image-20210726182902961.png" alt="img"></p>
<p><strong>配置 Maven-Helper 插件</strong></p>
<ul>
<li>
<p>选择 IDEA中 File --&gt; Settings</p>
<p><img src="@source/JavaWeb/assets/image-20210726192212026.png" alt="img"></p>
</li>
<li>
<p>选择 Plugins</p>
<p><img src="@source/JavaWeb/assets/image-20210726192224914.png" alt="img"></p>
</li>
<li>
<p>搜索 Maven，选择第一个 Maven Helper，点击Install安装，弹出面板中点击Accept</p>
<p><img src="@source/JavaWeb/assets/image-20210726192244567.png" alt="img"></p>
</li>
<li>
<p>重启 IDEA</p>
</li>
...
<p><img src="@source/JavaWeb/assets/image-20210726192430371.png" alt="img"></p>
...
<ul>
<li>
<p>在项目的 pom.xml 中编写 <code v-pre>&lt;dependencies&gt;</code> 标签</p>
</li>
<li>
<p>在 <code v-pre>&lt;dependencies&gt;</code> 标签中 使用 <code v-pre>&lt;dependency&gt;</code> 引入坐标</p>
</li>
<li>
<p>定义坐标的 groupId，artifactId，version</p>
<p><img src="@source/JavaWeb/assets/image-20210726193105765.png" alt="img"></p>
</li>
<li>
<p>点击刷新按钮，使坐标生效</p>
<p><img src="@source/JavaWeb/assets/image-20210726193121384.png" alt="img"></p>
</li>
</ul>
<blockquote>
<p>注意：</p>
...
<p><img src="@source/JavaWeb/assets/image-20210726193603724.png" alt="img"></p>
</li>
<li>
<p>在弹出的面板中搜索对应坐标，然后双击选中对应坐标</p>
<p><img src="@source/JavaWeb/assets/image-20210726193625229.png" alt="img"></p>
</li>
<li>
<p>点击刷新按钮，使坐标生效</p>
<p><img src="@source/JavaWeb/assets/image-20210726193121384.png" alt="img"></p>
...
<li>
<p>选择 IDEA中 File --&gt; Settings</p>
<p><img src="@source/JavaWeb/assets/image-20210726193854438.png" alt="img"></p>
</li>
<li>
<p>在弹出的面板中找到 Build Tools</p>
<p><img src="@source/JavaWeb/assets/image-20210726193909276.png" alt="img"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210726194703845.png" alt="img"></p>
...
<li>
<p>MyBatis 本是 Apache 的一个开源项目iBatis, 2010年这个项目由apache software foundation 迁移到了google
...
<p><img src="@source/JavaWeb/assets/image-20210726202410311.png" alt="img"></p>
<p>如下图所示有一个石膏娃娃，这个就是一个半成品。你可以在这个半成品的基础上进行不同颜色的涂鸦</p>
<p><img src="@source/JavaWeb/assets/image-20210726202858441.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726203656847.png" alt="img"></p>
<ul>
<li>
<p>硬编码</p>
<ul>
...
<p>如图所示</p>
<p><img src="@source/JavaWeb/assets/image-20210726204849309.png" alt="img"></p>
<p>下图是持久层框架的使用占比。</p>
<p><img src="@source/JavaWeb/assets/image-20210726205328999.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726212621722.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210726213046072.png" alt="img"></p>
</li>
<li>
<p>在弹出的界面进行基本信息的填写</p>
<p><img src="@source/JavaWeb/assets/image-20210726213305893.png" alt="img"></p>
</li>
<li>
<p>点击完成后就能看到如下界面</p>
<p><img src="@source/JavaWeb/assets/image-20210726213541418.png" alt="img"></p>
<p>而此界面就和 <code v-pre>navicat</code> 工具一样可以进行数据库的操作。也可以编写SQL语句</p>
</li>
</ul>
<p><img src="@source/JavaWeb/assets/image-20210726213857620.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726214648112.png" alt="img"></p>
<p>这里调用 <code v-pre>selectList()</code> 方法传递的参数是映射配置文件中的 namespace.id值。这样写也不便于后期的维护。如果使用 Mapper
代理方式（如下图）则不存在硬编码问题。</p>
<p><img src="@source/JavaWeb/assets/image-20210726214636108.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726215339568.png" alt="image-20210726215339568"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210726215946951.png" alt="img"></p>
</li>
<li>
<p>设置SQL映射文件的namespace属性为Mapper接口全限定名</p>
<p><img src="@source/JavaWeb/assets/image-20210726220053883.png" alt="img"></p>
</li>
<li>
<p>在 Mapper 接口中定义方法，方法名就是SQL映射文件中sql语句的id，并保持参数类型和返回值类型一致</p>
<p><img src="@source/JavaWeb/assets/image-20210726223216517.png" alt="img"></p>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/image-20210726221454927.png" alt="img"></p>
...
<p>在核心配置文件的 <code v-pre>environments</code> 标签中其实是可以配置多个 <code v-pre>environment</code> ，使用 <code v-pre>id</code> 给每段环境起名，在 <code v-pre>environments</code>
...
<p>在映射配置文件中的 <code v-pre>resultType</code> 属性需要配置数据封装的类型（类的全限定名）。而每次这样写是特别麻烦的，Mybatis
