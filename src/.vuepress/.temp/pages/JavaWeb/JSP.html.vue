...
<p><img src="@source/JavaWeb/assets/image-20210818102205544.png" alt="img"></p>
<p>输入了 <code v-pre>zhangsan</code> 用户的登陆信息后点击 <code v-pre>登陆</code> 按钮，就能看到如下图效果</p>
<p><img src="@source/JavaWeb/assets/image-20210818102313898.png" alt="image-20210818102313898"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818102506754.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818103127245.png" alt="img"></p>
<p>重新启动服务器并进行测试，发现也可以实现同样的功能。那么 <code v-pre>login.jsp</code> 又是如何实现的呢？那我们来看看 <code v-pre>login.jsp</code> 的代码</p>
<p><img src="@source/JavaWeb/assets/image-20210818103352432.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818104316457.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818105519970.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818110122438.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818111039350.png" alt="img"></p>
<ol>
...
<p><img src="@source/JavaWeb/assets/image-20210818112613589.png" alt="img"></p>
<p>打开 <code v-pre>hello_jsp.java</code> 文件，来查看里面的代码</p>
<p><img src="@source/JavaWeb/assets/image-20210818112724462.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818113118802.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818114008998.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818123606231.png" alt="img"></p>
<p>在 <code v-pre>hello.jsp</code> 中书写</p>
...
<p><img src="@source/JavaWeb/assets/image-20210818123820571.png" alt="img"></p>
<p>在 <code v-pre>hello.jsp</code> 中书写</p>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%!
    void  show(){}
...
<p><img src="@source/JavaWeb/assets/image-20210818123946272.png" alt="img"></p>
...
<p>使用JSP脚本展示品牌数据</p>
<p><img src="@source/JavaWeb/assets/image-20210818125203390.png" alt="img"></p>
<p>说明：</p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210818145450748.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818150346332.png" alt="img"></p>
<ol>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210818151232955.png" alt="img"></p>
</li>
<li>
...
<p><img src="@source/JavaWeb/assets/image-20210818152536484.png" alt="img"></p>
</li>
</ul>
...
<p><img src="@source/JavaWeb/assets/image-20210818152857407.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818153646575.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818163348642.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818164301154.png" alt="img"></p>
<ul>
...
<p><img src="@source/JavaWeb/assets/image-20210818165439826.png" alt="img"></p>
<blockquote>
<p>职责单一原则</p>
</blockquote>
...
<p><img src="@source/JavaWeb/assets/image-20210818165808589.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818171702401.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818173155335.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818174441917.png" alt="image-20210818174441917"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818174800783.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210818182952394.png" alt="image-20210818182952394"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210819190221889.png" alt="image-20210819190221889"></p>
<h3 id="_8-3-添加" tabindex="-1"><a class="header-anchor" href="#_8-3-添加" aria-hidden="true">#</a> 8.3  添加</h3>
<p><img src="@source/JavaWeb/assets/image-20210819192049571.png" alt="image-20210819192049571"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210819192737982.png" alt="image-20210819192737982"></p>
<p>接下来我们根据流程来实现功能：</p>
...
<p><img src="@source/JavaWeb/assets/image-20210819220701121.png" alt="img"></p>
<p>点击 <code v-pre>提交</code> 按钮，就能看到如下页面，里面就包含我们刚添加的数据</p>
<p><img src="@source/JavaWeb/assets/image-20210819220738074.png" alt="image-20210819220738074"></p>
<h3 id="_8-4-修改" tabindex="-1"><a class="header-anchor" href="#_8-4-修改" aria-hidden="true">#</a> 8.4  修改</h3>
<p><img src="@source/JavaWeb/assets/image-20210819223202473.png" alt="image-20210819223202473"></p>
<p>点击每条数据后面的 <code v-pre>编辑</code> 按钮会跳转到修改页面，如下图：</p>
<p><img src="@source/JavaWeb/assets/image-20210819223314230.png" alt="image-20210819223314230"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210819223830713.png" alt="image-20210819223830713"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210819224243778.png" alt="img"></p>
...
<p><img src="@source/JavaWeb/assets/image-20210819225948187.png" alt="image-20210819225948187"></p>
<p>在修改页面进行数据修改，点击 <code v-pre>提交</code> 按钮，会将数据提交到后端程序，后端程序会对表中的数据进行修改操作，然后重新进行数据的查询操作。整体流程如下：</p>
<p><img src="@source/JavaWeb/assets/image-20210819230242938.png" alt="img"></p>
