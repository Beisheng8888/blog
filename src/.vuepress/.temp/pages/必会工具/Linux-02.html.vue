...
<p>上述我们介绍了Linux系统软件安装的四种形式，接下来我们就通过第一种(二进制发布包)形式来安装JDK。 JDK对应的二进制发布包，在资料中已经提供，如下：<img src="@source/必会工具/assets/image-20210814174022881.png" alt="image-20210814174022881"></p>
<p>JDK具体安装步骤如下：</p>
<p><strong>1). 上传安装包</strong></p>
<p>使用FinalShell自带的上传工具将jdk的二进制发布包上传到Linux</p>
<p><img src="@source/必会工具/assets/image-20210814180303278.png" alt="image-20210814180303278"></p>
<p>由于上述在进行文件上传时，选择的上传目录为根目录 /，上传完毕后，我们执行指令 cd / 切换到根目录下，查看上传的安装包。</p>
<p><img src="@source/必会工具/assets/image-20210814180702071.png" alt="image-20210814180702071"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210814181014481.png" alt="image-20210814181014481"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210814182327675.png" alt="image-20210814182327675"></p>
...
<p><img src="@source/必会工具/assets/image-20210814222911649.png" alt="image-20210814222911649"></p>
<p>具体安装步骤如下：</p>
<p><strong>1). 上传安装包</strong></p>
<p>使用FinalShell自带的上传工具将Tomcat的二进制发布包上传到Linux(与前面上传JDK安装包步骤一致)。</p>
<p><img src="@source/必会工具/assets/image-20210814223436296.png" alt="image-20210814223436296"></p>
<p><strong>2). 解压安装包</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210814223807228.png" alt="img"></p>
<p><img src="@source/必会工具/assets/image-20210814223959266.png" alt="image-20210814223959266"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210814225635982.png" alt="image-20210814225635982"></p>
...
<p><img src="@source/必会工具/assets/image-20210814230753600.png" alt="image-20210814230753600"></p>
...
<p><img src="@source/必会工具/assets/image-20210814232643393.png" alt="image-20210814232643393"></p>
...
<p><img src="@source/必会工具/assets/image-20210814235615330.png" alt="image-20210814235615330"></p>
...
<p><img src="@source/必会工具/assets/image-20210814235926088.png" alt="image-20210814235926088"></p>
...
<p><img src="@source/必会工具/assets/image-20210815002209121.png" alt="image-20210815002209121"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815002649784.png" alt="image-20210815002649784"></p>
...
<p><img src="@source/必会工具/assets/image-20210815002907050.png" alt="image-20210815002907050"></p>
<p><img src="@source/必会工具/assets/image-20210815003107734.png" alt="image-20210815003107734"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815003647507.png" alt="image-20210815003647507"></p>
...
<p><img src="@source/必会工具/assets/image-20210815004608198.png" alt="image-20210815004608198"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815005920721.png" alt="image-20210815005920721"></p>
<blockquote>
<p>说明：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815010410996.png" alt="image-20210815010410996"></p>
<blockquote>
...
<p><img src="@source/必会工具/assets/image-20210815011744113.png" alt="image-20210815011744113"></p>
...
<p><img src="@source/必会工具/assets/image-20210815011938287.png" alt="image-20210815011938287"></p>
...
<p><img src="@source/必会工具/assets/image-20210815012902871.png" alt="image-20210815012902871"></p>
<p>当然我们也可以使用安装在windows系统中的sqlyog或者Navicat来远程连接linux上的MySQL。</p>
<p><img src="@source/必会工具/assets/image-20210815013909486.png" alt="img"></p>
...
firewall-cmd --reload
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815014120709.png" alt="image-20210815014120709"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815014811466.png" alt="image-20210815014811466"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815014907816.png" alt="image-20210815014907816"></p>
<p><strong>3). 测试</strong></p>
<p>在命令行中输入 rz , 就会自动打开一个文件选择的窗口，然后选择要上传的文件。</p>
<p><img src="@source/必会工具/assets/image-20210815015047896.png" alt="image-20210815015047896"></p>
<blockquote>
<p><strong>yum拓展知识:</strong></p>
<p>​	 1). 如果在不更改软件来源的情况下，是需要联网才能使用yum的，那么我们安装的软件是从哪儿下载的呢，这里就涉及到一个概念： yum源。</p>
<p>​</p>
<p>​	 2). 我们可以通过一个指令，来检查当前的yum源</p>
<p>​		<img src="@source/必会工具/assets/image-20210816192200749.png" alt="img"></p>
<p>​		从图中，我们可以看到我们安装的 CentOS7 采用的是网易的163yum源。</p>
<p>​</p>
<p>​	  3). 网络 yum 源配置文件位于 /etc/yum.repos.d/ 目录下，文件扩展名为&quot;*.repo&quot;</p>
<p>​		<img src="@source/必会工具/assets/image-20210816193941094.png" alt="img"></p>
...
<p>​			yum makecache</p>
<p>​		E. 再次查看yum源</p>
<p>​			<img src="@source/必会工具/assets/image-20210816214230609.png" alt="img"></p>
...
<p><img src="@source/必会工具/assets/image-20210815102934678.png" alt="image-20210815102934678"></p>
<p>可以在本地的idea中先启动当前的demo工程，然后访问一下，看看工程是否正常访问。</p>
<p><img src="@source/必会工具/assets/image-20210815103130325.png" alt="image-20210815103130325"></p>
<p>执行package指令，进行打包操作，将当前的springboot项目，打成一个jar包。</p>
<p><img src="@source/必会工具/assets/image-20210815103344378.png" alt="image-20210815103344378"></p>
...
C. 执行指令,进行jar包上传
rz
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815131101930.png" alt="image-20210815131101930"></p>
<p>此时这个jar包就上传到 /usr/local/app 目录了。</p>
<p><img src="@source/必会工具/assets/image-20210815131234243.png" alt="image-20210815131234243"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815131812582.png" alt="image-20210815131812582"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815132430385.png" alt="image-20210815132430385"></p>
...
<p><img src="@source/必会工具/assets/image-20210815132748655.png" alt="image-20210815132748655"></p>
...
<p><img src="@source/必会工具/assets/image-20210815133510405.png" alt="image-20210815133510405"></p>
<p><img src="@source/必会工具/assets/image-20210815133719642.png" alt="image-20210815133719642"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815140847083.png" alt="image-20210815140847083"></p>
<p>这样的话，我们的项目就已经启动成功了，我们可以通过ps指令，查看到系统的进程。</p>
<p><img src="@source/必会工具/assets/image-20210815140944635.png" alt="image-20210815140944635"></p>
<p>接下来，我们再次访问我们的项目，来看看服务是否可用。</p>
<p><img src="@source/必会工具/assets/image-20210815132748655.png" alt="image-20210815132748655"></p>
<p><strong>7). 停止SpringBoot项目</strong></p>
<p><img src="@source/必会工具/assets/image-20210815142132135.png" alt="image-20210815142132135"></p>
...
<p><img src="@source/必会工具/assets/image-20210815143955229.png" alt="img"></p>
<p>操作步骤如下：</p>
...
<p>A. 创建远程仓库</p>
<p><img src="@source/必会工具/assets/image-20210815145550077.png" alt="img"></p>
<p>B. 将idea中的代码提交并推送到远程仓库</p>
<p><img src="@source/必会工具/assets/image-20210815145253347.png" alt="image-20210815145253347"></p>
<p><img src="@source/必会工具/assets/image-20210815145432883.png" alt="img"></p>
...
<p><img src="@source/必会工具/assets/image-20210815145934265.png" alt="image-20210815145934265"></p>
<p>2). Git克隆代码</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815150452988.png" alt="image-20210815150452988"></p>
...
<p><img src="@source/必会工具/assets/image-20210815151544489.png" alt="image-20210815151544489"></p>
<p><img src="@source/必会工具/assets/image-20210815151807043.png" alt="img"></p>
<p><img src="@source/必会工具/assets/image-20210815151901262.png" alt="image-20210815151901262"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815152033246.png" alt="image-20210815152033246"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815152321369.png" alt="image-20210815152321369"></p>
<p>要想让配置的环境变量生效,还需要执行如下指令:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>source /etc/profile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815152616703.png" alt="image-20210815152616703"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815152936129.png" alt="image-20210815152936129"></p>
<p>并在settings.xml中的<code v-pre>&lt;mirrors&gt;</code>标签中,配置阿里云的私服(==选做==):</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815170915170.png" alt="image-20210815170915170"></p>
...
<p><img src="@source/必会工具/assets/image-20210815153759071.png" alt="image-20210815153759071"></p>
<p><strong>脚本解读:</strong></p>
<p><img src="@source/必会工具/assets/image-20210815154943654.png" alt="image-20210815154943654"></p>
...
<p>Linux系统中权限描述如下:</p>
<p><img src="@source/必会工具/assets/image-20210815162945754.png" alt="image-20210815162945754"></p>
<p>属主：当前文件的所有者，谁创建的这个文件，改文件默认就属于谁。</p>
<p>属组：当前文件所有者所在的用户组的其他人员。</p>
<p>其他：除了属主和属组的其他人。</p>
<p>解析当前脚本的权限情况:</p>
<p><img src="@source/必会工具/assets/image-20210815162135509.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815163957647.png" alt="image-20210815163957647"></p>
<p>权限解读:</p>
<p>A. 第一个7，代表当前文件所有者root用户，对该文件具有读写执行权限；</p>
<p>B. 第二个7，代表当前文件所有者所属组的用户，对该文件具有读写执行权限；</p>
<p>B. 第三个7，代表其他用户，对该文件具有读写执行权限；</p>
<p>执行该shell脚本:</p>
<p><img src="@source/必会工具/assets/image-20210815170334935.png" alt="image-20210815170334935"></p>
...
<p><img src="@source/必会工具/assets/image-20210815170418707.png" alt="image-20210815170418707"></p>
<p>访问项目：</p>
<p><img src="@source/必会工具/assets/image-20210815132748655.png" alt="image-20210815132748655"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815171934667.png" alt="image-20210815171934667"></p>
<p>上述我们所设置的网段为138，并不是随意指定的，需要和我们虚拟机中的虚拟网络编辑器中的NAT模式配置的网关保持一致。</p>
<p><img src="@source/必会工具/assets/image-20210815172303896.png" alt="image-20210815172303896"></p>
<p>2). 重启网络服务</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/必会工具/assets/image-20210815172448448.png" alt="image-20210815172448448"></p>
<p>==注意：重启完网络服务后ip地址已经发生了改变，此时FinalShell已经连接不上Linux系统，需要创建一个新连接才能连接到Linux。==</p>
<p>再次连接上Linux之后，我们再次查看IP地址，就可以看到我们所设置的静态IP：</p>
<p><img src="@source/必会工具/assets/image-20210815172832108.png" alt="image-20210815172832108"></p>
</div></template>
