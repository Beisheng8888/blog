...
<p>例如京东：</p>
<p><img src="@source/必会工具/assets/image-20210721165326938.png" alt="image-20210721165326938"></p>
...
<p>match查询示例：</p>
<p><img src="@source/必会工具/assets/image-20210721170455419.png" alt="image-20210721170455419"></p>
<p>multi_match查询示例：</p>
<p><img src="@source/必会工具/assets/image-20210721170720691.png" alt="image-20210721170720691"></p>
...
<p><img src="@source/必会工具/assets/image-20210721171655308.png" alt="image-20210721171655308"></p>
<p>但是，当我搜索的内容不是词条，而是多个词语形成的短语时，反而搜索不到：</p>
<p><img src="@source/必会工具/assets/image-20210721171838378.png" alt="image-20210721171838378"></p>
...
<p><img src="@source/必会工具/assets/image-20210721172307172.png" alt="image-20210721172307172"></p>
...
<p>附近的酒店：</p>
<p><img src="@source/必会工具/assets/image-20210721172645103.png" alt="image-20210721172645103"></p>
<p>附近的车：</p>
<p><img src="@source/必会工具/assets/image-20210721172654880.png" alt="image-20210721172654880"></p>
...
<p><img src="@source/必会工具/assets/DKV9HZbVS6.gif" alt="DKV9HZbVS6"></p>
...
<p><img src="@source/必会工具/assets/vZrdKAh19C.gif" alt="vZrdKAh19C"></p>
<p>语法说明：</p>
...
<p><img src="@source/必会工具/assets/image-20210721175443234.png" alt="image-20210721175443234"></p>
<p>发现共有47家酒店。</p>
<p>然后把半径缩短到3公里：</p>
<p><img src="@source/必会工具/assets/image-20210721182031475.png" alt="image-20210721182031475"></p>
...
<p><img src="@source/必会工具/assets/image-20210721190152134.png" alt="image-20210721190152134"></p>
<p>在后来的5.1版本升级中，elasticsearch将算法改进为BM25算法，公式如下：</p>
<p><img src="@source/必会工具/assets/image-20210721190416214.png" alt="image-20210721190416214"></p>
<p>TF-IDF算法有一各缺陷，就是词条频率越高，文档得分也会越高，单个词条对文档影响较大。而BM25则会让单个词条的算分有一个上限，曲线更加平滑：</p>
<p><img src="@source/必会工具/assets/image-20210721190907320.png" alt="image-20210721190907320"></p>
...
<p><img src="@source/必会工具/assets/image-20210721191144560.png" alt="image-20210721191144560"></p>
...
<p><img src="@source/必会工具/assets/image-20210721191544750.png" alt="image-20210721191544750"></p>
...
<p><img src="@source/必会工具/assets/image-20210721193152520.png" alt="image-20210721193152520"></p>
<p>添加了算分函数后，如家得分就提升了：</p>
<p><img src="@source/必会工具/assets/image-20210721193458182.png" alt="image-20210721193458182"></p>
...
<p><img src="@source/必会工具/assets/image-20210721193822848.png" alt="image-20210721193822848"></p>
...
<p><img src="@source/必会工具/assets/image-20210721194744183.png" alt="image-20210721194744183"></p>
...
<p><img src="@source/必会工具/assets/image-20210721195728306.png" alt="image-20210721195728306"></p>
...
<p><img src="@source/必会工具/assets/image-20210721200214690.png" alt="image-20210721200214690"></p>
...
<p><img src="@source/必会工具/assets/image-20210721200643029.png" alt="image-20210721200643029"></p>
...
<p><img src="@source/必会工具/assets/image-20210721201003229.png" alt="image-20210721201003229"></p>
...
<p><img src="@source/必会工具/assets/image-20210721202705030.png" alt="image-20210721202705030"></p>
<p>高亮显示的实现分为两步：</p>
<ul>
...
<p><strong>示例</strong>：</p>
<p><img src="@source/必会工具/assets/image-20210721203349633.png" alt="image-20210721203349633"></p>
...
<p>示例：</p>
<p><img src="@source/必会工具/assets/image-20210721203657850.png" alt="image-20210721203657850"></p>
...
<p><img src="@source/必会工具/assets/image-20210721203950559.png" alt="image-20210721203950559"></p>
<p>代码解读：</p>
<ul>
<li>
...
<p><img src="@source/必会工具/assets/image-20210721215640790.png" alt="image-20210721215640790"></p>
<p>另一个是<code v-pre>QueryBuilders</code>，其中包含match、term、function_score、bool等各种查询：</p>
<p><img src="@source/必会工具/assets/image-20210721215729236.png" alt="image-20210721215729236"></p>
<h3 id="_3-1-2-解析响应" tabindex="-1"><a class="header-anchor" href="#_3-1-2-解析响应" aria-hidden="true">#</a> 3.1.2.解析响应</h3>
<p>响应结果的解析：</p>
<p><img src="@source/必会工具/assets/image-20210721214221057.png" alt="image-20210721214221057"></p>
...
<p><img src="@source/必会工具/assets/image-20210721215923060.png" alt="image-20210721215923060"></p>
<p>因此，Java代码上的差异主要是request.source().query()中的参数了。同样是利用QueryBuilders提供的方法：</p>
<p><img src="@source/必会工具/assets/image-20210721215843099.png" alt="image-20210721215843099"></p>
...
<p>查询条件构造的API如下：</p>
<p><img src="@source/必会工具/assets/image-20210721220305140.png" alt="image-20210721220305140"></p>
...
<p><img src="@source/必会工具/assets/image-20210721220927286.png" alt="image-20210721220927286"></p>
...
<p>对应的API如下：</p>
<p><img src="@source/必会工具/assets/image-20210721221121266.png" alt="image-20210721221121266"></p>
<p>完整代码示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>高亮请求的构建API如下：</p>
<p><img src="@source/必会工具/assets/image-20210721221744883.png" alt="image-20210721221744883"></p>
...
<p>因此解析高亮的代码需要额外处理：</p>
<p><img src="@source/必会工具/assets/image-20210721222057212.png" alt="image-20210721222057212"></p>
<p>代码解读：</p>
<ul>
...
<p><img src="@source/必会工具/assets/image-20210721223159598.png" alt="image-20210721223159598"></p>
...
<p><img src="@source/必会工具/assets/image-20210721223859419.png" alt="image-20210721223859419"></p>
<p>点击搜索按钮，可以看到浏览器控制台发出了请求：</p>
<p><img src="@source/必会工具/assets/image-20210721224033789.png" alt="image-20210721224033789"></p>
<p>请求参数如下：</p>
<p><img src="@source/必会工具/assets/image-20210721224112708.png" alt="image-20210721224112708"></p>
...
<p><img src="@source/必会工具/assets/image-20210722091940726.png" alt="image-20210722091940726"></p>
<p>传递的参数如图：</p>
<p><img src="@source/必会工具/assets/image-20210722092051994.png" alt="image-20210722092051994"></p>
<p>包含的过滤条件有：</p>
<ul>
<li>brand：品牌值</li>
<li>city：城市</li>
...
<p><img src="@source/必会工具/assets/image-20210722092935453.png" alt="image-20210722092935453"></p>
...
<p><img src="@source/必会工具/assets/image-20210722093414542.png" alt="image-20210722093414542"></p>
<p>并且，在前端会发起查询请求，将你的坐标发送到服务端：</p>
<p><img src="@source/必会工具/assets/image-20210722093642382.png" alt="image-20210722093642382"></p>
...
<p><img src="@source/必会工具/assets/image-20210722095227059.png" alt="image-20210722095227059"></p>
...
<p><img src="@source/必会工具/assets/image-20210722095902314.png" alt="image-20210722095902314"></p>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token class-name">PageResult</span> <span class="token function">search</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">try</span> <span class="token punctuation">{</span>
...
<p>重启服务后，测试我的酒店功能：</p>
<p><img src="@source/必会工具/assets/image-20210722100040674.png" alt="image-20210722100040674"></p>
<p>发现确实可以实现对我附近酒店的排序，不过并没有看到酒店到底距离我多远，这该怎么办？</p>
<p>排序完成后，页面还要获取我附近每个酒店的具体<strong>距离</strong>值，这个值在响应结果中是独立的：</p>
<p><img src="@source/必会工具/assets/image-20210722095648542.png" alt="image-20210722095648542"></p>
...
<p><img src="@source/必会工具/assets/image-20210722100613966.png" alt="image-20210722100613966"></p>
<p>重启后测试，发现页面能成功显示距离了：</p>
<p><img src="@source/必会工具/assets/image-20210722100838604.png" alt="image-20210722100838604"></p>
...
<p><img src="@source/必会工具/assets/image-20210722100947292.png" alt="image-20210722100947292"></p>
...
<p><img src="@source/必会工具/assets/image-20210722101908062.png" alt="image-20210722101908062"></p>
...
<p><img src="@source/必会工具/assets/image-20210721191544750.png" alt="image-20210721191544750"></p>
<p>对应的JavaAPI如下：</p>
<p><img src="@source/必会工具/assets/image-20210722102850818.png" alt="image-20210722102850818"></p>
