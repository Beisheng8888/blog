...
<p><img src="@source/必会工具/assets/image-20210927090555559.png" alt="image-20210927090555559"></p>
<ul>
<li>[ ] 适合存储热点数据（热点商品、资讯、新闻）</li>
</ul>
<p><img src="@source/必会工具/assets/image-20210927090604994.png" alt="image-20210927090604994"></p>
<ul>
<li>[ ] 企业应用广泛</li>
</ul>
<p><img src="@source/必会工具/assets/image-20210927090612540.png" alt="image-20210927090612540"></p>
...
<p>下载后得到下面安装包：</p>
<p><img src="@source/必会工具/assets/image-20210927092053283.png" alt="image-20210927092053283"></p>
...
<p><img src="@source/必会工具/assets/image-20210927093112281.png" alt="image-20210927093112281"></p>
...
<p><img src="@source/必会工具/assets/image-20210927094452556.png" alt="image-20210927094452556"></p>
...
<p><img src="@source/必会工具/assets/image-20210927100421213.png" alt="image-20210927100421213"></p>
<p>==Ctrl + C==停止Redis服务</p>
<p>双击==redis-cli.exe==即可启动Redis客户端，默认连接的是本地的Redis服务，而且不需要认证即可连接成功。</p>
<p><img src="@source/必会工具/assets/image-20210927100319016.png" alt="image-20210927100319016"></p>
<p>退出客户端可以输入==exit==或者==quit==命令。</p>
...
<p><img src="@source/必会工具/assets/image-20210927104929169.png" alt="image-20210927104929169"></p>
<p>由于Redis配置文件中开启了认证校验，即客户端连接时需要提供密码，此时客户端连接方式变为：</p>
<p><img src="@source/必会工具/assets/image-20210927105909600.png" alt="image-20210927105909600"></p>
<p><strong>解释说明：</strong></p>
<blockquote>
...
<p><img src="@source/必会工具/assets/image-20210927111819871.png" alt="image-20210927111819871"></p>
<p><strong>解释说明：</strong></p>
<blockquote>
...
<p><img src="@source/必会工具/assets/image-20210927113014567.png" alt="image-20210927113014567"></p>
...
<p><img src="@source/必会工具/assets/image-20210927113312384.png" alt="image-20210927113312384"></p>
...
<p><img src="@source/必会工具/assets/image-20210927113632472.png" alt="image-20210927113632472"></p>
...
<p><img src="@source/必会工具/assets/image-20210927114003383.png" alt="image-20210927114003383"></p>
...
<p><img src="@source/必会工具/assets/image-20210927143741458.png" alt="image-20210927143741458"></p>
<p>maven坐标：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
