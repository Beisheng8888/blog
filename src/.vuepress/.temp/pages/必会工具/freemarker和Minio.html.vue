...
<p>请求：http://localhost:8881/basic</p>
...
<p>显示年月日: <strong><code v-pre>${today?date}</code></strong>
显示时分秒：<strong><code v-pre>${today?time}</code></strong>
显示日期+时间：<strong><code v-pre>${today?datetime}</code></strong>
...
<p>官网文档：http://docs.minio.org.cn/docs/</p>
...
<p>假设我们的服务器地址为http://192.168.200.130:9000，我们在地址栏输入：http://http://192.168.200.130:9000/ 即可进入登录界面。</p>
