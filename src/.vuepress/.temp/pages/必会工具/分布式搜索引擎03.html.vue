...
<p><img src="@source/必会工具/assets/image-20210723171948228.png" alt="image-20210723171948228"></p>
...
<p><img src="@source/必会工具/assets/image-20210723172404836.png" alt="image-20210723172404836"></p>
...
<p><img src="@source/必会工具/assets/image-20210723172917636.png" alt="image-20210723172917636"></p>
...
<p>聚合条件的语法：</p>
<p><img src="@source/必会工具/assets/image-20210723173057733.png" alt="image-20210723173057733"></p>
<p>聚合的结果也与查询结果不同，API也比较特殊。不过同样是JSON逐层解析：</p>
<p><img src="@source/必会工具/assets/image-20210723173215728.png" alt="image-20210723173215728"></p>
...
<p><img src="@source/必会工具/assets/image-20210723192605566.png" alt="image-20210723192605566"></p>
<p>分析：</p>
...
<p><img src="@source/必会工具/assets/image-20210723193730799.png" alt="image-20210723193730799"></p>
<p>请求<strong>参数与搜索文档的参数完全一致</strong>。</p>
<p>返回值类型就是页面要展示的最终结果：</p>
<p><img src="@source/必会工具/assets/image-20210723203915982.png" alt="image-20210723203915982"></p>
<p>结果是一个Map结构：</p>
<ul>
...
<p><img src="@source/必会工具/assets/image-20210723204936367.png" alt="image-20210723204936367"></p>
...
<p><img src="@source/必会工具/assets/image-20210723205932746.png" alt="image-20210723205932746"></p>
<p>资料中也提供了拼音分词器的安装包：</p>
<p><img src="@source/必会工具/assets/image-20210723205722303.png" alt="image-20210723205722303"></p>
...
<p><img src="@source/必会工具/assets/image-20210723210126506.png" alt="image-20210723210126506"></p>
...
<p><img src="@source/必会工具/assets/image-20210723210427878.png" alt="image-20210723210427878"></p>
<p>声明自定义分词器的语法如下：</p>
...
<p><img src="@source/必会工具/assets/image-20210723211829150.png" alt="image-20210723211829150"></p>
<p>总结：</p>
<p>如何使用拼音分词器？</p>
<ul>
<li>
...
<p><img src="@source/必会工具/assets/image-20210723213546183.png" alt="image-20210723213546183"></p>
...
<p><img src="@source/必会工具/assets/image-20210723213759922.png" alt="image-20210723213759922"></p>
<p>而自动补全的结果也比较特殊，解析的代码如下：</p>
<p><img src="@source/必会工具/assets/image-20210723213917524.png" alt="image-20210723213917524"></p>
...
<p><img src="@source/必会工具/assets/image-20210723214021062.png" alt="image-20210723214021062"></p>
...
<p><img src="@source/必会工具/assets/image-20210723214758392.png" alt="image-20210723214758392"></p>
...
<p>方案一：同步调用</p>
<p><img src="@source/必会工具/assets/image-20210723214931869.png" alt="image-20210723214931869"></p>
<p>基本步骤如下：</p>
<ul>
...
<p>方案二：异步通知</p>
<p><img src="@source/必会工具/assets/image-20210723215140735.png" alt="image-20210723215140735"></p>
<p>流程如下：</p>
<ul>
...
<p>方案三：监听binlog</p>
<p><img src="@source/必会工具/assets/image-20210723215518541.png" alt="image-20210723215518541"></p>
<p>流程如下：</p>
<ul>
...
<p><img src="@source/必会工具/assets/image-20210723220237930.png" alt="image-20210723220237930"></p>
<p>运行后，访问 http://localhost:8099</p>
<p><img src="@source/必会工具/assets/image-20210723220354464.png" alt="image-20210723220354464"></p>
<p>其中包含了酒店的CRUD功能：</p>
<p><img src="@source/必会工具/assets/image-20210723220511090.png" alt="image-20210723220511090"></p>
<h3 id="_3-2-3-声明交换机、队列" tabindex="-1"><a class="header-anchor" href="#_3-2-3-声明交换机、队列" aria-hidden="true">#</a> 3.2.3.声明交换机、队列</h3>
<p>MQ结构如图：</p>
<p><img src="@source/必会工具/assets/image-20210723215850307.png" alt="image-20210723215850307"></p>
...
<p><img src="@source/必会工具/assets/image-20210723221843816.png" alt="image-20210723221843816"></p>
...
<p><img src="@source/必会工具/assets/image-20200104124440086-5602723.png" alt="image-20200104124440086"></p>
<blockquote>
...
<p><img src="@source/必会工具/assets/image-20200104124551912.png" alt="image-20200104124551912"></p>
...
<p>参考资料的文档：</p>
<p><img src="@source/必会工具/assets/image-20210723222732427.png" alt="image-20210723222732427"></p>
<p>其中的第四章节：</p>
<p><img src="@source/必会工具/assets/image-20210723222812619.png" alt="image-20210723222812619"></p>
...
<p><img src="@source/必会工具/assets/image-20210723223008967.png" alt="image-20210723223008967"></p>
...
<p>一个典型的es集群职责划分如图：</p>
<p><img src="@source/必会工具/assets/image-20210723223629142.png" alt="image-20210723223629142"></p>
...
<p><img src="@source/必会工具/assets/image-20210723223804995.png" alt="image-20210723223804995"></p>
<p>此时，node2和node3认为node1宕机，就会重新选主：</p>
<p><img src="@source/必会工具/assets/image-20210723223845754.png" alt="image-20210723223845754"></p>
<p>当node3当选后，集群继续对外提供服务，node2和node3自成集群，node1自成集群，两个集群数据不同步，出现数据差异。</p>
<p>当网络恢复后，因为集群中有两个master节点，集群状态的不一致，出现脑裂的情况：</p>
<p><img src="@source/必会工具/assets/image-20210723224000555.png" alt="image-20210723224000555"></p>
...
<p>插入三条数据：</p>
<p><img src="@source/必会工具/assets/image-20210723225006058.png" alt="image-20210723225006058"></p>
<p><img src="@source/必会工具/assets/image-20210723225034637.png" alt="image-20210723225034637"></p>
<p><img src="@source/必会工具/assets/image-20210723225112029.png" alt="image-20210723225112029"></p>
<p>测试可以看到，三条数据分别在不同分片：</p>
<p><img src="@source/必会工具/assets/image-20210723225227928.png" alt="image-20210723225227928"></p>
<p>结果：</p>
<p><img src="@source/必会工具/assets/image-20210723225342120.png" alt="image-20210723225342120"></p>
...
<p><img src="@source/必会工具/assets/image-20210723224354904.png" alt="image-20210723224354904"></p>
...
<p>新增文档的流程如下：</p>
<p><img src="@source/必会工具/assets/image-20210723225436084.png" alt="image-20210723225436084"></p>
<p>解读：</p>
<ul>
<li>1）新增一个id=1的文档</li>
...
<p><img src="@source/必会工具/assets/image-20210723225809848.png" alt="image-20210723225809848"></p>
...
<p>1）例如一个集群结构如图：</p>
<p><img src="@source/必会工具/assets/image-20210723225945963.png" alt="image-20210723225945963"></p>
<p>现在，node1是主节点，其它两个节点是从节点。</p>
<p>2）突然，node1发生了故障：</p>
<p><img src="@source/必会工具/assets/image-20210723230020574.png" alt="image-20210723230020574"></p>
<p>宕机后的第一件事，需要重新选主，例如选中了node2：</p>
<p><img src="@source/必会工具/assets/image-20210723230055974.png" alt="image-20210723230055974"></p>
<p>node2成为主节点后，会检测集群监控状态，发现：shard-1、shard-0没有副本节点。因此需要将node1上的数据迁移到node2、node3：</p>
<p><img src="@source/必会工具/assets/image-20210723230216642.png" alt="image-20210723230216642"></p>
</div></template>
