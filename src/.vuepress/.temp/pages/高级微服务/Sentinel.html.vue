...
<p><img src="@source/高级微服务/assets/1533829099748.png" alt="1533829099748"></p>
<p>如图，如果服务提供者I发生了故障，当前的应用的部分业务因为依赖于服务I，因此也会被阻塞。此时，其它不依赖于服务I的业务似乎不受影响。</p>
<p><img src="@source/高级微服务/assets/1533829198240.png" alt="1533829198240"></p>
<p>但是，依赖服务I的业务请求被阻塞，用户不会得到响应，则tomcat的这个线程不会释放，于是越来越多的用户请求到来，越来越多的线程会阻塞：</p>
<p><img src="@source/高级微服务/assets/1533829307389.png" alt="1533829307389"></p>
<p>服务器支持的线程和并发数有限，请求一直阻塞，会导致服务器资源耗尽，从而导致所有其它服务都不可用，那么当前服务也就不可用了。</p>
<p>那么，依赖于当前服务的其它服务随着时间的推移，最终也都会变的不可用，形成级联失败，雪崩就发生了：</p>
<p><img src="@source/高级微服务/assets/image-20210715172710340.png" alt="image-20210715172710340"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715172820438.png" alt="image-20210715172820438"></p>
<h3 id="_1-1-3-仓壁模式" tabindex="-1"><a class="header-anchor" href="#_1-1-3-仓壁模式" aria-hidden="true">#</a> 1.1.3.仓壁模式</h3>
<p>方案2：仓壁模式</p>
<p>仓壁模式来源于船舱的设计：</p>
<p><img src="@source/高级微服务/assets/image-20210715172946352.png" alt="image-20210715172946352"></p>
<p>船舱都会被隔板分离为多个独立空间，当船体破损时，只会导致部分空间进入，将故障控制在一定范围内，避免整个船体都被淹没。</p>
<p>于此类似，我们可以限定每个业务能使用的线程数，避免耗尽整个tomcat的资源，因此也叫线程隔离。</p>
<p><img src="@source/高级微服务/assets/image-20210715173215243.png" alt="image-20210715173215243"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715173327075.png" alt="image-20210715173327075"></p>
<p>当发现访问服务D的请求异常比例过高时，认为服务D有导致雪崩的风险，会拦截访问服务D的一切请求，形成熔断：</p>
<p><img src="@source/高级微服务/assets/image-20210715173428073.png" alt="image-20210715173428073"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715173555158.png" alt="image-20210715173555158"></p>
...
<p>资料也提供了下载好的jar包：</p>
<p><img src="@source/高级微服务/assets/image-20210715174252531.png" alt="image-20210715174252531"></p>
<p>2）运行</p>
...
<p><img src="@source/高级微服务/assets/image-20210715190827846.png" alt="image-20210715190827846"></p>
<p>需要输入账号和密码，默认都是：sentinel</p>
<p>登录后，发现一片空白，什么都没有：</p>
<p><img src="@source/高级微服务/assets/image-20210715191134448.png" alt="image-20210715191134448"></p>
<p>这是因为我们还没有与微服务整合。</p>
...
<p><img src="@source/高级微服务/assets/image-20210715191241799.png" alt="image-20210715191241799"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715191757319.png" alt="image-20210715191757319"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715191757319.png" alt="image-20210715191757319"></p>
<p>表单中可以填写限流规则，如下：</p>
<p><img src="@source/高级微服务/assets/image-20210715192010657.png" alt="image-20210715192010657"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715192455429.png" alt="image-20210715192455429"></p>
<p>2）利用jmeter测试</p>
<p>如果没有用过jmeter，可以参考资料提供的文档《Jmeter快速入门.md》</p>
<p>资料提供了编写好的Jmeter测试样例：</p>
<p><img src="@source/高级微服务/assets/image-20210715200431615.png" alt="image-20210715200431615"></p>
<p>打开jmeter，导入资料提供的测试样例：</p>
<p><img src="@source/高级微服务/assets/image-20210715200537171.png" alt="image-20210715200537171"></p>
<p>选择：</p>
<p><img src="@source/高级微服务/assets/image-20210715200635414.png" alt="image-20210715200635414"></p>
<p>20个用户，2秒内运行完，QPS是10，超过了5.</p>
<p>选中<code v-pre>流控入门，QPS&lt;5</code>右键运行：</p>
<p><img src="@source/高级微服务/assets/image-20210715200804594.png" alt="image-20210715200804594"></p>
<blockquote>
<p>注意，不要点击菜单中的执行按钮来运行。</p>
</blockquote>
<p>结果：</p>
<p><img src="@source/高级微服务/assets/image-20210715200853671.png" alt="image-20210715200853671"></p>
...
<p><img src="@source/高级微服务/assets/image-20210715201827886.png" alt="image-20210715201827886"></p>
<p>快速入门测试的就是直接模式。</p>
...
<p><img src="@source/高级微服务/assets/image-20210715202540786.png" alt="image-20210715202540786"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716101805951.png" alt="image-20210716101805951"></p>
<p>3）配置流控规则</p>
<p>对哪个端点限流，就点击哪个端点后面的按钮。我们是对订单查询/order/query限流，因此点击它后面的按钮：</p>
<p><img src="@source/高级微服务/assets/image-20210716101934499.png" alt="image-20210716101934499"></p>
<p>在表单中填写流控规则：</p>
<p><img src="@source/高级微服务/assets/image-20210716102103814.png" alt="image-20210716102103814"></p>
<p>4）在Jmeter测试</p>
<p>选择《流控模式-关联》：</p>
<p><img src="@source/高级微服务/assets/image-20210716102416266.png" alt="image-20210716102416266"></p>
<p>可以看到1000个用户，100秒，因此QPS为10，超过了我们设定的阈值：5</p>
<p>查看http请求：</p>
<p><img src="@source/高级微服务/assets/image-20210716102532554.png" alt="image-20210716102532554"></p>
<p>请求的目标是/order/update，这样这个断点就会触发阈值。</p>
<p>但限流的目标是/order/query，我们在浏览器访问，可以发现：</p>
<p><img src="@source/高级微服务/assets/image-20210716102636030.png" alt="image-20210716102636030"></p>
<p>确实被限流了。</p>
<p>5）总结</p>
<p><img src="@source/高级微服务/assets/image-20210716103143002.png" alt="image-20210716103143002"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716103536346.png" alt="image-20210716103536346"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716105227163.png" alt="image-20210716105227163"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716105408723.png" alt="image-20210716105408723"></p>
...
<p>选择《流控模式-链路》：</p>
<p><img src="@source/高级微服务/assets/image-20210716105612312.png" alt="image-20210716105612312"></p>
<p>可以看到这里200个用户，50秒内发完，QPS为4，超过了我们设定的阈值2</p>
<p>一个http请求是访问/order/save：</p>
<p><img src="@source/高级微服务/assets/image-20210716105812789.png" alt="image-20210716105812789"></p>
<p>运行的结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716110027064.png" alt="image-20210716110027064"></p>
<p>完全不受影响。</p>
<p>另一个是访问/order/query：</p>
<p><img src="@source/高级微服务/assets/image-20210716105855951.png" alt="image-20210716105855951"></p>
<p>运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716105956401.png" alt="image-20210716105956401"></p>
<p>每次只有2个通过。</p>
...
<p><img src="@source/高级微服务/assets/image-20210716110225104.png" alt="image-20210716110225104"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716110629796.png" alt="image-20210716110629796"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716111012387.png" alt="image-20210716111012387"></p>
<h4 id="_2-jmeter测试" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《流控效果，warm up》：</p>
<p><img src="@source/高级微服务/assets/image-20210716111136699.png" alt="image-20210716111136699"></p>
<p>QPS为10.</p>
<p>刚刚启动时，大部分请求失败，成功的只有3个，说明QPS被限定在3：</p>
<p><img src="@source/高级微服务/assets/image-20210716111303701.png" alt="image-20210716111303701"></p>
<p>随着时间推移，成功比例越来越高：</p>
<p><img src="@source/高级微服务/assets/image-20210716111404717.png" alt="image-20210716111404717"></p>
<p>到Sentinel控制台查看实时监控：</p>
<p><img src="@source/高级微服务/assets/image-20210716111526480.png" alt="image-20210716111526480"></p>
<p>一段时间后：</p>
<p><img src="@source/高级微服务/assets/image-20210716111658541.png" alt="image-20210716111658541"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716113147176.png" alt="image-20210716113147176"></p>
<p>如果使用队列模式做流控，所有进入的请求都要排队，以固定的200ms的间隔执行，QPS会变的很平滑：</p>
<p><img src="@source/高级微服务/assets/image-20210716113426524.png" alt="image-20210716113426524"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716114048918.png" alt="image-20210716114048918"></p>
<h4 id="_2-jmeter测试-1" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试-1" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《流控效果，队列》：</p>
<p><img src="@source/高级微服务/assets/image-20210716114243558.png" alt="image-20210716114243558"></p>
<p>QPS为15，已经超过了我们设定的10。</p>
<p>如果是之前的 快速失败、warmup模式，超出的请求应该会直接报错。</p>
<p>但是我们看看队列模式的运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716114429361.png" alt="image-20210716114429361"></p>
<p>全部都通过了。</p>
<p>再去sentinel查看实时监控的QPS曲线：</p>
<p><img src="@source/高级微服务/assets/image-20210716114522935.png" alt="image-20210716114522935"></p>
<p>QPS非常平滑，一致保持在10，但是超出的请求没有被拒绝，而是放入队列。因此<strong>响应时间</strong>（等待时间）会越来越长。</p>
<p>当队列满了以后，才会有部分请求失败：</p>
<p><img src="@source/高级微服务/assets/image-20210716114651137.png" alt="image-20210716114651137"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716115014663.png" alt="image-20210716115014663"></p>
<p>访问/goods/{id}的请求中，id参数值会有变化，热点参数限流会根据参数值分别统计QPS，统计结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716115131463.png" alt="image-20210716115131463"></p>
<p>当id=1的请求触发阈值被限流时，id值不为1的请求不受影响。</p>
<p>配置示例：</p>
<p><img src="@source/高级微服务/assets/image-20210716115232426.png" alt="image-20210716115232426"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716115717523.png" alt="image-20210716115717523"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716120033572.png" alt="image-20210716120033572"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716120208509.png" alt="image-20210716120208509"></p>
<p>这里不要点击hot后面的按钮，页面有BUG</p>
<p>点击左侧菜单中<strong>热点规则</strong>菜单：</p>
<p><img src="@source/高级微服务/assets/image-20210716120319009.png" alt="image-20210716120319009"></p>
<p>点击新增，填写表单：</p>
<p><img src="@source/高级微服务/assets/image-20210716120536714.png" alt="image-20210716120536714"></p>
<h4 id="_3-jmeter测试" tabindex="-1"><a class="header-anchor" href="#_3-jmeter测试" aria-hidden="true">#</a> 3）Jmeter测试</h4>
<p>选择《热点参数限流 QPS1》：</p>
<p><img src="@source/高级微服务/assets/image-20210716120754527.png" alt="image-20210716120754527"></p>
<p>这里发起请求的QPS为5.</p>
<p>包含3个http请求：</p>
<p>普通参数，QPS阈值为2</p>
<p><img src="@source/高级微服务/assets/image-20210716120840501.png" alt="image-20210716120840501"></p>
<p>运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716121105567.png" alt="image-20210716121105567"></p>
<p>例外项，QPS阈值为4</p>
<p><img src="@source/高级微服务/assets/image-20210716120900365.png" alt="image-20210716120900365"></p>
<p>运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716121201630.png" alt="image-20210716121201630"></p>
<p>例外项，QPS阈值为10</p>
<p><img src="@source/高级微服务/assets/image-20210716120919131.png" alt="image-20210716120919131"></p>
<p>运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716121220305.png" alt="image-20210716121220305"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716122403502.png" alt="image-20210716122403502"></p>
<p>代码：</p>
...
<p><img src="@source/高级微服务/assets/image-20210716123705780.png" alt="image-20210716123705780"></p>
...
<p>如图：</p>
<p><img src="@source/高级微服务/assets/image-20210716123036937.png" alt="image-20210716123036937"></p>
<p><strong>线程池隔离</strong>：给每个服务调用业务分配一个线程池，利用线程池本身实现隔离效果</p>
<p><strong>信号量隔离</strong>：不创建线程池，而是计数器模式，记录业务使用的线程数量，达到信号量上限时，禁止新的请求。</p>
<p>两者的优缺点：</p>
<p><img src="@source/高级微服务/assets/image-20210716123240518.png" alt="image-20210716123240518"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716123411217.png" alt="image-20210716123411217"></p>
<ul>
<li>
...
<p><img src="@source/高级微服务/assets/image-20210716123831992.png" alt="image-20210716123831992"></p>
<p>填写表单：</p>
<p><img src="@source/高级微服务/assets/image-20210716123936844.png" alt="image-20210716123936844"></p>
<h4 id="_2-jmeter测试-2" tabindex="-1"><a class="header-anchor" href="#_2-jmeter测试-2" aria-hidden="true">#</a> 2）Jmeter测试</h4>
<p>选择《阈值类型-线程数&lt;2》：</p>
<p><img src="@source/高级微服务/assets/image-20210716124229894.png" alt="image-20210716124229894"></p>
<p>一次发生10个请求，有较大概率并发线程数超过2，而超出的请求会走之前定义的失败降级逻辑。</p>
<p>查看运行结果：</p>
<p><img src="@source/高级微服务/assets/image-20210716124147820.png" alt="image-20210716124147820"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716130958518.png" alt="image-20210716130958518"></p>
<p>状态机包括三个状态：</p>
<ul>
...
<p>例如：</p>
<p><img src="@source/高级微服务/assets/image-20210716145934347.png" alt="image-20210716145934347"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716150234787.png" alt="image-20210716150234787"></p>
<p>此时，orderId=101的订单，关联的是id为1的用户，调用时长为60ms：</p>
<p><img src="@source/高级微服务/assets/image-20210716150510956.png" alt="image-20210716150510956"></p>
<p>orderId=102的订单，关联的是id为2的用户，调用时长为非常短；</p>
<p><img src="@source/高级微服务/assets/image-20210716150605208.png" alt="image-20210716150605208"></p>
<h4 id="_2-设置熔断规则" tabindex="-1"><a class="header-anchor" href="#_2-设置熔断规则" aria-hidden="true">#</a> 2）设置熔断规则</h4>
<p>下面，给feign接口设置降级规则：</p>
<p><img src="@source/高级微服务/assets/image-20210716150654094.png" alt="image-20210716150654094"></p>
<p>规则：</p>
<p><img src="@source/高级微服务/assets/image-20210716150740434.png" alt="image-20210716150740434"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716150911004.png" alt="image-20210716150911004"></p>
<p>触发了熔断，请求时长缩短至5ms，快速失败了，并且走降级逻辑，返回的null</p>
<p>在浏览器访问：http://localhost:8088/order/102，竟然也被熔断了：</p>
<p><img src="@source/高级微服务/assets/image-20210716151107785.png" alt="image-20210716151107785"></p>
...
<p>例如，一个异常比例设置：</p>
<p><img src="@source/高级微服务/assets/image-20210716131430682.png" alt="image-20210716131430682"></p>
<p>解读：统计最近1000ms内的请求，如果请求量超过10次，并且异常比例不低于0.4，则触发熔断。</p>
<p>一个异常数设置：</p>
<p><img src="@source/高级微服务/assets/image-20210716131522912.png" alt="image-20210716131522912"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716151348183.png" alt="image-20210716151348183"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716150654094.png" alt="image-20210716150654094"></p>
<p>规则：</p>
<p><img src="@source/高级微服务/assets/image-20210716151538785.png" alt="image-20210716151538785"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716151722916.png" alt="image-20210716151722916"></p>
<p>此时，我们去访问本来应该正常的103：</p>
<p><img src="@source/高级微服务/assets/image-20210716151844817.png" alt="image-20210716151844817"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716152010750.png" alt="image-20210716152010750"></p>
<ul>
<li>
...
<p>比如：</p>
<p><img src="@source/高级微服务/assets/image-20210716152349191.png" alt="image-20210716152349191"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716153250134.png" alt="image-20210716153250134"></p>
<p>配置如下：</p>
<p><img src="@source/高级微服务/assets/image-20210716153301069.png" alt="image-20210716153301069"></p>
<p>现在，我们直接跳过网关，访问order-service服务：</p>
<p><img src="@source/高级微服务/assets/image-20210716153348396.png" alt="image-20210716153348396"></p>
<p>通过网关访问：</p>
<p><img src="@source/高级微服务/assets/image-20210716153434095.png" alt="image-20210716153434095"></p>
...
<p>限流：</p>
<p><img src="@source/高级微服务/assets/image-20210716153938887.png" alt="image-20210716153938887"></p>
<p>授权拦截时：</p>
<p><img src="@source/高级微服务/assets/image-20210716154012736.png" alt="image-20210716154012736"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716154155238.png" alt="image-20210716154155238"></p>
...
<p><img src="@source/高级微服务/assets/image-20210716154215456.png" alt="image-20210716154215456"></p>
</div></template>
