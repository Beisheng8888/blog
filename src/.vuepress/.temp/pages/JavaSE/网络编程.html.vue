...
<p>端口号</p>
<ul>
<li>用两个字节表示的整数，它的取值范围是0~65535。其中，0~1023之间的端口号用于一些知名的网络服务和应用，普通的应用程序需要使用1024以上的端口号。如果端口号被另外一个服务或应用所占用，会导致当前程序启动失败</li>
</ul>
</li>
<li>
<p>协议</p>
...
<li>
<p>三次握手</p>
<p><img src="@source/JavaSE/img/07_TCP三次握手.png" alt="07_TCP三次握手"></p>
</li>
<li>
<p>四次挥手</p>
<p><img src="@source/JavaSE/img/08_TCP四次挥手.png" alt="08_TCP四次挥手"></p>
</li>
</ul>
</li>
<li>
