...
<p><img src="@source/JavaSE/img/01_类加载器.png" alt="01_类加载器"></p>
</li>
</ul>
...
<p><img src="@source/JavaSE/img/02_类加载过程加载.png" alt="02_类加载过程加载"></p>
</li>
<li>
<p>链接</p>
<ul>
...
<p><img src="@source/JavaSE/img/03_类加载过程验证.png" alt="03_类加载过程验证"></p>
<ul>
<li>
<p>准备</p>
...
<p><img src="@source/JavaSE/img/04_类加载过程准备.png" alt="04_类加载过程准备"></p>
<ul>
<li>
<p>解析</p>
...
<p><img src="@source/JavaSE/img/05_类加载过程解析.png" alt="05_类加载过程解析"></p>
</li>
<li>
<p>初始化</p>
<p>根据程序员通过程序制定的主观计划去初始化类变量和其他资源</p>
<p>(静态变量赋值以及初始化其他资源)</p>
<p><img src="@source/JavaSE/img/06_类加载过程初始化.png" alt="06_类加载过程初始化"></p>
</li>
</ol>
</li>
<li>
...
<p><img src="@source/JavaSE/img/07_双亲委派模型.png" alt="07_双亲委派模型"></p>
</li>
</ul>
...
<p><img src="@source/JavaSE/img/08_获取Class对象的三种方式.png" alt="08_获取Class对象的三种方式"></p>
</li>
<li>
<p>示例代码</p>
...
<li>
<p>获取里面的构造方法对象</p>
<p>getConstructor (Class<code v-pre>&lt;?&gt;</code>... parameterTypes)
