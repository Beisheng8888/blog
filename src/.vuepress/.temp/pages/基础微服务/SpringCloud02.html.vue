...
<p><img src="@source/基础微服务/assets/image-20210714164426792.png" alt="image-20210714164426792"></p>
...
<p>如何在nacos中管理配置呢？</p>
<p><img src="@source/基础微服务/assets/image-20210714164742924.png" alt="image-20210714164742924"></p>
<p>然后在弹出的表单中，填写配置信息：</p>
<p><img src="@source/基础微服务/assets/image-20210714164856664.png" alt="image-20210714164856664"></p>
<blockquote>
...
<p><img src="@source/基础微服务/assets/L0iFYNF.png" alt="img"></p>
...
<p><strong>bootstrap.yaml 优先级大于 application.xxx</strong></p>
...
<p><img src="@source/基础微服务/assets/image-20210714170845901.png" alt="image-20210714170845901"></p>
<p>3）读取nacos配置</p>
<p>在user-service中的UserController中添加业务逻辑，读取pattern.dateformat配置：</p>
<p><img src="@source/基础微服务/assets/image-20210714170337448.png" alt="image-20210714170337448"></p>
<p>完整代码：</p>
...
<p><img src="@source/基础微服务/assets/image-20210714170449612.png" alt="image-20210714170449612"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714171036335.png" alt="image-20210714171036335"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714171316124.png" alt="image-20210714171316124"></p>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<p><img src="@source/基础微服务/assets/image-20210714173233650.png" alt="image-20210714173233650"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714173324231.png" alt="image-20210714173324231"></p>
<p>在user-service服务中，修改UserController，添加一个方法：</p>
<p><img src="@source/基础微服务/assets/image-20210714173721309.png" alt="image-20210714173721309"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714173538538.png" alt="image-20210714173538538"></p>
<p><img src="@source/基础微服务/assets/image-20210714173519963.png" alt="image-20210714173519963"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714174313344.png" alt="image-20210714174313344"></p>
<p>访问http://localhost:8082/user/prop，结果：</p>
<p><img src="@source/基础微服务/assets/image-20210714174424818.png" alt="image-20210714174424818"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714174623557.png" alt="image-20210714174623557"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714174728042.png" alt="image-20210714174728042"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714174814204.png" alt="image-20210714174814204"></p>
<p>存在下面的问题：</p>
<p>•代码可读性差，编程体验不统一</p>
<p>•参数复杂URL难以维护</p>
<p>Feign是一个声明式的http客户端，官方地址：https://github.com/OpenFeign/feign</p>
<p>其作用就是帮助我们优雅的实现http请求的发送，解决上面提到的问题。</p>
<p><img src="@source/基础微服务/assets/image-20210714174918088.png" alt="image-20210714174918088"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714175102524.png" alt="image-20210714175102524"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714175415087.png" alt="image-20210714175415087"></p>
<p>是不是看起来优雅多了。</p>
...
<p><img src="@source/基础微服务/assets/image-20210714185925910.png" alt="image-20210714185925910"></p>
<p>Debug方式启动order-service服务，可以看到这里的client，底层就是Apache HttpClient：</p>
<p><img src="@source/基础微服务/assets/image-20210714190041542.png" alt="image-20210714190041542"></p>
<p>总结，Feign的优化：</p>
<p>1.日志级别尽量用basic</p>
...
<p>feign客户端：</p>
<p><img src="@source/基础微服务/assets/image-20210714190542730.png" alt="image-20210714190542730"></p>
<p>UserController：</p>
<p><img src="@source/基础微服务/assets/image-20210714190528450.png" alt="image-20210714190528450"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714190640857.png" alt="image-20210714190640857"></p>
<p>优点：</p>
<ul>
<li>简单</li>
<li>实现了代码共享</li>
...
<p><img src="@source/基础微服务/assets/image-20210714214041796.png" alt="image-20210714214041796"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714204557771.png" alt="image-20210714204557771"></p>
<p>项目结构：</p>
<p><img src="@source/基础微服务/assets/image-20210714204656214.png" alt="image-20210714204656214"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714205221970.png" alt="image-20210714205221970"></p>
...
<p>重启后，发现服务报错了：</p>
<p><img src="@source/基础微服务/assets/image-20210714205623048.png" alt="image-20210714205623048"></p>
...
<p>架构图：</p>
<p><img src="@source/基础微服务/assets/image-20210714210131152.png" alt="image-20210714210131152"></p>
...
<p>创建服务：</p>
<p><img src="@source/基础微服务/assets/image-20210714210919458.png" alt="image-20210714210919458"></p>
<p>引入依赖：</p>
...
<p><img src="@source/基础微服务/assets/image-20210714211908341.png" alt="image-20210714211908341"></p>
<h3 id="_5-网关路由的流程图" tabindex="-1"><a class="header-anchor" href="#_5-网关路由的流程图" aria-hidden="true">#</a> 5）网关路由的流程图</h3>
<p>整个访问的流程如下：</p>
<p><img src="@source/基础微服务/assets/image-20210714211742956.png" alt="image-20210714211742956"></p>
<p>总结：</p>
<p>网关搭建步骤：</p>
<ol>
<li>
...
<p><img src="@source/基础微服务/assets/image-20210714212312871.png" alt="image-20210714212312871"></p>
...
<p><img src="@source/基础微服务/assets/image-20210714214228409.png" alt="image-20210714214228409"></p>
<p>排序的规则是什么呢？</p>
<ul>
...
<p>找到资料的页面文件：</p>
<p><img src="@source/基础微服务/assets/image-20210714215713563.png" alt="image-20210714215713563"></p>
<p>放入tomcat或者nginx这样的web服务器中，启动并访问。</p>
<p>可以在浏览器控制台看到下面的错误：</p>
<p><img src="@source/基础微服务/assets/image-20210714215832675.png" alt="image-20210714215832675"></p>
