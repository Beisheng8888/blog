<template><div><h1 id="分布式搜索引擎02" tabindex="-1"><a class="header-anchor" href="#分布式搜索引擎02" aria-hidden="true">#</a> 分布式搜索引擎02</h1>
<p>已经导入了大量数据到elasticsearch中，实现了elasticsearch的数据存储功能。但elasticsearch最擅长的还是搜索和数据分析。</p>
<p>研究下elasticsearch的数据搜索功能。会分别使用<strong>DSL</strong>和<strong>RestClient</strong>实现搜索。</p>
<h1 id="_1-dsl查询文档" tabindex="-1"><a class="header-anchor" href="#_1-dsl查询文档" aria-hidden="true">#</a> 1.DSL查询文档</h1>
<p>elasticsearch的查询依然是基于JSON风格的DSL来实现的。</p>
<h2 id="_1-1-dsl查询分类" tabindex="-1"><a class="header-anchor" href="#_1-1-dsl查询分类" aria-hidden="true">#</a> 1.1.DSL查询分类</h2>
<p>Elasticsearch提供了基于JSON的DSL（<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html" target="_blank" rel="noopener noreferrer">Domain Specific Language<ExternalLinkIcon/></a>）来定义查询。常见的查询类型包括：</p>
<ul>
<li>
...
<p>例如京东：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721165326938.png" alt="image-20210721165326938" tabindex="0" loading="lazy"><figcaption>image-20210721165326938</figcaption></figure>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>mulit_match语法如下：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>GET /indexName/_search
<span class="token punctuation">{</span>
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<p>match查询示例：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721170455419.png" alt="image-20210721170455419" tabindex="0" loading="lazy"><figcaption>image-20210721170455419</figcaption></figure>
<p>multi_match查询示例：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721170720691.png" alt="image-20210721170720691" tabindex="0" loading="lazy"><figcaption>image-20210721170720691</figcaption></figure>
<p>可以看到，两种查询结果是一样的，为什么？</p>
<p>因为我们将brand、name、business值都利用copy_to复制到了all字段中。因此你根据三个字段搜索，和根据all字段搜索效果当然一样了。</p>
<p><strong>但是，搜索字段越多，对查询性能影响越大，因此建议采用copy_to，然后单字段查询的方式。</strong></p>
...
<h3 id="_1-3-1-term查询" tabindex="-1"><a class="header-anchor" href="#_1-3-1-term查询" aria-hidden="true">#</a> 1.3.1.term查询</h3>
...
<figure><img src="@source/src/必会工具/assets/image-20210721171655308.png" alt="image-20210721171655308" tabindex="0" loading="lazy"><figcaption>image-20210721171655308</figcaption></figure>
<p>但是，当我搜索的内容不是词条，而是多个词语形成的短语时，反而搜索不到：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721171838378.png" alt="image-20210721171838378" tabindex="0" loading="lazy"><figcaption>image-20210721171838378</figcaption></figure>
<h3 id="_1-3-2-range查询" tabindex="-1"><a class="header-anchor" href="#_1-3-2-range查询" aria-hidden="true">#</a> 1.3.2.range查询</h3>
...
<figure><img src="@source/src/必会工具/assets/image-20210721172307172.png" alt="image-20210721172307172" tabindex="0" loading="lazy"><figcaption>image-20210721172307172</figcaption></figure>
...
<li>range查询：根据数值范围查询，可以是数值、日期的范围   其中e是等于的意思</li>
</ul>
<h2 id="_1-4-地理坐标查询" tabindex="-1"><a class="header-anchor" href="#_1-4-地理坐标查询" aria-hidden="true">#</a> 1.4.地理坐标查询</h2>
<p>所谓的地理坐标查询，其实就是根据经纬度查询，官方文档：<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/geo-queries.html" target="_blank" rel="noopener noreferrer">https://www.elastic.co/guide/en/elasticsearch/reference/current/geo-queries.html<ExternalLinkIcon/></a></p>
<p>常见的使用场景包括：</p>
<ul>
<li>携程：搜索我附近的酒店</li>
<li>滴滴：搜索我附近的出租车</li>
...
<p>附近的酒店：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721172645103.png" alt="image-20210721172645103" tabindex="0" loading="lazy"><figcaption>image-20210721172645103</figcaption></figure>
<p>附近的车：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721172654880.png" alt="image-20210721172654880" tabindex="0" loading="lazy"><figcaption>image-20210721172654880</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/DKV9HZbVS6.gif" alt="DKV9HZbVS6" tabindex="0" loading="lazy"><figcaption>DKV9HZbVS6</figcaption></figure>
...
<p>换句话来说，在地图上找一个点作为圆心。ho，以指定距离为半径，画一个圆，落在圆内的坐标都算符合条件：</p>
<figure><img src="@source/src/必会工具/assets/vZrdKAh19C.gif" alt="vZrdKAh19C" tabindex="0" loading="lazy"><figcaption>vZrdKAh19C</figcaption></figure>
<p>语法说明：</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210721175443234.png" alt="image-20210721175443234" tabindex="0" loading="lazy"><figcaption>image-20210721175443234</figcaption></figure>
<p>发现共有47家酒店。</p>
<p>然后把半径缩短到3公里：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721182031475.png" alt="image-20210721182031475" tabindex="0" loading="lazy"><figcaption>image-20210721182031475</figcaption></figure>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">[</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在elasticsearch中，早期使用的打分算法是TF-IDF算法，公式如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721190152134.png" alt="image-20210721190152134" tabindex="0" loading="lazy"><figcaption>image-20210721190152134</figcaption></figure>
<p>在后来的5.1版本升级中，elasticsearch将算法改进为BM25算法，公式如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721190416214.png" alt="image-20210721190416214" tabindex="0" loading="lazy"><figcaption>image-20210721190416214</figcaption></figure>
<p>TF-IDF算法有一各缺陷，就是词条频率越高，文档得分也会越高，单个词条对文档影响较大。而BM25则会让单个词条的算分有一个上限，曲线更加平滑：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721190907320.png" alt="image-20210721190907320" tabindex="0" loading="lazy"><figcaption>image-20210721190907320</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721191144560.png" alt="image-20210721191144560" tabindex="0" loading="lazy"><figcaption>image-20210721191144560</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721191544750.png" alt="image-20210721191544750" tabindex="0" loading="lazy"><figcaption>image-20210721191544750</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721193152520.png" alt="image-20210721193152520" tabindex="0" loading="lazy"><figcaption>image-20210721193152520</figcaption></figure>
<p>添加了算分函数后，如家得分就提升了：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721193458182.png" alt="image-20210721193458182" tabindex="0" loading="lazy"><figcaption>image-20210721193458182</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721193822848.png" alt="image-20210721193822848" tabindex="0" loading="lazy"><figcaption>image-20210721193822848</figcaption></figure>
  ...
  <span class="token property">"query"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"bool"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
      ...
      <span class="token property">"should"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        ...
        <span class="token punctuation">{</span><span class="token property">"term"</span><span class="token operator">:</span> <span class="token punctuation">{</span><span class="token property">"brand"</span><span class="token operator">:</span> <span class="token string">"华美达"</span> <span class="token punctuation">}</span><span class="token punctuation">}</span><span class="token punctuation">{</span><span class="token punctuation">}</span>
      <span class="token punctuation">]</span><span class="token punctuation">,</span>
...
<figure><img src="@source/src/必会工具/assets/image-20210721194744183.png" alt="image-20210721194744183" tabindex="0" loading="lazy"><figcaption>image-20210721194744183</figcaption></figure>
...
<p>elasticsearch默认是根据相关度算分（_score）来排序，但是也支持自定义方式对搜索<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/sort-search-results.html" target="_blank" rel="noopener noreferrer">结果排序<ExternalLinkIcon/></a>。可以排序字段类型有：keyword类型、数值类型、地理坐标类型、日期类型等。</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210721195728306.png" alt="image-20210721195728306" tabindex="0" loading="lazy"><figcaption>image-20210721195728306</figcaption></figure>
...
<p>提示：获取你的位置的经纬度的方式：<a href="https://lbs.amap.com/demo/jsapi-v2/example/map/click-to-get-lnglat/" target="_blank" rel="noopener noreferrer">https://lbs.amap.com/demo/jsapi-v2/example/map/click-to-get-lnglat/<ExternalLinkIcon/></a></p>
<p>假设我的位置是：31.034661，121.612282，寻找我周围距离最近的酒店。</p>
<figure><img src="@source/src/必会工具/assets/image-20210721200214690.png" alt="image-20210721200214690" tabindex="0" loading="lazy"><figcaption>image-20210721200214690</figcaption></figure>
...
<p>类似于mysql中的<code v-pre>limit ?, ?</code></p>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里是查询990开始的数据，也就是 第990~第1000条 数据。</p>
<p>不过，elasticsearch内部分页时，必须先查询 0~1000条，然后截取其中的990 ~ 1000的这10条：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721200643029.png" alt="image-20210721200643029" tabindex="0" loading="lazy"><figcaption>image-20210721200643029</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721201003229.png" alt="image-20210721201003229" tabindex="0" loading="lazy"><figcaption>image-20210721201003229</figcaption></figure>
...
<p>针对深度分页，ES提供了两种解决方案，<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/paginate-search-results.html" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a>：</p>
<ul>
...
<figure><img src="@source/src/必会工具/assets/image-20210721202705030.png" alt="image-20210721202705030" tabindex="0" loading="lazy"><figcaption>image-20210721202705030</figcaption></figure>
<p>高亮显示的实现分为两步：</p>
<ul>
<li>1）给文档中的所有关键字都添加一个标签，例如<code v-pre>&lt;em&gt;</code>标签</li>
<li>2）页面给<code v-pre>&lt;em&gt;</code>标签编写CSS样式</li>
</ul>
...
<li><strong>如果要对非搜索字段高亮，则需要添加一个属性：required_field_match=false</strong></li>
</ul>
<p><strong>示例</strong>：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721203349633.png" alt="image-20210721203349633" tabindex="0" loading="lazy"><figcaption>image-20210721203349633</figcaption></figure>
...
<p>示例：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721203657850.png" alt="image-20210721203657850" tabindex="0" loading="lazy"><figcaption>image-20210721203657850</figcaption></figure>
<h1 id="_3-restclient查询文档" tabindex="-1"><a class="header-anchor" href="#_3-restclient查询文档" aria-hidden="true">#</a> 3.RestClient查询文档</h1>
<ul>
<li>1）准备Request对象</li>
<li>2）准备请求参数</li>
<li>3）发起请求</li>
...
<figure><img src="@source/src/必会工具/assets/image-20210721203950559.png" alt="image-20210721203950559" tabindex="0" loading="lazy"><figcaption>image-20210721203950559</figcaption></figure>
<p>代码解读：</p>
<ul>
<li>
...
<li>
<p>第二步，利用<code v-pre>request.source()</code>构建DSL，DSL中可以包含查询、分页、排序、高亮等</p>
<ul>
<li><code v-pre>query()</code>：代表查询条件，利用<code v-pre>QueryBuilders.matchAllQuery()</code>构建一个match_all查询的DSL</li>
</ul>
</li>
<li>
...
<p>这里关键的API有两个，一个是<code v-pre>request.source()</code>，其中包含了查询、排序、分页、高亮等所有功能：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721215640790.png" alt="image-20210721215640790" tabindex="0" loading="lazy"><figcaption>image-20210721215640790</figcaption></figure>
<p>另一个是<code v-pre>QueryBuilders</code>，其中包含match、term、function_score、bool等各种查询：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721215729236.png" alt="image-20210721215729236" tabindex="0" loading="lazy"><figcaption>image-20210721215729236</figcaption></figure>
<h3 id="_3-1-2-解析响应" tabindex="-1"><a class="header-anchor" href="#_3-1-2-解析响应" aria-hidden="true">#</a> 3.1.2.解析响应</h3>
<p>响应结果的解析：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721214221057.png" alt="image-20210721214221057" tabindex="0" loading="lazy"><figcaption>image-20210721214221057</figcaption></figure>
<p>elasticsearch返回的结果是一个JSON字符串，结构包含：</p>
<ul>
<li><code v-pre>hits</code>：命中的结果
<ul>
<li><code v-pre>total</code>：总条数，其中的value是具体的总条数值</li>
<li><code v-pre>max_score</code>：所有结果中得分最高的文档的相关性算分</li>
<li><code v-pre>hits</code>：搜索结果的文档数组，其中的每个文档都是一个json对象
<ul>
<li><code v-pre>_source</code>：文档中的原始数据，也是json对象</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li><code v-pre>SearchHits</code>：通过response.getHits()获取，就是JSON中的最外层的hits，代表命中的结果
<ul>
<li><code v-pre>SearchHits#getTotalHits().value</code>：获取总条数信息</li>
<li><code v-pre>SearchHits#getHits()</code>：获取SearchHit数组，也就是文档数组
<ul>
<li><code v-pre>SearchHit#getSourceAsString()</code>：获取文档结果中的_source，也就是原始的json文档数据</li>
</ul>
</li>
</ul>
</li>
...
<h2 id="_3-2-match查询" tabindex="-1"><a class="header-anchor" href="#_3-2-match查询" aria-hidden="true">#</a> 3.2.match查询</h2>
<p>全文检索的match和multi_match查询与match_all的API基本一致。差别是查询条件，也就是query的部分。</p>
<figure><img src="@source/src/必会工具/assets/image-20210721215923060.png" alt="image-20210721215923060" tabindex="0" loading="lazy"><figcaption>image-20210721215923060</figcaption></figure>
<p>因此，Java代码上的差异主要是request.source().query()中的参数了。同样是利用QueryBuilders提供的方法：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721215843099.png" alt="image-20210721215843099" tabindex="0" loading="lazy"><figcaption>image-20210721215843099</figcaption></figure>
...
<p>查询条件构造的API如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721220305140.png" alt="image-20210721220305140" tabindex="0" loading="lazy"><figcaption>image-20210721220305140</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721220927286.png" alt="image-20210721220927286" tabindex="0" loading="lazy"><figcaption>image-20210721220927286</figcaption></figure>
...
<p>对应的API如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721221121266.png" alt="image-20210721221121266" tabindex="0" loading="lazy"><figcaption>image-20210721221121266</figcaption></figure>
<p>完整代码示例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>高亮请求的构建API如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721221744883.png" alt="image-20210721221744883" tabindex="0" loading="lazy"><figcaption>image-20210721221744883</figcaption></figure>
...
<p>因此解析高亮的代码需要额外处理：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721222057212.png" alt="image-20210721222057212" tabindex="0" loading="lazy"><figcaption>image-20210721222057212</figcaption></figure>
<p>代码解读：</p>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">handleResponse</span><span class="token punctuation">(</span><span class="token class-name">SearchResponse</span> response<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4-旅游案例" tabindex="-1"><a class="header-anchor" href="#_4-旅游案例" aria-hidden="true">#</a> 4.旅游案例</h1>
<p>下面，我们通过旅游的案例来实战演练下之前学习的知识。</p>
<p>我们实现四部分功能：</p>
<ul>
<li>酒店搜索和分页</li>
<li>酒店结果过滤</li>
...
<p>启动我们提供的hotel-demo项目，其默认端口是8089，访问<a href="http://localhost:8090" target="_blank" rel="noopener noreferrer">http://localhost:8090<ExternalLinkIcon/></a>，就能看到项目页面了：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721223159598.png" alt="image-20210721223159598" tabindex="0" loading="lazy"><figcaption>image-20210721223159598</figcaption></figure>
<h2 id="_4-1-酒店搜索和分页" tabindex="-1"><a class="header-anchor" href="#_4-1-酒店搜索和分页" aria-hidden="true">#</a> 4.1.酒店搜索和分页</h2>
<p>案例需求：实现旅游的酒店搜索功能，完成关键字搜索和分页</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210721223859419.png" alt="image-20210721223859419" tabindex="0" loading="lazy"><figcaption>image-20210721223859419</figcaption></figure>
<p>点击搜索按钮，可以看到浏览器控制台发出了请求：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721224033789.png" alt="image-20210721224033789" tabindex="0" loading="lazy"><figcaption>image-20210721224033789</figcaption></figure>
<p>请求参数如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210721224112708.png" alt="image-20210721224112708" tabindex="0" loading="lazy"><figcaption>image-20210721224112708</figcaption></figure>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因此，我们在<code v-pre>cn.beisheng.hotel.pojo</code>包下定义一个实体类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
<p>因此，我们在<code v-pre>cn.beisheng.hotel.pojo</code>中定义返回结果：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>pojo</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PageResult</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-1-3-定义controller" tabindex="-1"><a class="header-anchor" href="#_4-1-3-定义controller" aria-hidden="true">#</a> 4.1.3.定义controller</h3>
...
<p>因此，我们在<code v-pre>cn.beisheng.hotel.web</code>中定义HotelController：</p>
...
<p>1）在<code v-pre>cn.beisheng.hotel.service</code>中的<code v-pre>IHotelService</code>接口中定义一个方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）实现搜索业务，肯定离不开RestHighLevelClient，我们需要把它注册到Spring中作为一个Bean。在<code v-pre>cn.beisheng.hotel</code>中的<code v-pre>HotelDemoApplication</code>中声明这个Bean：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）在<code v-pre>cn.beisheng.hotel.service.impl</code>中的<code v-pre>HotelService</code>中实现search方法：</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210722091940726.png" alt="image-20210722091940726" tabindex="0" loading="lazy"><figcaption>image-20210722091940726</figcaption></figure>
<p>传递的参数如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722092051994.png" alt="image-20210722092051994" tabindex="0" loading="lazy"><figcaption>image-20210722092051994</figcaption></figure>
<p>包含的过滤条件有：</p>
<ul>
<li>brand：品牌值</li>
<li>city：城市</li>
...
<p>修改在<code v-pre>cn.beisheng.hotel.pojo</code>包下的实体类RequestParams：</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210722092935453.png" alt="image-20210722092935453" tabindex="0" loading="lazy"><figcaption>image-20210722092935453</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210722093414542.png" alt="image-20210722093414542" tabindex="0" loading="lazy"><figcaption>image-20210722093414542</figcaption></figure>
<p>并且，在前端会发起查询请求，将你的坐标发送到服务端：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722093642382.png" alt="image-20210722093642382" tabindex="0" loading="lazy"><figcaption>image-20210722093642382</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-3-距离排序api" tabindex="-1"><a class="header-anchor" href="#_4-3-3-距离排序api" aria-hidden="true">#</a> 4.3.3.距离排序API</h3>
...
<span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的java代码示例：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722095227059.png" alt="image-20210722095227059" tabindex="0" loading="lazy"><figcaption>image-20210722095227059</figcaption></figure>
<h3 id="_4-3-4-添加距离排序" tabindex="-1"><a class="header-anchor" href="#_4-3-4-添加距离排序" aria-hidden="true">#</a> 4.3.4.添加距离排序</h3>
<p>在<code v-pre>cn.beisheng.hotel.service.impl</code>的<code v-pre>HotelService</code>的<code v-pre>search</code>方法中，添加一个排序功能：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722095902314.png" alt="image-20210722095902314" tabindex="0" loading="lazy"><figcaption>image-20210722095902314</figcaption></figure>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token class-name">PageResult</span> <span class="token function">search</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">try</span> <span class="token punctuation">{</span>
...
<p>重启服务后，测试我的酒店功能：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722100040674.png" alt="image-20210722100040674" tabindex="0" loading="lazy"><figcaption>image-20210722100040674</figcaption></figure>
<p>发现确实可以实现对我附近酒店的排序，不过并没有看到酒店到底距离我多远，这该怎么办？</p>
<p>排序完成后，页面还要获取我附近每个酒店的具体<strong>距离</strong>值，这个值在响应结果中是独立的：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722095648542.png" alt="image-20210722095648542" tabindex="0" loading="lazy"><figcaption>image-20210722095648542</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）修改HotelService中的handleResponse方法</p>
<figure><img src="@source/src/必会工具/assets/image-20210722100613966.png" alt="image-20210722100613966" tabindex="0" loading="lazy"><figcaption>image-20210722100613966</figcaption></figure>
<p>重启后测试，发现页面能成功显示距离了：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722100838604.png" alt="image-20210722100838604" tabindex="0" loading="lazy"><figcaption>image-20210722100838604</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210722100947292.png" alt="image-20210722100947292" tabindex="0" loading="lazy"><figcaption>image-20210722100947292</figcaption></figure>
...
<h3 id="_4-4-2-修改hoteldoc实体" tabindex="-1"><a class="header-anchor" href="#_4-4-2-修改hoteldoc实体" aria-hidden="true">#</a> 4.4.2.修改HotelDoc实体</h3>
<p>给<code v-pre>cn.beisheng.hotel.pojo</code>包下的HotelDoc类添加isAD字段：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722101908062.png" alt="image-20210722101908062" tabindex="0" loading="lazy"><figcaption>image-20210722101908062</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210721191544750.png" alt="image-20210721191544750" tabindex="0" loading="lazy"><figcaption>image-20210721191544750</figcaption></figure>
<p>对应的JavaAPI如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210722102850818.png" alt="image-20210722102850818" tabindex="0" loading="lazy"><figcaption>image-20210722102850818</figcaption></figure>
...
<p>修改<code v-pre>cn.beisheng.hotel.service.impl</code>包下的<code v-pre>HotelService</code>类中的<code v-pre>buildBasicQuery</code>方法，添加算分函数查询：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">buildBasicQuery</span><span class="token punctuation">(</span><span class="token class-name">RequestParams</span> params<span class="token punctuation">,</span> <span class="token class-name">SearchRequest</span> request<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 1.构建BooleanQuery</span>
    <span class="token class-name">BoolQueryBuilder</span> boolQuery <span class="token operator">=</span> <span class="token class-name">QueryBuilders</span><span class="token punctuation">.</span><span class="token function">boolQuery</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
