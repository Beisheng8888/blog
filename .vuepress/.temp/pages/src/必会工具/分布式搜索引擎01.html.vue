<template><div><h1 id="分布式搜索引擎01" tabindex="-1"><a class="header-anchor" href="#分布式搜索引擎01" aria-hidden="true">#</a> 分布式搜索引擎01</h1>
<p>-- elasticsearch基础</p>
<h1 id="_1-初识elasticsearch" tabindex="-1"><a class="header-anchor" href="#_1-初识elasticsearch" aria-hidden="true">#</a> 1.初识elasticsearch</h1>
<h2 id="_1-1-了解es" tabindex="-1"><a class="header-anchor" href="#_1-1-了解es" aria-hidden="true">#</a> 1.1.了解ES</h2>
<h3 id="_1-1-1-elasticsearch的作用" tabindex="-1"><a class="header-anchor" href="#_1-1-1-elasticsearch的作用" aria-hidden="true">#</a> 1.1.1.elasticsearch的作用</h3>
<p>elasticsearch是一款非常强大的开源搜索引擎，具备非常多强大功能，可以帮助我们从海量数据中快速找到需要的内容</p>
<p>例如：</p>
<ul>
<li>
<p>在GitHub搜索代码</p>
<figure><img src="@source/src/必会工具/assets/image-20210720193623245.png" alt="image-20210720193623245" tabindex="0" loading="lazy"><figcaption>image-20210720193623245</figcaption></figure>
</li>
<li>
<p>在电商网站搜索商品</p>
<figure><img src="@source/src/必会工具/assets/image-20210720193633483.png" alt="image-20210720193633483" tabindex="0" loading="lazy"><figcaption>image-20210720193633483</figcaption></figure>
</li>
<li>
<p>在百度搜索答案</p>
<figure><img src="@source/src/必会工具/assets/image-20210720193641907.png" alt="image-20210720193641907" tabindex="0" loading="lazy"><figcaption>image-20210720193641907</figcaption></figure>
</li>
<li>
<p>在打车软件搜索附近的车</p>
<figure><img src="@source/src/必会工具/assets/image-20210720193648044.png" alt="image-20210720193648044" tabindex="0" loading="lazy"><figcaption>image-20210720193648044</figcaption></figure>
</li>
</ul>
<h3 id="_1-1-2-elk技术栈" tabindex="-1"><a class="header-anchor" href="#_1-1-2-elk技术栈" aria-hidden="true">#</a> 1.1.2.ELK技术栈</h3>
<p>elasticsearch结合kibana、Logstash、Beats，也就是elastic stack（ELK）。被广泛应用在日志数据分析、实时监控等领域：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720194008781.png" alt="image-20210720194008781" tabindex="0" loading="lazy"><figcaption>image-20210720194008781</figcaption></figure>
<p>而elasticsearch是elastic stack的核心，负责存储、搜索、分析数据。</p>
<figure><img src="@source/src/必会工具/assets/image-20210720194230265.png" alt="image-20210720194230265" tabindex="0" loading="lazy"><figcaption>image-20210720194230265</figcaption></figure>
<h3 id="_1-1-3-elasticsearch和lucene" tabindex="-1"><a class="header-anchor" href="#_1-1-3-elasticsearch和lucene" aria-hidden="true">#</a> 1.1.3.elasticsearch和lucene</h3>
<p>elasticsearch底层是基于<strong>lucene</strong>来实现的。</p>
<p><strong>Lucene</strong>是一个Java语言的搜索引擎类库，是Apache公司的顶级项目，由DougCutting于1999年研发。官网地址：<a href="https://lucene.apache.org/" target="_blank" rel="noopener noreferrer">https://lucene.apache.org/<ExternalLinkIcon/></a> 。</p>
<figure><img src="@source/src/必会工具/assets/image-20210720194547780.png" alt="image-20210720194547780" tabindex="0" loading="lazy"><figcaption>image-20210720194547780</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210720195001221.png" alt="image-20210720195001221" tabindex="0" loading="lazy"><figcaption>image-20210720195001221</figcaption></figure>
...
<p>目前比较知名的搜索引擎技术排名：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720195142535.png" alt="image-20210720195142535" tabindex="0" loading="lazy"><figcaption>image-20210720195142535</figcaption></figure>
<p>虽然在早期，Apache Solr是最主要的搜索引擎技术，但随着发展elasticsearch已经渐渐超越了Solr，独占鳌头：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720195306484.png" alt="image-20210720195306484" tabindex="0" loading="lazy"><figcaption>image-20210720195306484</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210720195531539.png" alt="image-20210720195531539" tabindex="0" loading="lazy"><figcaption>image-20210720195531539</figcaption></figure>
<p>如果是根据id查询，那么直接走索引，查询速度非常快。</p>
<p>但如果是基于title做模糊查询，只能是逐行扫描数据，流程如下：</p>
<p>1）用户搜索数据，条件是title符合<code v-pre>&quot;%手机%&quot;</code></p>
...
<p>如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720200457207.png" alt="image-20210720200457207" tabindex="0" loading="lazy"><figcaption>image-20210720200457207</figcaption></figure>
...
<p>如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720201115192.png" alt="image-20210720201115192" tabindex="0" loading="lazy"><figcaption>image-20210720201115192</figcaption></figure>
...
<h2 id="_1-3-es的一些概念" tabindex="-1"><a class="header-anchor" href="#_1-3-es的一些概念" aria-hidden="true">#</a> 1.3.es的一些概念</h2>
...
<figure><img src="@source/src/必会工具/assets/image-20210720202707797.png" alt="image-20210720202707797" tabindex="0" loading="lazy"><figcaption>image-20210720202707797</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210720203022172.png" alt="image-20210720203022172" tabindex="0" loading="lazy"><figcaption>image-20210720203022172</figcaption></figure>
<p><strong>因此，我们可以把索引当做是数据库中的表</strong>。</p>
<p>数据库的表会有约束信息，用来定义表的结构、字段的名称、类型等信息。因此，索引库中就有<strong>映射（mapping）</strong>，是索引中文档的字段约束信息，类似表的结构约束。</p>
<h3 id="_1-3-3-mysql与elasticsearch" tabindex="-1"><a class="header-anchor" href="#_1-3-3-mysql与elasticsearch" aria-hidden="true">#</a> 1.3.3.mysql与elasticsearch</h3>
...
<ul>
<li>
<p><strong>Mysql：擅长事务类型操作，可以确保数据的安全和一致性</strong></p>
</li>
<li>
<p><strong>Elasticsearch：擅长海量数据的搜索、分析、计算</strong></p>
</li>
</ul>
<p>因此在企业中，往往是两者结合使用：</p>
<ul>
<li><strong>对安全性要求较高的写操作，使用mysql实现</strong></li>
<li><strong>对查询性能要求较高的搜索需求，使用elasticsearch实现</strong></li>
<li><strong>两者再基于某种方式，实现数据的同步，保证一致性</strong></li>
</ul>
<figure><img src="@source/src/必会工具/assets/image-20210720203534945.png" alt="image-20210720203534945" tabindex="0" loading="lazy"><figcaption>image-20210720203534945</figcaption></figure>
<h2 id="_1-4-安装es、kibana" tabindex="-1"><a class="header-anchor" href="#_1-4-安装es、kibana" aria-hidden="true">#</a> 1.4.安装es、kibana</h2>
<h3 id="_1-4-1-安装" tabindex="-1"><a class="header-anchor" href="#_1-4-1-安装" aria-hidden="true">#</a> 1.4.1.安装</h3>
<p>参考资料：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720203805350.png" alt="image-20210720203805350" tabindex="0" loading="lazy"><figcaption>image-20210720203805350</figcaption></figure>
...
<h2 id="_2-1-mapping映射属性" tabindex="-1"><a class="header-anchor" href="#_2-1-mapping映射属性" aria-hidden="true">#</a> 2.1.mapping映射属性</h2>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token property">"info"</span><span class="token operator">:</span> <span class="token string">"Java"</span><span class="token punctuation">,</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"zy@beisheng.cn"</span><span class="token punctuation">,</span>
...
<h2 id="_2-2-索引库的crud" tabindex="-1"><a class="header-anchor" href="#_2-2-索引库的crud" aria-hidden="true">#</a> 2.2.索引库的CRUD</h2>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /beisheng
<span class="token punctuation">{</span>
  <span class="token property">"mappings"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"properties"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/必会工具/assets/image-20210720211019329.png" alt="image-20210720211019329" tabindex="0" loading="lazy"><figcaption>image-20210720211019329</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210720212357390.png" alt="image-20210720212357390" tabindex="0" loading="lazy"><figcaption>image-20210720212357390</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在kibana中测试：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720212123420.png" alt="image-20210720212123420" tabindex="0" loading="lazy"><figcaption>image-20210720212123420</figcaption></figure>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /beisheng/_doc/<span class="token number">1</span>
<span class="token punctuation">{</span>
    <span class="token property">"info"</span><span class="token operator">:</span> <span class="token string">"程序员Java讲师"</span><span class="token punctuation">,</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"zy@126.cn"</span><span class="token punctuation">,</span>
    <span class="token property">"name"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
        <span class="token property">"firstName"</span><span class="token operator">:</span> <span class="token string">"云"</span><span class="token punctuation">,</span>
        <span class="token property">"lastName"</span><span class="token operator">:</span> <span class="token string">"赵"</span>
    <span class="token punctuation">}</span>
...
<figure><img src="@source/src/必会工具/assets/image-20210720212933362.png" alt="image-20210720212933362" tabindex="0" loading="lazy"><figcaption>image-20210720212933362</figcaption></figure>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>通过kibana查看数据：</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token constant">GET</span> <span class="token operator">/</span>beisheng<span class="token operator">/</span>_doc<span class="token operator">/</span><span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>查看结果：</strong></p>
<figure><img src="@source/src/必会工具/assets/image-20210720213345003.png" alt="image-20210720213345003" tabindex="0" loading="lazy"><figcaption>image-20210720213345003</figcaption></figure>
...
DELETE /beisheng/_doc/<span class="token number">1</span>
...
<figure><img src="@source/src/必会工具/assets/image-20210720213634918.png" alt="image-20210720213634918" tabindex="0" loading="lazy"><figcaption>image-20210720213634918</figcaption></figure>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>PUT /beisheng/_doc/<span class="token number">1</span>
<span class="token punctuation">{</span>
    <span class="token property">"info"</span><span class="token operator">:</span> <span class="token string">"Java"</span><span class="token punctuation">,</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"zy@beisheng.cn"</span><span class="token punctuation">,</span>
    <span class="token property">"name"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code>POST /beisheng/_update/<span class="token number">1</span>
<span class="token punctuation">{</span>
  <span class="token property">"doc"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">"email"</span><span class="token operator">:</span> <span class="token string">"ZhaoYun@beisheng.cn"</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<p>ES官方提供了各种不同语言的客户端，用来操作ES。这些客户端的本质就是组装DSL语句，通过http请求发送给ES。官方文档地址：<a href="https://www.elastic.co/guide/en/elasticsearch/client/index.html" target="_blank" rel="noopener noreferrer">https://www.elastic.co/guide/en/elasticsearch/client/index.html<ExternalLinkIcon/></a></p>
<p>其中的Java Rest Client又包括两种：</p>
<ul>
<li>Java Low Level Rest Client</li>
<li>Java High Level Rest Client</li>
</ul>
<figure><img src="@source/src/必会工具/assets/image-20210720214555863.png" alt="image-20210720214555863" tabindex="0" loading="lazy"><figcaption>image-20210720214555863</figcaption></figure>
<p>我们学习的是Java HighLevel Rest Client客户端API</p>
<h2 id="_4-0-导入demo工程" tabindex="-1"><a class="header-anchor" href="#_4-0-导入demo工程" aria-hidden="true">#</a> 4.0.导入Demo工程</h2>
<h3 id="_4-0-1-导入数据" tabindex="-1"><a class="header-anchor" href="#_4-0-1-导入数据" aria-hidden="true">#</a> 4.0.1.导入数据</h3>
<p>首先导入资料提供的数据库数据：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720220400297.png" alt="image-20210720220400297" tabindex="0" loading="lazy"><figcaption>image-20210720220400297</figcaption></figure>
<p>数据结构如下：</p>
...
<p>然后导入资料提供的项目:</p>
<figure><img src="@source/src/必会工具/assets/image-20210720220503411.png" alt="image-20210720220503411" tabindex="0" loading="lazy"><figcaption>image-20210720220503411</figcaption></figure>
<p>项目结构如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720220647541.png" alt="image-20210720220647541" tabindex="0" loading="lazy"><figcaption>image-20210720220647541</figcaption></figure>
<h3 id="_4-0-3-mapping映射分析" tabindex="-1"><a class="header-anchor" href="#_4-0-3-mapping映射分析" aria-hidden="true">#</a> 4.0.3.mapping映射分析</h3>
...
<p>地理坐标说明：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720222110126.png" alt="image-20210720222110126" tabindex="0" loading="lazy"><figcaption>image-20210720222110126</figcaption></figure>
<p>copy_to说明：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720222221516.png" alt="image-20210720222221516" tabindex="0" loading="lazy"><figcaption>image-20210720222221516</figcaption></figure>
<h3 id="_4-0-4-初始化restclient" tabindex="-1"><a class="header-anchor" href="#_4-0-4-初始化restclient" aria-hidden="true">#</a> 4.0.4.初始化RestClient</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2）因为SpringBoot默认的ES版本是7.6.2，所以我们需要覆盖默认的ES版本：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）初始化RestHighLevelClient：</p>
<p>初始化的代码如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里为了单元测试方便，我们创建一个测试类HotelIndexTest，然后将初始化的代码编写在@BeforeEach方法中：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>hotel</span><span class="token punctuation">;</span>
...
<p>创建索引库的API如下：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720223049408.png" alt="image-20210720223049408" tabindex="0" loading="lazy"><figcaption>image-20210720223049408</figcaption></figure>
<p>代码分为三步：</p>
<ul>
...
<p>在hotel-demo的cn.beisheng.hotel.constants包下，创建一个类，定义mapping映射的JSON字符串常量：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>constants</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在hotel-demo中的HotelIndexTest测试类中，编写单元测试，实现创建索引：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>因此与删除的Java代码流程是类似的。依然是三步走：</p>
<ul>
...
<h1 id="_5-restclient操作文档" tabindex="-1"><a class="header-anchor" href="#_5-restclient操作文档" aria-hidden="true">#</a> 5.RestClient操作文档</h1>
...
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>hotel<span class="token punctuation">.</span>pojo<span class="token punctuation">.</span></span><span class="token class-name">Hotel</span></span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的java代码如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720230027240.png" alt="image-20210720230027240" tabindex="0" loading="lazy"><figcaption>image-20210720230027240</figcaption></figure>
...
<p>变化的地方在于，<a href="http://xn--client-vt9in98k266am0d6y0gd5e.xxx" target="_blank" rel="noopener noreferrer">这里直接使用client.xxx<ExternalLinkIcon/></a>()的API，不再需要client.indices()了。</p>
...
<figure><img src="@source/src/必会工具/assets/image-20210720230811674.png" alt="image-20210720230811674" tabindex="0" loading="lazy"><figcaption>image-20210720230811674</figcaption></figure>
<p>可以看到，结果是一个JSON，其中文档放在一个<code v-pre>_source</code>属性中，因此解析就是拿到<code v-pre>_source</code>，反序列化为Java对象即可。</p>
<p>与之前类似，也是三步走：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>与查询相比，仅仅是请求方式从DELETE变成GET，可以想象Java代码应该依然是三步走：</p>
<ul>
...
<p>代码示例如图：</p>
<figure><img src="@source/src/必会工具/assets/image-20210720231040875.png" alt="image-20210720231040875" tabindex="0" loading="lazy"><figcaption>image-20210720231040875</figcaption></figure>
<p>与之前类似，也是三步走：</p>
<ul>
...
<figure><img src="@source/src/必会工具/assets/image-20210720232105943.png" alt="image-20210720232105943" tabindex="0" loading="lazy"><figcaption>image-20210720232105943</figcaption></figure>
<p>可以看到，能添加的请求包括：</p>
<ul>
...
<figure><img src="@source/src/必会工具/assets/image-20210720232431383.png" alt="image-20210720232431383" tabindex="0" loading="lazy"><figcaption>image-20210720232431383</figcaption></figure>
<p>其实还是三步走：</p>
<ul>
