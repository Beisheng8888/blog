...
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-0" disabled="disabled"><label class="task-list-item-label" for="task-item-0"> 基于内存存储，读写性能高</label></li>
</ul>
<figure><img src="@source/src/必会工具/assets/image-20210927090555559.png" alt="image-20210927090555559" tabindex="0" loading="lazy"><figcaption>image-20210927090555559</figcaption></figure>
<ul class="task-list-container">
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-1" disabled="disabled"><label class="task-list-item-label" for="task-item-1"> 适合存储热点数据（热点商品、资讯、新闻）</label></li>
</ul>
<figure><img src="@source/src/必会工具/assets/image-20210927090604994.png" alt="image-20210927090604994" tabindex="0" loading="lazy"><figcaption>image-20210927090604994</figcaption></figure>
<ul class="task-list-container">
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" id="task-item-2" disabled="disabled"><label class="task-list-item-label" for="task-item-2"> 企业应用广泛</label></li>
</ul>
<figure><img src="@source/src/必会工具/assets/image-20210927090612540.png" alt="image-20210927090612540" tabindex="0" loading="lazy"><figcaption>image-20210927090612540</figcaption></figure>
...
<ul>
<li>Windows版下载地址：<a href="https://github.com/microsoftarchive/redis/releases" target="_blank" rel="noopener noreferrer">https://github.com/microsoftarchive/redis/releases<ExternalLinkIcon/></a></li>
<li>Linux版下载地址： <a href="https://download.redis.io/releases/" target="_blank" rel="noopener noreferrer">https://download.redis.io/releases/<ExternalLinkIcon/></a></li>
</ul>
<p>下载后得到下面安装包：</p>
<figure><img src="@source/src/必会工具/assets/image-20210927092053283.png" alt="image-20210927092053283" tabindex="0" loading="lazy"><figcaption>image-20210927092053283</figcaption></figure>
...
<li>解压安装包，命令：<mark>tar -zxvf redis-4.0.0.tar.gz -C /usr/local</mark></li>
<li>安装Redis的依赖环境gcc，命令：<mark>yum install gcc-c++</mark></li>
<li>进入/usr/local/redis-4.0.0，进行编译，命令：<mark>make</mark></li>
<li>进入redis的src目录进行安装，命令：<mark>make install</mark></li>
</ol>
<p>安装后重点文件说明：</p>
<blockquote>
...
<figure><img src="@source/src/必会工具/assets/image-20210927093112281.png" alt="image-20210927093112281" tabindex="0" loading="lazy"><figcaption>image-20210927093112281</figcaption></figure>
...
<p>执行Redis服务启动脚本文件<mark>redis-server</mark>：</p>
<figure><img src="@source/src/必会工具/assets/image-20210927094452556.png" alt="image-20210927094452556" tabindex="0" loading="lazy"><figcaption>image-20210927094452556</figcaption></figure>
<p>通过启动日志可以看到，Redis默认端口号为<mark>6379</mark>。</p>
<p><mark>Ctrl + C</mark>停止Redis服务</p>
<p>通过<mark>redis-cli</mark>可以连接到本地的Redis服务，默认情况下不需要认证即可连接成功。</p>
<p>退出客户端可以输入<mark>exit</mark>或者<mark>quit</mark>命令。</p>
<p><strong>2）Windows系统中启动和停止Redis</strong></p>
<p>Windows系统中启动Redis，直接双击redis-server.exe即可启动Redis服务，redis服务默认端口号为6379</p>
<figure><img src="@source/src/必会工具/assets/image-20210927100421213.png" alt="image-20210927100421213" tabindex="0" loading="lazy"><figcaption>image-20210927100421213</figcaption></figure>
<p><mark>Ctrl + C</mark>停止Redis服务</p>
<p>双击<mark>redis-cli.exe</mark>即可启动Redis客户端，默认连接的是本地的Redis服务，而且不需要认证即可连接成功。</p>
<figure><img src="@source/src/必会工具/assets/image-20210927100319016.png" alt="image-20210927100319016" tabindex="0" loading="lazy"><figcaption>image-20210927100319016</figcaption></figure>
<p>退出客户端可以输入<mark>exit</mark>或者<mark>quit</mark>命令。</p>
...
<p>**1）**设置Redis服务后台运行</p>
<p>​	将配置文件中的<mark>daemonize</mark>配置项改为yes，默认值为no。</p>
<p>​	注意：Windows版的Redis不支持后台运行。</p>
<p>**2）**设置Redis服务密码</p>
<p>​	将配置文件中的 <mark># requirepass foobared</mark> 配置项取消注释，默认为注释状态。foobared为密码，可以根据情况自己指定。</p>
<p>**3）**设置允许客户端远程连接Redis服务</p>
<p>​	Redis服务默认只能客户端本地连接，不允许客户端远程连接。将配置文件中的 <mark>bind 127.0.0.1</mark> 配置项注释掉。</p>
<p><strong>解释说明：</strong></p>
<blockquote>
<p>Redis配置文件中 <mark>#</mark> 表示注释</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code># 进入Redis安装目录
...
<figure><img src="@source/src/必会工具/assets/image-20210927104929169.png" alt="image-20210927104929169" tabindex="0" loading="lazy"><figcaption>image-20210927104929169</figcaption></figure>
<p>由于Redis配置文件中开启了认证校验，即客户端连接时需要提供密码，此时客户端连接方式变为：</p>
<figure><img src="@source/src/必会工具/assets/image-20210927105909600.png" alt="image-20210927105909600" tabindex="0" loading="lazy"><figcaption>image-20210927105909600</figcaption></figure>
<p><strong>解释说明：</strong></p>
<blockquote>
...
<figure><img src="@source/src/必会工具/assets/image-20210927111819871.png" alt="image-20210927111819871" tabindex="0" loading="lazy"><figcaption>image-20210927111819871</figcaption></figure>
<p><strong>解释说明：</strong></p>
<blockquote>
...
<p>更多命令可以参考Redis中文网：<a href="https://www.redis.net.cn" target="_blank" rel="noopener noreferrer">https://www.redis.net.cn<ExternalLinkIcon/></a></p>
...
<figure><img src="@source/src/必会工具/assets/image-20210927113014567.png" alt="image-20210927113014567" tabindex="0" loading="lazy"><figcaption>image-20210927113014567</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210927113312384.png" alt="image-20210927113312384" tabindex="0" loading="lazy"><figcaption>image-20210927113312384</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210927113632472.png" alt="image-20210927113632472" tabindex="0" loading="lazy"><figcaption>image-20210927113632472</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210927114003383.png" alt="image-20210927114003383" tabindex="0" loading="lazy"><figcaption>image-20210927114003383</figcaption></figure>
...
<p>示例代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>test</span><span class="token punctuation">;</span>
...
<p>网址：<a href="https://spring.io/projects/spring-data-redis" target="_blank" rel="noopener noreferrer">https://spring.io/projects/spring-data-redis<ExternalLinkIcon/></a></p>
<figure><img src="@source/src/必会工具/assets/image-20210927143741458.png" alt="image-20210927143741458" tabindex="0" loading="lazy"><figcaption>image-20210927143741458</figcaption></figure>
<p>maven坐标：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<p>第四步：提供配置类</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>config</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testCommon</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token class-name">Boolean</span> beisheng <span class="token operator">=</span> redisTemplate<span class="token punctuation">.</span><span class="token function">hasKey</span><span class="token punctuation">(</span><span class="token string">"beisheng"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>beisheng<span class="token punctuation">)</span><span class="token punctuation">;</span>
