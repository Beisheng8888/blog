...
<figure><img src="@source/src/必会工具/assets/image-20210729230059884.png" alt="image-20210729230059884" tabindex="0" loading="lazy"><figcaption>image-20210729230059884</figcaption></figure>
...
<p>4）Saturn： 唯品会开源的一个分布式任务调度平台，基于Elastic-job，可以全域统一配置，统一监<br>
控，具有任务高可用以及分片功能。</p>
<p>XXL-JOB是一个分布式任务调度平台，其核心设计目标是开发迅速、学习简单、轻量级、易扩展。现已开放源代码并接入多家公司线上产品线，开箱即用。</p>
<p>源码地址：<a href="https://gitee.com/xuxueli0323/xxl-job" target="_blank" rel="noopener noreferrer">https://gitee.com/xuxueli0323/xxl-job<ExternalLinkIcon/></a></p>
<p>文档地址：<a href="https://www.xuxueli.com/xxl-job/" target="_blank" rel="noopener noreferrer">https://www.xuxueli.com/xxl-job/<ExternalLinkIcon/></a></p>
<p><strong>特性</strong></p>
<ul>
<li><strong>简单灵活</strong><br>
提供Web页面对任务进行管理，管理系统支持用户管理、权限控制；<br>
支持容器部署；<br>
支持通过通用HTTP提供跨平台任务调度；</li>
<li><strong>丰富的任务管理功能</strong><br>
支持页面对任务CRUD操作；<br>
支持在页面编写脚本任务、命令行任务、Java代码任务并执行；<br>
支持任务级联编排，父任务执行结束后触发子任务执行；<br>
支持设置指定任务执行节点路由策略，包括轮询、随机、广播、故障转移、忙碌转移等；<br>
支持Cron方式、任务依赖、调度中心API接口方式触发任务执行</li>
<li><strong>高性能</strong><br>
任务调度流程全异步化设计实现，如异步调度、异步运行、异步回调等，有效对密集调度进行流量削峰；</li>
<li><strong>高可用</strong><br>
任务调度中心、任务执行节点均 集群部署，支持动态扩展、故障转移<br>
支持任务配置路由故障转移策略，执行器节点不可用是自动转移到其他节点执行<br>
支持任务超时控制、失败重试配置<br>
支持任务处理阻塞策略：调度当任务执行节点忙碌时来不及执行任务的处理策略，包括：串行、抛弃、覆盖策略</li>
<li><strong>易于监控运维</strong><br>
支持设置任务失败邮件告警，预留接口支持短信、钉钉告警；<br>
...
<tbody>
<tr>
<td style="text-align:left"><a href="https://github.com/xuxueli/xxl-job" target="_blank" rel="noopener noreferrer">https://github.com/xuxueli/xxl-job<ExternalLinkIcon/></a></td>
...
<tr>
<td style="text-align:left"><a href="http://gitee.com/xuxueli0323/xxl-job" target="_blank" rel="noopener noreferrer">http://gitee.com/xuxueli0323/xxl-job<ExternalLinkIcon/></a></td>
...
<figure><img src="@source/src/必会工具/assets/image-20210730001433997.png" alt="image-20210730001433997" tabindex="0" loading="lazy"><figcaption>image-20210730001433997</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729230502703.png" alt="image-20210729230502703" tabindex="0" loading="lazy"><figcaption>image-20210729230502703</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729230630495.png" alt="image-20210729230630495" tabindex="0" loading="lazy"><figcaption>image-20210729230630495</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729232146585.png" alt="image-20210729232146585" tabindex="0" loading="lazy"><figcaption>image-20210729232146585</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729232926534.png" alt="image-20210729232926534" tabindex="0" loading="lazy"><figcaption>image-20210729232926534</figcaption></figure>
<figure><img src="@source/src/必会工具/assets/image-20210729232825564.png" alt="image-20210729232825564" tabindex="0" loading="lazy"><figcaption>image-20210729232825564</figcaption></figure>
<p>以下是执行器的属性说明：</p>
<table>
<thead>
<tr>
...
<p>自动注册和手动注册的区别和配置</p>
<figure><img src="@source/src/必会工具/assets/image-20210729233016355.png" alt="image-20210729233016355" tabindex="0" loading="lazy"><figcaption>image-20210729233016355</figcaption></figure>
<h2 id="_1-7-任务详解-基础配置" tabindex="-1"><a class="header-anchor" href="#_1-7-任务详解-基础配置" aria-hidden="true">#</a> 1.7 任务详解-基础配置</h2>
<figure><img src="@source/src/必会工具/assets/image-20210729233926457.png" alt="image-20210729233926457" tabindex="0" loading="lazy"><figcaption>image-20210729233926457</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234009010.png" alt="image-20210729234009010" tabindex="0" loading="lazy"><figcaption>image-20210729234009010</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234114283.png" alt="image-20210729234114283" tabindex="0" loading="lazy"><figcaption>image-20210729234114283</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234219162.png" alt="image-20210729234219162" tabindex="0" loading="lazy"><figcaption>image-20210729234219162</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234256062.png" alt="image-20210729234256062" tabindex="0" loading="lazy"><figcaption>image-20210729234256062</figcaption></figure>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234409132.png" alt="image-20210729234409132" tabindex="0" loading="lazy"><figcaption>image-20210729234409132</figcaption></figure>
<h2 id="_1-8-路由策略-轮询-案例" tabindex="-1"><a class="header-anchor" href="#_1-8-路由策略-轮询-案例" aria-hidden="true">#</a> 1.8 路由策略(轮询)-案例</h2>
<p>1.修改任务为轮询</p>
<figure><img src="@source/src/必会工具/assets/image-20210729234513775.png" alt="image-20210729234513775" tabindex="0" loading="lazy"><figcaption>image-20210729234513775</figcaption></figure>
<p>2.启动多个微服务</p>
<figure><img src="@source/src/必会工具/assets/image-20210729234536483.png" alt="image-20210729234536483" tabindex="0" loading="lazy"><figcaption>image-20210729234536483</figcaption></figure>
<p>修改yml配置文件</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">server</span><span class="token punctuation">:</span>
...
<figure><img src="@source/src/必会工具/assets/image-20210729234756221.png" alt="image-20210729234756221" tabindex="0" loading="lazy"><figcaption>image-20210729234756221</figcaption></figure>
<p>执行器集群部署时，任务路由策略选择”分片广播”情况下，一次任务调度将会广播触发对应集群中所有执行器执行一次任务</p>
<figure><img src="@source/src/必会工具/assets/image-20210729234822935.png" alt="image-20210729234822935" tabindex="0" loading="lazy"><figcaption>image-20210729234822935</figcaption></figure>
...
<p>①：创建分片执行器</p>
<figure><img src="@source/src/必会工具/assets/image-20210729234930218.png" alt="image-20210729234930218" tabindex="0" loading="lazy"><figcaption>image-20210729234930218</figcaption></figure>
<p>②：创建任务，路由策略为分片广播</p>
<figure><img src="@source/src/必会工具/assets/image-20210729234948571.png" alt="image-20210729234948571" tabindex="0" loading="lazy"><figcaption>image-20210729234948571</figcaption></figure>
<p>③：分片广播代码</p>
<p>分片参数</p>
