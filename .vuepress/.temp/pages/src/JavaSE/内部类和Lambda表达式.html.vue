<template><div><h1 id="内部类和lambda表达式" tabindex="-1"><a class="header-anchor" href="#内部类和lambda表达式" aria-hidden="true">#</a> 内部类和Lambda表达式</h1>
<h2 id="_1-内部类" tabindex="-1"><a class="header-anchor" href="#_1-内部类" aria-hidden="true">#</a> 1.内部类</h2>
<h3 id="_1-1-内部类的基本使用-理解" tabindex="-1"><a class="header-anchor" href="#_1-1-内部类的基本使用-理解" aria-hidden="true">#</a> 1.1 内部类的基本使用（理解）</h3>
<ul>
<li>
<p>内部类概念</p>
<ul>
...
<h3 id="_1-2-成员内部类-理解" tabindex="-1"><a class="header-anchor" href="#_1-2-成员内部类-理解" aria-hidden="true">#</a> 1.2 成员内部类（理解）</h3>
<ul>
<li>
<p>成员内部类的定义位置</p>
<ul>
...
<h3 id="_1-3-局部内部类-理解" tabindex="-1"><a class="header-anchor" href="#_1-3-局部内部类-理解" aria-hidden="true">#</a> 1.3 局部内部类（理解）</h3>
<ul>
<li>
<p>局部内部类定义位置</p>
<ul>
...
<h3 id="_1-4-匿名内部类-应用" tabindex="-1"><a class="header-anchor" href="#_1-4-匿名内部类-应用" aria-hidden="true">#</a> 1.4 匿名内部类（应用）</h3>
<ul>
<li>
<p>匿名内部类的前提</p>
<ul>
...
<li>
<p>举例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">new</span> <span class="token class-name">Inter</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>
<p>匿名内部类直接调用方法</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">Inter</span><span class="token punctuation">{</span>
...
<h3 id="_1-5-匿名内部类在开发中的使用-应用" tabindex="-1"><a class="header-anchor" href="#_1-5-匿名内部类在开发中的使用-应用" aria-hidden="true">#</a> 1.5 匿名内部类在开发中的使用（应用）</h3>
<ul>
<li>
<p>匿名内部类在开发中的使用</p>
<ul>
...
<h2 id="_2-lambda表达式" tabindex="-1"><a class="header-anchor" href="#_2-lambda表达式" aria-hidden="true">#</a> 2.Lambda表达式</h2>
<h3 id="_2-1体验lambda表达式【理解】" tabindex="-1"><a class="header-anchor" href="#_2-1体验lambda表达式【理解】" aria-hidden="true">#</a> 2.1体验Lambda表达式【理解】</h3>
<ul>
<li>
<p>代码演示</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">/*
...
<h3 id="_2-2lambda表达式的标准格式【理解】" tabindex="-1"><a class="header-anchor" href="#_2-2lambda表达式的标准格式【理解】" aria-hidden="true">#</a> 2.2Lambda表达式的标准格式【理解】</h3>
<ul>
<li>
<p>格式：</p>
<p 代码块="">​	(形式参数) -&gt;</p>
...
<h3 id="_2-3lambda表达式练习1【应用】" tabindex="-1"><a class="header-anchor" href="#_2-3lambda表达式练习1【应用】" aria-hidden="true">#</a> 2.3Lambda表达式练习1【应用】</h3>
<ul>
<li>
<p>Lambda表达式的使用前提</p>
<ul>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//接口</span>
...
<h3 id="_2-4lambda表达式练习2【应用】" tabindex="-1"><a class="header-anchor" href="#_2-4lambda表达式练习2【应用】" aria-hidden="true">#</a> 2.4Lambda表达式练习2【应用】</h3>
<ul>
<li>
<p>练习描述</p>
<p>有参无返回值抽象方法的练习</p>
...
<h3 id="_2-5lambda表达式练习3【应用】" tabindex="-1"><a class="header-anchor" href="#_2-5lambda表达式练习3【应用】" aria-hidden="true">#</a> 2.5Lambda表达式练习3【应用】</h3>
<ul>
<li>
<p>练习描述</p>
<p>有参有返回值抽象方法的练习</p>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Addable</span> <span class="token punctuation">{</span>
...
<h3 id="_2-6lambda表达式的省略模式【应用】" tabindex="-1"><a class="header-anchor" href="#_2-6lambda表达式的省略模式【应用】" aria-hidden="true">#</a> 2.6Lambda表达式的省略模式【应用】</h3>
<ul>
<li>
<p>省略的规则</p>
<ul>
...
<h3 id="_2-7lambda表达式的使用前提【理解】" tabindex="-1"><a class="header-anchor" href="#_2-7lambda表达式的使用前提【理解】" aria-hidden="true">#</a> 2.7Lambda表达式的使用前提【理解】</h3>
<ul>
<li>使用Lambda必须要有接口</li>
<li>并且要求接口中有且仅有一个抽象方法</li>
</ul>
<h3 id="_2-8lambda表达式和匿名内部类的区别【理解】" tabindex="-1"><a class="header-anchor" href="#_2-8lambda表达式和匿名内部类的区别【理解】" aria-hidden="true">#</a> 2.8Lambda表达式和匿名内部类的区别【理解】</h3>
<ul>
<li>所需类型不同
<ul>
