<template><div><h1 id="类加载器和反射" tabindex="-1"><a class="header-anchor" href="#类加载器和反射" aria-hidden="true">#</a> 类加载器和反射</h1>
<h2 id="_1-类加载器" tabindex="-1"><a class="header-anchor" href="#_1-类加载器" aria-hidden="true">#</a> 1.类加载器</h2>
...
<figure><img src="@source/src/JavaSE/img/01_类加载器.png" alt="01_类加载器" tabindex="0" loading="lazy"><figcaption>01_类加载器</figcaption></figure>
</li>
</ul>
...
<figure><img src="@source/src/JavaSE/img/02_类加载过程加载.png" alt="02_类加载过程加载" tabindex="0" loading="lazy"><figcaption>02_类加载过程加载</figcaption></figure>
</li>
<li>
<p>链接</p>
<ul>
...
<figure><img src="@source/src/JavaSE/img/03_类加载过程验证.png" alt="03_类加载过程验证" tabindex="0" loading="lazy"><figcaption>03_类加载过程验证</figcaption></figure>
<ul>
<li>
<p>准备</p>
...
<figure><img src="@source/src/JavaSE/img/04_类加载过程准备.png" alt="04_类加载过程准备" tabindex="0" loading="lazy"><figcaption>04_类加载过程准备</figcaption></figure>
<ul>
<li>
<p>解析</p>
...
<figure><img src="@source/src/JavaSE/img/05_类加载过程解析.png" alt="05_类加载过程解析" tabindex="0" loading="lazy"><figcaption>05_类加载过程解析</figcaption></figure>
</li>
<li>
<p>初始化</p>
<p>根据程序员通过程序制定的主观计划去初始化类变量和其他资源</p>
<p>(静态变量赋值以及初始化其他资源)</p>
<figure><img src="@source/src/JavaSE/img/06_类加载过程初始化.png" alt="06_类加载过程初始化" tabindex="0" loading="lazy"><figcaption>06_类加载过程初始化</figcaption></figure>
</li>
</ol>
</li>
<li>
...
<li>
<p>代码演示</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ClassLoaderDemo1</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/JavaSE/img/07_双亲委派模型.png" alt="07_双亲委派模型" tabindex="0" loading="lazy"><figcaption>07_双亲委派模型</figcaption></figure>
</li>
</ul>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ClassLoaderDemo2</span> <span class="token punctuation">{</span>
...
<li>
<p>反射机制</p>
<p>是在运行状态中，对于任意一个类，都能够知道这个类的所有属性和方法；<br>
对于任意一个对象，都能够调用它的任意属性和方法；<br>
...
<figure><img src="@source/src/JavaSE/img/08_获取Class对象的三种方式.png" alt="08_获取Class对象的三种方式" tabindex="0" loading="lazy"><figcaption>08_获取Class对象的三种方式</figcaption></figure>
</li>
<li>
<p>示例代码</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectDemo1</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ClassNotFoundException</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">Class</span> clazz <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"com.beisheng.myreflect2.Student"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<tr>
<td>Constructor<code v-pre>&lt;T&gt;</code> getConstructor(Class<code v-pre>&lt;?&gt;</code>... parameterTypes)</td>
<td>返回单个公共构造方法对象</td>
</tr>
<tr>
<td>Constructor<code v-pre>&lt;T&gt;</code> getDeclaredConstructor(Class<code v-pre>&lt;?&gt;</code>... parameterTypes)</td>
<td>返回单个构造方法对象</td>
</tr>
</tbody>
</table>
...
<span class="token comment">//                                      返回单个构造方法对象</span>
        ...
        <span class="token class-name">Class</span> clazz <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"com.beisheng.myreflect3.Student"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token comment">//                                      返回所有构造方法对象的数组</span>
        ...
        <span class="token class-name">Constructor</span><span class="token punctuation">[</span><span class="token punctuation">]</span> constructors <span class="token operator">=</span> clazz<span class="token punctuation">.</span><span class="token function">getDeclaredConstructors</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//私有的和公共的数组</span>
...
<span class="token comment">//                                      返回所有公共构造方法对象的数组</span>
        <span class="token comment">//1.获取Class对象</span>
        <span class="token class-name">Class</span> clazz <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"com.beisheng.myreflect3.Student"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">Constructor</span><span class="token punctuation">[</span><span class="token punctuation">]</span> constructors <span class="token operator">=</span> clazz<span class="token punctuation">.</span><span class="token function">getConstructors</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//公共的构造方法的数组</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token class-name">Constructor</span> constructor <span class="token operator">:</span> constructors<span class="token punctuation">)</span> <span class="token punctuation">{</span>
            <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>constructor<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Student类同上一个示例,这里就不在重复提供了</span>
...
<li>
<p>获取里面的构造方法对象</p>
<p>getConstructor (Class<code v-pre>&lt;?&gt;</code>... parameterTypes)<br>
getDeclaredConstructor (Class<code v-pre>&lt;?&gt;</code>... parameterTypes)</p>
</li>
<li>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectDemo1</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">method4</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ClassNotFoundException</span><span class="token punctuation">,</span> <span class="token class-name">NoSuchFieldException</span> <span class="token punctuation">{</span>
        ...
        <span class="token comment">//1.获取class对象</span>
        <span class="token class-name">Class</span> clazz <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"com.beisheng.myreflect4.Student"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<tr>
<td>Method getMethod(String name, Class<code v-pre>&lt;?&gt;</code>... parameterTypes)</td>
<td>返回单个公共成员方法对象</td>
</tr>
<tr>
<td>Method getDeclaredMethod(String name, Class<code v-pre>&lt;?&gt;</code>... parameterTypes)</td>
<td>返回单个成员方法对象</td>
</tr>
</tbody>
</table>
...
<span class="token comment">//                                返回单个成员方法对象</span>
        <span class="token comment">//1.获取class对象</span>
        <span class="token class-name">Class</span> clazz <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"com.beisheng.myreflect5.Student"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<li>
<p>示例代码</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReflectDemo2</span> <span class="token punctuation">{</span>
...
<span class="token comment">//        返回值：方法的返回值（如果没有就不写）</span>
        ...
        <span class="token class-name">Object</span> result <span class="token operator">=</span> method<span class="token punctuation">.</span><span class="token function">invoke</span><span class="token punctuation">(</span>student<span class="token punctuation">,</span> <span class="token string">"zhangsan"</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//对象掉方法</span>
