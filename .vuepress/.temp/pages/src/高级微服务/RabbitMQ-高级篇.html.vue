<template><div><h1 id="rabbitmq-高级篇" tabindex="-1"><a class="header-anchor" href="#rabbitmq-高级篇" aria-hidden="true">#</a> RabbitMQ-高级篇</h1>
<p>消息队列在使用过程中，面临着很多实际问题需要思考：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718155003157.png" alt="image-20210718155003157" tabindex="0" loading="lazy"><figcaption>image-20210718155003157</figcaption></figure>
<h1 id="_1-消息可靠性" tabindex="-1"><a class="header-anchor" href="#_1-消息可靠性" aria-hidden="true">#</a> 1.消息可靠性</h1>
<p>消息从发送，到消费者接收，会经理多个过程：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718155059371.png" alt="image-20210718155059371" tabindex="0" loading="lazy"><figcaption>image-20210718155059371</figcaption></figure>
...
<p>首先，导入资料提供的demo工程：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718155328927.png" alt="image-20210718155328927" tabindex="0" loading="lazy"><figcaption>image-20210718155328927</figcaption></figure>
<p>项目结构如下：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718155448734.png" alt="image-20210718155448734" tabindex="0" loading="lazy"><figcaption>image-20210718155448734</figcaption></figure>
...
<ul>
<li>消息投递到交换机了，但是没有路由到队列。返回ACK，及路由失败原因。（<strong>只要发送到了交换机并且成功，就返回ACK</strong>）</li>
</ul>
</li>
</ul>
<figure><img src="@source/src/高级微服务/assets/image-20210718160907166.png" alt="image-20210718160907166" tabindex="0" loading="lazy"><figcaption>image-20210718160907166</figcaption></figure>
<p>注意：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718161707992.png" alt="image-20210718161707992" tabindex="0" loading="lazy"><figcaption>image-20210718161707992</figcaption></figure>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    <span class="token key atrule">publisher-confirm-type</span><span class="token punctuation">:</span> correlated   <span class="token comment">#开启生产者确认机制，采用异步回调</span>
    <span class="token key atrule">publisher-returns</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>   <span class="token comment">#开启publish-return功能 ReturnCallback</span>
    <span class="token key atrule">template</span><span class="token punctuation">:</span>
      <span class="token key atrule">mandatory</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>	<span class="token comment">#定义消息路由失败时的策略。true，则调用ReturnCallback</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>mq<span class="token punctuation">.</span>config</span><span class="token punctuation">;</span>
...
<p>在publisher服务的cn.beisheng.mq.spring.SpringAmqpTest类中，定义一个单元测试方法：</p>
...
<p><strong>默认情况下，SpringAMQP声明的如何交换机，队列，发出的任何消息，都是持久化的，不用特意指定。</strong></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>事实上，默认情况下，由SpringAMQP声明的交换机都是持久化的。</strong></p>
<p>可以在RabbitMQ控制台看到持久化的交换机都会带上<code v-pre>D</code>的标示：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718164412450.png" alt="image-20210718164412450" tabindex="0" loading="lazy"><figcaption>image-20210718164412450</figcaption></figure>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>事实上，默认情况下，由SpringAMQP声明的队列都是持久化的。</strong></p>
<p>可以在RabbitMQ控制台看到持久化的队列都会带上<code v-pre>D</code>的标示：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718164729543.png" alt="image-20210718164729543" tabindex="0" loading="lazy"><figcaption>image-20210718164729543</figcaption></figure>
...
<p>用java代码指定：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718165100016.png" alt="image-20210718165100016" tabindex="0" loading="lazy"><figcaption>image-20210718165100016</figcaption></figure>
<p><strong>默认情况下，SpringAMQP发出的任何消息都是持久化的，不用特意指定。</strong></p>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    <span class="token key atrule">listener</span><span class="token punctuation">:</span>
      <span class="token key atrule">simple</span><span class="token punctuation">:</span>
        <span class="token key atrule">acknowledge-mode</span><span class="token punctuation">:</span> auto <span class="token comment"># 开启ack</span>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718171705383.png" alt="image-20210718171705383" tabindex="0" loading="lazy"><figcaption>image-20210718171705383</figcaption></figure>
<p>抛出异常后，因为Spring会自动返回nack，所以消息恢复至Ready状态，并且没有被RabbitMQ删除：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718171759179.png" alt="image-20210718171759179" tabindex="0" loading="lazy"><figcaption>image-20210718171759179</figcaption></figure>
<h2 id="_1-4-消费失败重试机制" tabindex="-1"><a class="header-anchor" href="#_1-4-消费失败重试机制" aria-hidden="true">#</a> 1.4.消费失败重试机制</h2>
<p><strong>当消费者出现异常后，消息会不断requeue（重入队）到队列，再重新发送给消费者，然后再次异常，再次requeue，无限循环，导致mq的消息处理飙升，带来不必要的压力：</strong></p>
<figure><img src="@source/src/高级微服务/assets/image-20210718172746378.png" alt="image-20210718172746378" tabindex="0" loading="lazy"><figcaption>image-20210718172746378</figcaption></figure>
<p>怎么办呢？</p>
...
<p><strong>在开启重试模式后，重试次数耗尽，如果消息依然失败，则需要有MessageRecovery接口来处理，它包含三种不同的实现：</strong></p>
<ul>
<li>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718174328383.png" alt="image-20210718174328383" tabindex="0" loading="lazy"><figcaption>image-20210718174328383</figcaption></figure>
<p>因为simple.queue绑定了死信交换机 dl.direct，因此死信会投递给这个交换机：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718174416160.png" alt="image-20210718174416160" tabindex="0" loading="lazy"><figcaption>image-20210718174416160</figcaption></figure>
<p>如果这个死信交换机也绑定了一个队列，则消息最终会进入这个存放死信的队列：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718174506856.png" alt="image-20210718174506856" tabindex="0" loading="lazy"><figcaption>image-20210718174506856</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210821073801398.png" alt="image-20210821073801398" tabindex="0" loading="lazy"><figcaption>image-20210821073801398</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718182643311.png" alt="image-20210718182643311" tabindex="0" loading="lazy"><figcaption>image-20210718182643311</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718191657478.png" alt="image-20210718191657478" tabindex="0" loading="lazy"><figcaption>image-20210718191657478</figcaption></figure>
<p>查看下接收消息的日志：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718191738706.png" alt="image-20210718191738706" tabindex="0" loading="lazy"><figcaption>image-20210718191738706</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718191939140.png" alt="image-20210718191939140" tabindex="0" loading="lazy"><figcaption>image-20210718191939140</figcaption></figure>
<p>接收消息日志：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718192004662.png" alt="image-20210718192004662" tabindex="0" loading="lazy"><figcaption>image-20210718192004662</figcaption></figure>
...
<p>这个插件就是DelayExchange插件。参考RabbitMQ的插件列表页面：<a href="https://www.rabbitmq.com/community-plugins.html" target="_blank" rel="noopener noreferrer">https://www.rabbitmq.com/community-plugins.html<ExternalLinkIcon/></a></p>
<figure><img src="@source/src/高级微服务/assets/image-20210718192529342.png" alt="image-20210718192529342" tabindex="0" loading="lazy"><figcaption>image-20210718192529342</figcaption></figure>
<p>使用方式可以参考官网地址：<a href="https://blog.rabbitmq.com/posts/2015/04/scheduling-messages-with-rabbitmq" target="_blank" rel="noopener noreferrer">https://blog.rabbitmq.com/posts/2015/04/scheduling-messages-with-rabbitmq<ExternalLinkIcon/></a></p>
...
<p>参考资料：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718193409812.png" alt="image-20210718193409812" tabindex="0" loading="lazy"><figcaption>image-20210718193409812</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/123.png" alt="image-202107187649" tabindex="0" loading="lazy"><figcaption>image-202107187649</figcaption></figure>
<p>基于注解方式（推荐）：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718193747649.png" alt="image-20210718193747649" tabindex="0" loading="lazy"><figcaption>image-20210718193747649</figcaption></figure>
<p>也可以基于@Bean的方式：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718193831076.png" alt="image-20210718193831076" tabindex="0" loading="lazy"><figcaption>image-20210718193831076</figcaption></figure>
<h4 id="_2-发送消息" tabindex="-1"><a class="header-anchor" href="#_2-发送消息" aria-hidden="true">#</a> 2）发送消息</h4>
<p>发送消息时，一定要携带x-delay属性，指定延迟的时间：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718193917009.png" alt="image-20210718193917009" tabindex="0" loading="lazy"><figcaption>image-20210718193917009</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718194040498.png" alt="image-20210718194040498" tabindex="0" loading="lazy"><figcaption>image-20210718194040498</figcaption></figure>
<p>解决消息堆积有两种思路：</p>
<ul>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718194522223.png" alt="image-20210718194522223" tabindex="0" loading="lazy"><figcaption>image-20210718194522223</figcaption></figure>
...
<figure><img src="@source/src/高级微服务/assets/image-20210718194539054.png" alt="image-20210718194539054" tabindex="0" loading="lazy"><figcaption>image-20210718194539054</figcaption></figure>
...
<p>结构如图：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718220843323.png" alt="image-20210718220843323" tabindex="0" loading="lazy"><figcaption>image-20210718220843323</figcaption></figure>
<h3 id="_4-2-2-部署" tabindex="-1"><a class="header-anchor" href="#_4-2-2-部署" aria-hidden="true">#</a> 4.2.2.部署</h3>
<p>参考资料：《<a href="http://xn--RabbitMQ-q29mo90kol6dt10b.md" target="_blank" rel="noopener noreferrer">RabbitMQ部署指南.md<ExternalLinkIcon/></a>》</p>
...
<p>结构如图：</p>
<figure><img src="@source/src/高级微服务/assets/image-20210718221039542.png" alt="image-20210718221039542" tabindex="0" loading="lazy"><figcaption>image-20210718221039542</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>spring<span class="token operator">:</span>
  rabbitmq<span class="token operator">:</span>
    ...
    username<span class="token operator">:</span> beisheng
