<template><div><h1 id="spring02" tabindex="-1"><a class="header-anchor" href="#spring02" aria-hidden="true">#</a> Spring02</h1>
...
<figure><img src="@source/src/基础框架/assets/image-20210730101826913.png" alt="image-20210730101826913" tabindex="0" loading="lazy"><figcaption>image-20210730101826913</figcaption></figure>
<p><strong><mark>小技巧：如果你觉得上述复制粘贴方式不好改或者容易改错，其实idea是有提示功能的，注意不要选错就行了。有些版本的idea没有这个提示，那么就按照上面复制粘贴的方式改，改完之后可以做成live template模板，后期直接用。</mark></strong></p>
<figure><img src="@source/src/基础框架/assets/image-20210730102053281.png" alt="image-20210730102053281" tabindex="0" loading="lazy"><figcaption>image-20210730102053281</figcaption></figure>
...
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">&lt;context</span><span class="token punctuation">:</span><span class="token value attr-value">property-placeholder location="jdbc.properties" system-properties-mode="NEVER"/></span>
...
<li>加载properties文件**<mark>标准格式</mark>**</li>
</ul>
...
<li><strong><mark>方式二：使用bean名称获取并指定类型</mark></strong></li>
</ul>
<blockquote>
<p>弊端：推荐使用</p>
</blockquote>
...
<figure><img src="@source/src/基础框架/assets/image-20210730102842030.png" alt="image-20210730102842030" tabindex="0" loading="lazy"><figcaption>image-20210730102842030</figcaption></figure>
...
<figure><img src="@source/src/基础框架/assets/image-20210730103438742.png" alt="image-20210730103438742" tabindex="0" loading="lazy"><figcaption>image-20210730103438742</figcaption></figure>
<h4 id="_2-3-依赖注入相关" tabindex="-1"><a class="header-anchor" href="#_2-3-依赖注入相关" aria-hidden="true">#</a> 2.3 依赖注入相关</h4>
<figure><img src="@source/src/基础框架/assets/image-20210730103701525.png" alt="image-20210730103701525" tabindex="0" loading="lazy"><figcaption>image-20210730103701525</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//@Component定义bean</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AppForAnnotation</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">ApplicationContext</span> ctx <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">BookDao</span> bookDao <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token class-name">BookDao</span><span class="token punctuation">)</span> ctx<span class="token punctuation">.</span><span class="token function">getBean</span><span class="token punctuation">(</span><span class="token string">"bookDao"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础框架/assets/image-20210730104835746.png" alt="image-20210730104835746" tabindex="0" loading="lazy"><figcaption>image-20210730104835746</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Repository</span><span class="token punctuation">(</span><span class="token string">"bookDao"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BookDaoImpl</span> <span class="token keyword">implements</span> <span class="token class-name">BookDao</span> <span class="token punctuation">{</span>
<span class="token punctuation">}</span>
...
<figure><img src="@source/src/基础框架/assets/image-20210803192052811.png" alt="image-20210803192052811" tabindex="0" loading="lazy"><figcaption>image-20210803192052811</figcaption></figure>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//加载配置文件初始化容器</span>
<span class="token class-name">ApplicationContext</span> ctx <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//声明当前类为Spring配置类</span>
...
<p><mark>注意：自动装配基于反射设计创建对象并暴力反射对应属性为私有属性初始化数据，因此无需提供setter方法。</mark></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SpringConfig</span> <span class="token punctuation">{</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><mark>注意：@PropertySource()中加载多文件请使用数组格式配置，不允许使用通配符*</mark></p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//Spring会自动从IOC容器中找到BookDao对象赋值给参数bookDao变量，如果没有就会报错。</span>
<span class="token annotation punctuation">@Bean</span>
...
<figure><img src="@source/src/基础框架/assets/image-20210730113548708.png" alt="image-20210730113548708" tabindex="0" loading="lazy"><figcaption>image-20210730113548708</figcaption></figure>
...
<figure><img src="@source/src/基础框架/assets/image-20210730114303147.png" alt="image-20210730114303147" tabindex="0" loading="lazy"><figcaption>image-20210730114303147</figcaption></figure>
...
<figure><img src="@source/src/基础框架/assets/image-20210730114342060.png" alt="image-20210730114342060" tabindex="0" loading="lazy"><figcaption>image-20210730114342060</figcaption></figure>
<ul>
<li>使用MapperScannerConfigurer加载Dao接口，创建代理对象保存到IOC容器中</li>
</ul>
<figure><img src="@source/src/基础框架/assets/image-20210730114356175.png" alt="image-20210730114356175" tabindex="0" loading="lazy"><figcaption>image-20210730114356175</figcaption></figure>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--junit--></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//【第二步】使用Spring整合Junit专用的类加载器</span>
...
<figure><img src="@source/src/基础框架/assets/image-20200831155517797.png" alt="image-20200831155517797" tabindex="0" loading="lazy"><figcaption>image-20200831155517797</figcaption></figure>
</div></template>
