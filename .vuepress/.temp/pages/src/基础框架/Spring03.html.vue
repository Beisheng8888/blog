<template><div><h1 id="spring03" tabindex="-1"><a class="header-anchor" href="#spring03" aria-hidden="true">#</a> Spring03</h1>
...
<figure><img src="@source/src/基础框架/assets/image-20210730144903209.png" alt="image-20210730144903209" tabindex="0" loading="lazy"><figcaption>image-20210730144903209</figcaption></figure>
<ul>
...
<ul>
<li>一个具体方法：com.beisheng.dao包下的BookDao接口中的无形参无返回值的save方法</li>
...
<li>开发模式：XML or <strong><mark>注解</mark></strong></li>
<li>思路分析：
<ol>
<li>导入坐标（pom.xml）</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/基础框架/assets/image-20210730150138448.png" alt="image-20210730150138448" tabindex="0" loading="lazy"><figcaption>image-20210730150138448</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//通知类必须配置成Spring管理的bean</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyAdvice</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/基础框架/assets/image-20210730154740528.png" alt="image-20210730154740528" tabindex="0" loading="lazy"><figcaption>image-20210730154740528</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">App</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/基础框架/assets/image-20210730151347354.png" alt="image-20210730151347354" tabindex="0" loading="lazy"><figcaption>image-20210730151347354</figcaption></figure>
...
<p>目标对象（Target）：被代理的对象，也叫原始对象，该对象中的方法没有任何功能增强。<br>
...
<ul>
<li>描述方式一：执行com.beisheng.dao包下的BookDao接口中的无参数update方法</li>
</ul>
...
<li>描述方式二：执行com.beisheng.dao.impl包下的BookDaoImpl类中的无参数update方法</li>
</ul>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>execution(public User com.beisheng.service.UserService.findById(int))
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
...
<blockquote>
<p>匹配com.beisheng包下的任意包中的UserService类或接口中所有find开头的带有一个参数的方法</p>
</blockquote>
...
<li>访问控制修饰符针对接口开发均采用public描述（<strong><mark>可省略访问控制修饰符描述</mark></strong>）</li>
...
<li><strong><mark>接口名/类名</mark><strong>书写名称与模块相关的</strong><mark>采用*匹配</mark></strong>，例如UserService书写成*Service，绑定业务层接口名</li>
<li><strong><mark>方法名</mark><strong>书写以</strong><mark>动词</mark><strong>进行</strong><mark>精准匹配</mark></strong>，名词采用<em>匹配，例如getById书写成getBy</em>,selectAll书写成selectAll</li>
...
<li>**<mark>环绕通知(重点)：</mark>**手动调用切入点方法并对其进行增强的通知方式。</li>
...
<ul>
<li>名称：@Before</li>
<li>类型：<strong><mark>方法注解</mark></strong></li>
<li>位置：通知方法定义上方</li>
<li>作用：设置当前通知方法与切入点之间的绑定关系，当前通知方法在原始切入点方法前运行</li>
<li>范例：</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Before</span><span class="token punctuation">(</span><span class="token string">"pt()"</span><span class="token punctuation">)</span>
...
<ul>
<li>名称：@After</li>
<li>类型：<mark><strong>方法注解</strong></mark></li>
<li>位置：通知方法定义上方</li>
<li>作用：设置当前通知方法与切入点之间的绑定关系，当前通知方法在原始切入点方法后运行</li>
<li>范例：</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@After</span><span class="token punctuation">(</span><span class="token string">"pt()"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@AfterReturning</span><span class="token punctuation">(</span><span class="token string">"pt()"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@AfterThrowing</span><span class="token punctuation">(</span><span class="token string">"pt()"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Around</span><span class="token punctuation">(</span><span class="token string">"pt()"</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><mark><strong>环绕通知注意事项</strong></mark></p>
<ol>
...
<p>分析：</p>
<p>​	①：业务功能：业务层接口执行前后分别记录时间，求差值得到执行效率<br>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AccountServiceTestCase</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/基础框架/assets/image-20210730164219555.png" alt="image-20210730164219555" tabindex="0" loading="lazy"><figcaption>image-20210730164219555</figcaption></figure>
...
<figure><img src="@source/src/基础框架/assets/image-20210731193059709.png" alt="image-20210731193059709" tabindex="0" loading="lazy"><figcaption>image-20210731193059709</figcaption></figure>
<p>分析：<br>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//-------------service层代码-----------------------</span>
...
<p>切入点表达式标准格式：动作关键字(访问修饰符  返回值  包名.类/接口名.方法名（参数）异常名)</p>
<ul>
<li>execution(* com.beisheng.service.<em>Service.</em>(..))</li>
</ul>
</li>
<li>
<p>切入点表达式描述通配符：</p>
...
<li>Spring事务作用：在数据层或**<mark>业务层</mark>**保障一系列的数据库操作同成功同失败</li>
</ul>
<figure><img src="@source/src/基础框架/assets/image-20210801190820853.png" alt="image-20210801190820853" tabindex="0" loading="lazy"><figcaption>image-20210801190820853</figcaption></figure>
...
<li>分析：<br>
①：数据层提供基础操作，指定账户减钱（outMoney），指定账户加钱（inMoney）<br>
②：业务层提供转账操作（transfer），调用减钱与加钱的操作<br>
③：提供2个账号和操作金额执行转账操作<br>
④：基于Spring整合MyBatis环境搭建上述操作</li>
<li>结果分析：<br>
①：程序正常执行时，账户金额A减B加，没有问题<br>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">AccountDao</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">AccountService</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//配置事务管理器，mybatis使用的是jdbc事务</span>
...
<figure><img src="@source/src/基础框架/assets/image-20210801192453227.png" alt="image-20210801192453227" tabindex="0" loading="lazy"><figcaption>image-20210801192453227</figcaption></figure>
...
<figure><img src="@source/src/基础框架/assets/image-20210802151553053.png" alt="image-20210802151553053" tabindex="0" loading="lazy"><figcaption>image-20210802151553053</figcaption></figure>
<blockquote>
...
<figure><img src="@source/src/基础框架/assets/image-20210802153216460.png" alt="image-20210802153216460" tabindex="0" loading="lazy"><figcaption>image-20210802153216460</figcaption></figure>
<h5 id="【准备工作】环境整备" tabindex="-1"><a class="header-anchor" href="#【准备工作】环境整备" aria-hidden="true">#</a> 【准备工作】环境整备</h5>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">USE</span> spring_db<span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">LogService</span> <span class="token punctuation">{</span>
    <span class="token comment">//propagation设置事务属性：传播行为设置为当前操作需要新事务</span>
...
<figure><img src="@source/src/基础框架/assets/image-20210802153014296.png" alt="image-20210802153014296" tabindex="0" loading="lazy"><figcaption>image-20210802153014296</figcaption></figure>
</div></template>
