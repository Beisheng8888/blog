...
<figure><img src="@source/src/基础微服务/assets/image-20210714164426792.png" alt="image-20210714164426792" tabindex="0" loading="lazy"><figcaption>image-20210714164426792</figcaption></figure>
...
<p>如何在nacos中管理配置呢？</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714164742924.png" alt="image-20210714164742924" tabindex="0" loading="lazy"><figcaption>image-20210714164742924</figcaption></figure>
<p>然后在弹出的表单中，填写配置信息：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714164856664.png" alt="image-20210714164856664" tabindex="0" loading="lazy"><figcaption>image-20210714164856664</figcaption></figure>
<blockquote>
...
<figure><img src="@source/src/基础微服务/assets/L0iFYNF.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p><strong>bootstrap.yaml 优先级大于 <a href="http://application.xxx" target="_blank" rel="noopener noreferrer">application.xxx<ExternalLinkIcon/></a></strong></p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714170845901.png" alt="image-20210714170845901" tabindex="0" loading="lazy"><figcaption>image-20210714170845901</figcaption></figure>
<p>3）读取nacos配置</p>
<p>在user-service中的UserController中添加业务逻辑，读取pattern.dateformat配置：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714170337448.png" alt="image-20210714170337448" tabindex="0" loading="lazy"><figcaption>image-20210714170337448</figcaption></figure>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>

<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>pojo<span class="token punctuation">.</span></span><span class="token class-name">User</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>service<span class="token punctuation">.</span></span><span class="token class-name">UserService</span></span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714170449612.png" alt="image-20210714170449612" tabindex="0" loading="lazy"><figcaption>image-20210714170449612</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714171036335.png" alt="image-20210714171036335" tabindex="0" loading="lazy"><figcaption>image-20210714171036335</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>config</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714171316124.png" alt="image-20210714171316124" tabindex="0" loading="lazy"><figcaption>image-20210714171316124</figcaption></figure>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>

<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>config<span class="token punctuation">.</span></span><span class="token class-name">PatternProperties</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>pojo<span class="token punctuation">.</span></span><span class="token class-name">User</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>user<span class="token punctuation">.</span>service<span class="token punctuation">.</span></span><span class="token class-name">UserService</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">lombok<span class="token punctuation">.</span>extern<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Slf4j</span></span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>springframework<span class="token punctuation">.</span>beans<span class="token punctuation">.</span>factory<span class="token punctuation">.</span>annotation<span class="token punctuation">.</span></span><span class="token class-name">Autowired</span></span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714173233650.png" alt="image-20210714173233650" tabindex="0" loading="lazy"><figcaption>image-20210714173233650</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714173324231.png" alt="image-20210714173324231" tabindex="0" loading="lazy"><figcaption>image-20210714173324231</figcaption></figure>
<p>在user-service服务中，修改UserController，添加一个方法：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714173721309.png" alt="image-20210714173721309" tabindex="0" loading="lazy"><figcaption>image-20210714173721309</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714173538538.png" alt="image-20210714173538538" tabindex="0" loading="lazy"><figcaption>image-20210714173538538</figcaption></figure>
<figure><img src="@source/src/基础微服务/assets/image-20210714173519963.png" alt="image-20210714173519963" tabindex="0" loading="lazy"><figcaption>image-20210714173519963</figcaption></figure>
<p>这样，UserApplication(8081)使用的profile是dev，UserApplication2(8082)使用的profile是test。</p>
<p>启动UserApplication和UserApplication2</p>
<p>访问<a href="http://localhost:8081/user/prop%EF%BC%8C%E7%BB%93%E6%9E%9C%EF%BC%9A" target="_blank" rel="noopener noreferrer">http://localhost:8081/user/prop，结果：<ExternalLinkIcon/></a></p>
<figure><img src="@source/src/基础微服务/assets/image-20210714174313344.png" alt="image-20210714174313344" tabindex="0" loading="lazy"><figcaption>image-20210714174313344</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714174424818.png" alt="image-20210714174424818" tabindex="0" loading="lazy"><figcaption>image-20210714174424818</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714174623557.png" alt="image-20210714174623557" tabindex="0" loading="lazy"><figcaption>image-20210714174623557</figcaption></figure>
<h2 id="_1-4-搭建nacos集群" tabindex="-1"><a class="header-anchor" href="#_1-4-搭建nacos集群" aria-hidden="true">#</a> 1.4.搭建Nacos集群</h2>
<p>Nacos生产环境下一定要部署为集群状态，部署方式参考资料中的文档：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714174728042.png" alt="image-20210714174728042" tabindex="0" loading="lazy"><figcaption>image-20210714174728042</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714174814204.png" alt="image-20210714174814204" tabindex="0" loading="lazy"><figcaption>image-20210714174814204</figcaption></figure>
<p>存在下面的问题：</p>
<p>•代码可读性差，编程体验不统一</p>
<p>•参数复杂URL难以维护</p>
<p>Feign是一个声明式的http客户端，官方地址：<a href="https://github.com/OpenFeign/feign" target="_blank" rel="noopener noreferrer">https://github.com/OpenFeign/feign<ExternalLinkIcon/></a></p>
<p>其作用就是帮助我们优雅的实现http请求的发送，解决上面提到的问题。</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714174918088.png" alt="image-20210714174918088" tabindex="0" loading="lazy"><figcaption>image-20210714174918088</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714175102524.png" alt="image-20210714175102524" tabindex="0" loading="lazy"><figcaption>image-20210714175102524</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>order<span class="token punctuation">.</span>client</span><span class="token punctuation">;</span>

<span class="token keyword">import</span> <span class="token import"><span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>order<span class="token punctuation">.</span>pojo<span class="token punctuation">.</span></span><span class="token class-name">User</span></span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714175415087.png" alt="image-20210714175415087" tabindex="0" loading="lazy"><figcaption>image-20210714175415087</figcaption></figure>
<p>是不是看起来优雅多了。</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714185925910.png" alt="image-20210714185925910" tabindex="0" loading="lazy"><figcaption>image-20210714185925910</figcaption></figure>
<p>Debug方式启动order-service服务，可以看到这里的client，底层就是Apache HttpClient：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714190041542.png" alt="image-20210714190041542" tabindex="0" loading="lazy"><figcaption>image-20210714190041542</figcaption></figure>
<p>总结，Feign的优化：</p>
<p>1.日志级别尽量用basic</p>
...
<p>feign客户端：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714190542730.png" alt="image-20210714190542730" tabindex="0" loading="lazy"><figcaption>image-20210714190542730</figcaption></figure>
<p>UserController：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714190528450.png" alt="image-20210714190528450" tabindex="0" loading="lazy"><figcaption>image-20210714190528450</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714190640857.png" alt="image-20210714190640857" tabindex="0" loading="lazy"><figcaption>image-20210714190640857</figcaption></figure>
<p>优点：</p>
<ul>
<li>简单</li>
<li>实现了代码共享</li>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714214041796.png" alt="image-20210714214041796" tabindex="0" loading="lazy"><figcaption>image-20210714214041796</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714204557771.png" alt="image-20210714204557771" tabindex="0" loading="lazy"><figcaption>image-20210714204557771</figcaption></figure>
<p>项目结构：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714204656214.png" alt="image-20210714204656214" tabindex="0" loading="lazy"><figcaption>image-20210714204656214</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714205221970.png" alt="image-20210714205221970" tabindex="0" loading="lazy"><figcaption>image-20210714205221970</figcaption></figure>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>cn.beisheng.demo<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
...
<p>重启后，发现服务报错了：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714205623048.png" alt="image-20210714205623048" tabindex="0" loading="lazy"><figcaption>image-20210714205623048</figcaption></figure>
<p>这是因为UserClient现在在cn.beisheng.feign.clients包下，</p>
<p>而order-service的@EnableFeignClients注解是在cn.beisheng.order包下，不在同一个包，无法扫描到UserClient。</p>
<h4 id="_4-解决扫描包问题" tabindex="-1"><a class="header-anchor" href="#_4-解决扫描包问题" aria-hidden="true">#</a> 4）解决扫描包问题</h4>
<p>方式一：</p>
<p>指定Feign应该扫描的包：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@EnableFeignClients</span><span class="token punctuation">(</span>basePackages <span class="token operator">=</span> <span class="token string">"cn.beisheng.feign.clients"</span><span class="token punctuation">)</span>
...
<p>架构图：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714210131152.png" alt="image-20210714210131152" tabindex="0" loading="lazy"><figcaption>image-20210714210131152</figcaption></figure>
...
<p>创建服务：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714210919458.png" alt="image-20210714210919458" tabindex="0" loading="lazy"><figcaption>image-20210714210919458</figcaption></figure>
<p>引入依赖：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>gateway</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714211908341.png" alt="image-20210714211908341" tabindex="0" loading="lazy"><figcaption>image-20210714211908341</figcaption></figure>
<h3 id="_5-网关路由的流程图" tabindex="-1"><a class="header-anchor" href="#_5-网关路由的流程图" aria-hidden="true">#</a> 5）网关路由的流程图</h3>
<p>整个访问的流程如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714211742956.png" alt="image-20210714211742956" tabindex="0" loading="lazy"><figcaption>image-20210714211742956</figcaption></figure>
<p>总结：</p>
<p>网关搭建步骤：</p>
<ol>
<li>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714212312871.png" alt="image-20210714212312871" tabindex="0" loading="lazy"><figcaption>image-20210714212312871</figcaption></figure>
...
<blockquote>
<p><strong>需求</strong>：给所有进入userservice的请求添加一个请求头：Truth=beisheng is freaking awesome!</p>
</blockquote>
  ...
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">gateway</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> user<span class="token punctuation">-</span>service
        ...
        <span class="token punctuation">-</span> AddRequestHeader=Truth<span class="token punctuation">,</span> beisheng is freaking awesome<span class="token tag">!</span> <span class="token comment"># 添加请求头</span>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">cloud</span><span class="token punctuation">:</span>
    <span class="token key atrule">gateway</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> AddRequestHeader=Truth<span class="token punctuation">,</span> beisheng is freaking awesome<span class="token tag">!</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>gateway<span class="token punctuation">.</span>filters</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714214228409.png" alt="image-20210714214228409" tabindex="0" loading="lazy"><figcaption>image-20210714214228409</figcaption></figure>
<p>排序的规则是什么呢？</p>
<ul>
...
<p>解决方案：CORS，这个以前应该学习过，这里不再赘述了。不知道的小伙伴可以查看<a href="https://www.ruanyifeng.com/blog/2016/04/cors.html" target="_blank" rel="noopener noreferrer">https://www.ruanyifeng.com/blog/2016/04/cors.html<ExternalLinkIcon/></a></p>
<h3 id="_3-6-2-模拟跨域问题" tabindex="-1"><a class="header-anchor" href="#_3-6-2-模拟跨域问题" aria-hidden="true">#</a> 3.6.2.模拟跨域问题</h3>
<p>找到资料的页面文件：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714215713563.png" alt="image-20210714215713563" tabindex="0" loading="lazy"><figcaption>image-20210714215713563</figcaption></figure>
<p>放入tomcat或者nginx这样的web服务器中，启动并访问。</p>
<p>可以在浏览器控制台看到下面的错误：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714215832675.png" alt="image-20210714215832675" tabindex="0" loading="lazy"><figcaption>image-20210714215832675</figcaption></figure>
