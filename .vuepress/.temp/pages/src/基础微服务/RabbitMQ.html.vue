...
<figure><img src="@source/src/基础微服务/assets/image-20210717161939695.png" alt="image-20210717161939695" tabindex="0" loading="lazy"><figcaption>image-20210717161939695</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717162004285.png" alt="image-20210717162004285" tabindex="0" loading="lazy"><figcaption>image-20210717162004285</figcaption></figure>
<p>总结：</p>
<p>同步调用的优点：</p>
<ul>
...
<figure><img src="@source/src/基础微服务/assets/image-20210422095356088.png" alt="image-20210422095356088" tabindex="0" loading="lazy"><figcaption>image-20210422095356088</figcaption></figure>
...
<p>好在现在开源软件或云平台上 Broker 的软件是非常成熟的，比较常见的一种就是的MQ技术。</p>
...
<p>安装RabbitMQ，参考资料：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717162628635.png" alt="image-20210717162628635" tabindex="0" loading="lazy"><figcaption>image-20210717162628635</figcaption></figure>
<p>MQ的基本结构：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717162752376.png" alt="image-20210717162752376" tabindex="0" loading="lazy"><figcaption>image-20210717162752376</figcaption></figure>
<p>RabbitMQ中的一些角色：</p>
<ul>
<li>publisher：生产者</li>
<li>consumer：消费者</li>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717163332646.png" alt="image-20210717163332646" tabindex="0" loading="lazy"><figcaption>image-20210717163332646</figcaption></figure>
<h2 id="_2-3-导入demo工程" tabindex="-1"><a class="header-anchor" href="#_2-3-导入demo工程" aria-hidden="true">#</a> 2.3.导入Demo工程</h2>
<p>资料提供了一个Demo工程，mq-demo:</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717163253264.png" alt="image-20210717163253264" tabindex="0" loading="lazy"><figcaption>image-20210717163253264</figcaption></figure>
<p>导入后可以看到结构如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717163604330.png" alt="image-20210717163604330" tabindex="0" loading="lazy"><figcaption>image-20210717163604330</figcaption></figure>
<p>包括三部分：</p>
<ul>
...
<p>简单队列模式的模型图：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717163434647.png" alt="image-20210717163434647" tabindex="0" loading="lazy"><figcaption>image-20210717163434647</figcaption></figure>
...
<p>代码实现：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>mq<span class="token punctuation">.</span>helloworld</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PublisherTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testSendMessage</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span><span class="token punctuation">,</span> <span class="token class-name">TimeoutException</span> <span class="token punctuation">{</span>
        ...
        factory<span class="token punctuation">.</span><span class="token function">setUsername</span><span class="token punctuation">(</span><span class="token string">"beisheng"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p><strong>阅后即焚</strong></p>
<p>SpringAMQP是基于RabbitMQ封装的一套模板，并且还利用SpringBoot对其实现了自动装配，使用起来非常方便。</p>
<p>SpringAmqp的官方地址：<a href="https://spring.io/projects/spring-amqp" target="_blank" rel="noopener noreferrer">https://spring.io/projects/spring-amqp<ExternalLinkIcon/></a></p>
<figure><img src="@source/src/基础微服务/assets/image-20210717164024967.png" alt="image-20210717164024967" tabindex="0" loading="lazy"><figcaption>image-20210717164024967</figcaption></figure>
<figure><img src="@source/src/基础微服务/assets/image-20210717164038678.png" alt="image-20210717164038678" tabindex="0" loading="lazy"><figcaption>image-20210717164038678</figcaption></figure>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    <span class="token key atrule">host</span><span class="token punctuation">:</span> 192.168.78.128 <span class="token comment"># 主机名</span>
    ...
    <span class="token key atrule">password</span><span class="token punctuation">:</span> <span class="token number">1234</span> <span class="token comment"># 密码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在publisher服务中编写测试类SpringAmqpTest，并利用RabbitTemplate实现消息发送：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>mq<span class="token punctuation">.</span>spring</span><span class="token punctuation">;</span>
...
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">rabbitmq</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">username</span><span class="token punctuation">:</span> root <span class="token comment"># 用户名</span>
    <span class="token key atrule">password</span><span class="token punctuation">:</span> <span class="token number">1234</span> <span class="token comment"># 密码</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在consumer服务的<code v-pre>cn.beisheng.mq.listener</code>包中新建一个类SpringRabbitListener，代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>mq<span class="token punctuation">.</span>listener</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717164238910.png" alt="image-20210717164238910" tabindex="0" loading="lazy"><figcaption>image-20210717164238910</figcaption></figure>
...
<p>发布订阅的模型如图：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717165309625.png" alt="image-20210717165309625" tabindex="0" loading="lazy"><figcaption>image-20210717165309625</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717165438225.png" alt="image-20210717165438225" tabindex="0" loading="lazy"><figcaption>image-20210717165438225</figcaption></figure>
...
<p>我们的计划是这样的：</p>
<ul>
<li>创建一个交换机 beisheng.fanout，类型是Fanout</li>
<li>创建两个队列fanout.queue1和fanout.queue2，绑定到交换机beisheng.fanout</li>
</ul>
<figure><img src="@source/src/基础微服务/assets/image-20210717165509466.png" alt="image-20210717165509466" tabindex="0" loading="lazy"><figcaption>image-20210717165509466</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717165552676.png" alt="image-20210717165552676" tabindex="0" loading="lazy"><figcaption>image-20210717165552676</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FanoutConfig</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token class-name">FanoutExchange</span> <span class="token function">fanoutExchange</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token keyword">return</span> <span class="token keyword">new</span> <span class="token class-name">FanoutExchange</span><span class="token punctuation">(</span><span class="token string">"beisheng.fanout"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testFanoutExchange</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 队列名称</span>
    <span class="token class-name">String</span> exchangeName <span class="token operator">=</span> <span class="token string">"beisheng.fanout"</span><span class="token punctuation">;</span>
    <span class="token comment">// 消息</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20210717170041447.png" alt="image-20210717170041447" tabindex="0" loading="lazy"><figcaption>image-20210717170041447</figcaption></figure>
<p>在Direct模型下：</p>
<ul>
...
<li>
<p>在publisher中编写测试方法，向beisheng. direct发送消息</p>
</li>
</ol>
<figure><img src="@source/src/基础微服务/assets/image-20210717170223317.png" alt="image-20210717170223317" tabindex="0" loading="lazy"><figcaption>image-20210717170223317</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testSendDirectExchange</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">String</span> exchangeName <span class="token operator">=</span> <span class="token string">"beisheng.direct"</span><span class="token punctuation">;</span>
    <span class="token comment">// 消息</span>
...
<p>​</p>
<p>图示：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210717170705380.png" alt="image-20210717170705380" tabindex="0" loading="lazy"><figcaption>image-20210717170705380</figcaption></figure>
<p>解释：</p>
<ul>
...
<li>
<p>在publisher中编写测试方法，向beisheng. topic发送消息</p>
</li>
</ol>
<figure><img src="@source/src/基础微服务/assets/image-20210717170829229.png" alt="image-20210717170829229" tabindex="0" loading="lazy"><figcaption>image-20210717170829229</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testSendTopicExchange</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 交换机名称</span>
    <span class="token class-name">String</span> exchangeName <span class="token operator">=</span> <span class="token string">"beisheng.topic"</span><span class="token punctuation">;</span>
    <span class="token comment">// 消息</span>
...
<figure><img src="@source/src/基础微服务/assets/image-20200525170410401.png" alt="image-20200525170410401" tabindex="0" loading="lazy"><figcaption>image-20200525170410401</figcaption></figure>
...
<p>发送消息后查看控制台：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210422232835363.png" alt="image-20210422232835363" tabindex="0" loading="lazy"><figcaption>image-20210422232835363</figcaption></figure>
