...
<figure><img src="@source/src/基础微服务/assets/image-20210713202807818.png" alt="image-20210713202807818" tabindex="0" loading="lazy"><figcaption>image-20210713202807818</figcaption></figure>
<p>单体架构的优缺点如下：</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713203124797.png" alt="image-20210713203124797" tabindex="0" loading="lazy"><figcaption>image-20210713203124797</figcaption></figure>
<p>分布式架构的优缺点：</p>
<p><strong>优点：</strong></p>
<ul>
<li>降低服务耦合</li>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713203753373.png" alt="image-20210713203753373" tabindex="0" loading="lazy"><figcaption>image-20210713203753373</figcaption></figure>
...
<p>SpringCloud是目前国内使用最广泛的微服务框架。官网地址：<a href="https://spring.io/projects/spring-cloud%E3%80%82" target="_blank" rel="noopener noreferrer">https://spring.io/projects/spring-cloud。<ExternalLinkIcon/></a></p>
<p>SpringCloud集成了各种微服务功能组件，并基于SpringBoot实现了这些组件的自动装配，从而提供了良好的开箱即用体验。</p>
<p>其中常见的组件包括：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713204155887.png" alt="image-20210713204155887" tabindex="0" loading="lazy"><figcaption>image-20210713204155887</figcaption></figure>
<p>另外，SpringCloud底层是依赖于SpringBoot的，并且有版本的兼容关系，如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713205003790.png" alt="image-20210713205003790" tabindex="0" loading="lazy"><figcaption>image-20210713205003790</figcaption></figure>
<p>我们学习的版本是 Hoxton.SR10，因此对应的SpringBoot版本是2.3.x版本。</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713210800950.png" alt="image-20210713210800950" tabindex="0" loading="lazy"><figcaption>image-20210713210800950</figcaption></figure>
<h2 id="_2-2-服务拆分示例" tabindex="-1"><a class="header-anchor" href="#_2-2-服务拆分示例" aria-hidden="true">#</a> 2.2.服务拆分示例</h2>
<p>以资料中的微服务cloud-demo为例，其结构如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713211009593.png" alt="image-20210713211009593" tabindex="0" loading="lazy"><figcaption>image-20210713211009593</figcaption></figure>
...
<p>首先，将资料提供的<code v-pre>cloud-order.sql</code>和<code v-pre>cloud-user.sql</code>导入到mysql中：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713211417049.png" alt="image-20210713211417049" tabindex="0" loading="lazy"><figcaption>image-20210713211417049</figcaption></figure>
<p>cloud-user表中初始数据如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713211550169.png" alt="image-20210713211550169" tabindex="0" loading="lazy"><figcaption>image-20210713211550169</figcaption></figure>
<p>cloud-order表中初始数据如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713211657319.png" alt="image-20210713211657319" tabindex="0" loading="lazy"><figcaption>image-20210713211657319</figcaption></figure>
...
<p>用IDEA导入资料提供的Demo：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713211814094.png" alt="image-20210713211814094" tabindex="0" loading="lazy"><figcaption>image-20210713211814094</figcaption></figure>
<p>项目结构如下：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713212656887.png" alt="image-20210713212656887" tabindex="0" loading="lazy"><figcaption>image-20210713212656887</figcaption></figure>
<p>导入后，会在IDEA右下角出现弹窗：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713212349272.png" alt="image-20210713212349272" tabindex="0" loading="lazy"><figcaption>image-20210713212349272</figcaption></figure>
<p>点击弹窗，然后按下图选择：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713212336185.png" alt="image-20210713212336185" tabindex="0" loading="lazy"><figcaption>image-20210713212336185</figcaption></figure>
<p>会出现这样的菜单：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713212513324.png" alt="image-20210713212513324" tabindex="0" loading="lazy"><figcaption>image-20210713212513324</figcaption></figure>
<p>配置下项目使用的JDK：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713220736408.png" alt="image-20210713220736408" tabindex="0" loading="lazy"><figcaption>image-20210713220736408</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713212749575.png" alt="image-20210713212749575" tabindex="0" loading="lazy"><figcaption>image-20210713212749575</figcaption></figure>
<p>根据id查询订单，返回值是Order对象，如图：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713212901725.png" alt="image-20210713212901725" tabindex="0" loading="lazy"><figcaption>image-20210713212901725</figcaption></figure>
<p>其中的user为null</p>
<p>在user-service中有一个根据id查询用户的接口：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713213146089.png" alt="image-20210713213146089" tabindex="0" loading="lazy"><figcaption>image-20210713213146089</figcaption></figure>
<p>查询的结果如图：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713213213075.png" alt="image-20210713213213075" tabindex="0" loading="lazy"><figcaption>image-20210713213213075</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713213312278.png" alt="image-20210713213312278" tabindex="0" loading="lazy"><figcaption>image-20210713213312278</figcaption></figure>
<p>因此，我们需要在order-service中 向user-service发起一个http的请求，调用<a href="http://localhost:8081/user/%7BuserId%7D%E8%BF%99%E4%B8%AA%E6%8E%A5%E5%8F%A3%E3%80%82" target="_blank" rel="noopener noreferrer">http://localhost:8081/user/{userId}这个接口。<ExternalLinkIcon/></a></p>
<p>大概的步骤是这样的：</p>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>order</span><span class="token punctuation">;</span>
...
<span class="token annotation punctuation">@MapperScan</span><span class="token punctuation">(</span><span class="token string">"cn.beisheng.order.mapper"</span><span class="token punctuation">)</span>
...
<p>修改order-service服务中的cn.beisheng.order.service包下的OrderService类中的queryOrderById方法：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713213959569.png" alt="image-20210713213959569" tabindex="0" loading="lazy"><figcaption>image-20210713213959569</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713214404481.png" alt="image-20210713214404481" tabindex="0" loading="lazy"><figcaption>image-20210713214404481</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713214925388.png" alt="image-20210713214925388" tabindex="0" loading="lazy"><figcaption>image-20210713214925388</figcaption></figure>
<p>大家思考几个问题：</p>
<ul>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713220104956.png" alt="image-20210713220104956" tabindex="0" loading="lazy"><figcaption>image-20210713220104956</figcaption></figure>
<p>回答之前的各个问题。</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713220509769.png" alt="image-20210713220509769" tabindex="0" loading="lazy"><figcaption>image-20210713220509769</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713220605881.png" alt="image-20210713220605881" tabindex="0" loading="lazy"><figcaption>image-20210713220605881</figcaption></figure>
<p>填写模块信息：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713220857396.png" alt="image-20210713220857396" tabindex="0" loading="lazy"><figcaption>image-20210713220857396</figcaption></figure>
<p>然后填写服务信息：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713221339022.png" alt="image-20210713221339022" tabindex="0" loading="lazy"><figcaption>image-20210713221339022</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>eureka</span><span class="token punctuation">;</span>
...
<p>启动微服务，然后在浏览器访问：<a href="http://127.0.0.1:10086" target="_blank" rel="noopener noreferrer">http://127.0.0.1:10086<ExternalLinkIcon/></a></p>
<p>看到下面结果应该是成功了：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713222157190.png" alt="image-20210713222157190" tabindex="0" loading="lazy"><figcaption>image-20210713222157190</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713222656562.png" alt="image-20210713222656562" tabindex="0" loading="lazy"><figcaption>image-20210713222656562</figcaption></figure>
<p>然后，在弹出的窗口中，填写信息：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713222757702.png" alt="image-20210713222757702" tabindex="0" loading="lazy"><figcaption>image-20210713222757702</figcaption></figure>
<p>现在，SpringBoot窗口会出现两个user-service启动配置：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713222841951.png" alt="image-20210713222841951" tabindex="0" loading="lazy"><figcaption>image-20210713222841951</figcaption></figure>
<p>不过，第一个是8081端口，第二个是8082端口。</p>
<p>启动两个user-service实例：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713223041491.png" alt="image-20210713223041491" tabindex="0" loading="lazy"><figcaption>image-20210713223041491</figcaption></figure>
<p>查看eureka-server管理页面：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713223150650.png" alt="image-20210713223150650" tabindex="0" loading="lazy"><figcaption>image-20210713223150650</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713224049419.png" alt="image-20210713224049419" tabindex="0" loading="lazy"><figcaption>image-20210713224049419</figcaption></figure>
<p>修改order-service服务中的cn.beisheng.order.service包下的OrderService类中的queryOrderById方法。修改访问的url路径，用服务名代替ip、端口：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713224245731.png" alt="image-20210713224245731" tabindex="0" loading="lazy"><figcaption>image-20210713224245731</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713224517686.png" alt="image-20210713224517686" tabindex="0" loading="lazy"><figcaption>image-20210713224517686</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/1525620483637.png" alt="1525620483637" tabindex="0" loading="lazy"><figcaption>1525620483637</figcaption></figure>
...
<p>继续跟入execute方法：</p>
<figure><img src="@source/src/基础微服务/assets/1525620787090.png" alt="1525620787090" tabindex="0" loading="lazy"><figcaption>1525620787090</figcaption></figure>
<p>代码是这样的：</p>
<ul>
...
<figure><img src="@source/src/基础微服务/assets/1525620835911.png" alt="1525620835911" tabindex="0" loading="lazy"><figcaption>1525620835911</figcaption></figure>
<p>果然实现了负载均衡。</p>
...
<figure><img src="@source/src/基础微服务/assets/1525620835911.png" alt="1525620835911" tabindex="0" loading="lazy"><figcaption>1525620835911</figcaption></figure>
<p>我们继续跟入：</p>
<figure><img src="@source/src/基础微服务/assets/1544361421671.png" alt="1544361421671" tabindex="0" loading="lazy"><figcaption>1544361421671</figcaption></figure>
<p>继续跟踪源码chooseServer方法，发现这么一段代码：</p>
<figure><img src="@source/src/基础微服务/assets/1525622652849.png" alt="1525622652849" tabindex="0" loading="lazy"><figcaption>1525622652849</figcaption></figure>
<p>我们看看这个rule是谁：</p>
<figure><img src="@source/src/基础微服务/assets/1525622699666.png" alt="1525622699666" tabindex="0" loading="lazy"><figcaption>1525622699666</figcaption></figure>
<p>这里的rule默认值是一个<code v-pre>RoundRobinRule</code>，看类的介绍：</p>
<figure><img src="@source/src/基础微服务/assets/1525622754316.png" alt="1525622754316" tabindex="0" loading="lazy"><figcaption>1525622754316</figcaption></figure>
<p>这不就是轮询的意思嘛。</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713224724673.png" alt="image-20210713224724673" tabindex="0" loading="lazy"><figcaption>image-20210713224724673</figcaption></figure>
<p>基本流程如下：</p>
<ul>
...
<li>RibbonLoadBalancerClient修改请求地址，用localhost:8081替代userservice，得到<a href="http://localhost:8081/user/1%EF%BC%8C%E5%8F%91%E8%B5%B7%E7%9C%9F%E5%AE%9E%E8%AF%B7%E6%B1%82" target="_blank" rel="noopener noreferrer">http://localhost:8081/user/1，发起真实请求<ExternalLinkIcon/></a></li>
</ul>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713225653000.png" alt="image-20210713225653000" tabindex="0" loading="lazy"><figcaption>image-20210713225653000</figcaption></figure>
<p>不同规则的含义如下：</p>
<table>
<thead>
<tr>
...
<td>对以下两种服务器进行忽略：   （1）在默认情况下，这台服务器如果3次连接失败，这台服务器就会被设置为“短路”状态。短路状态将持续30秒，如果再次连接失败，短路的持续时间就会几何级地增加。  （2）并发数过高的服务器。如果一个服务器的并发连接数过高，配置了AvailabilityFilteringRule规则的客户端也会将其忽略。并发连接数的上限，可以由客户端的<code v-pre>&lt;clientName&gt;</code>.<code v-pre>&lt;clientConfigNameSpace&gt;</code>.ActiveConnectionsLimit属性进行配置。</td>
</tr>
<tr>
...
<li>这种配置是全局的order在调用那个模块的时候都是这种策略</li>
</ol>
...
<li>这种配置是局部的，只对UserService 使用这种负载均衡策略</li>
</ol>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713230444308.png" alt="image-20210713230444308" tabindex="0" loading="lazy"><figcaption>image-20210713230444308</figcaption></figure>
<p>安装方式可以参考资料《<a href="http://xn--Nacos-w47hp30co9nr93f.md" target="_blank" rel="noopener noreferrer">Nacos安装指南.md<ExternalLinkIcon/></a>》</p>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713231439607.png" alt="image-20210713231439607" tabindex="0" loading="lazy"><figcaption>image-20210713231439607</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713232522531.png" alt="image-20210713232522531" tabindex="0" loading="lazy"><figcaption>image-20210713232522531</figcaption></figure>
<p>微服务互相访问时，应该尽可能访问同集群实例，因为本地访问速度更快。当本集群内不可用时，才访问其它集群。例如：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713232658928.png" alt="image-20210713232658928" tabindex="0" loading="lazy"><figcaption>image-20210713232658928</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713232916215.png" alt="image-20210713232916215" tabindex="0" loading="lazy"><figcaption>image-20210713232916215</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210713233528982.png" alt="image-20210713233528982" tabindex="0" loading="lazy"><figcaption>image-20210713233528982</figcaption></figure>
<p>启动UserApplication3后再次查看nacos控制台：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713233727923.png" alt="image-20210713233727923" tabindex="0" loading="lazy"><figcaption>image-20210713233727923</figcaption></figure>
...
<p><strong>但默认情况下NacosRule是同集群内随机挑选</strong>，不会考虑机器的性能问题。</p>
<p>因此，Nacos提供了权重配置来控制访问频率，权重越大则访问频率越高。</p>
<p>在nacos控制台，找到user-service的实例列表，点击编辑，即可修改权重：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713235133225.png" alt="image-20210713235133225" tabindex="0" loading="lazy"><figcaption>image-20210713235133225</figcaption></figure>
<p>在弹出的编辑窗口，修改权重：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210713235235219.png" alt="image-20210713235235219" tabindex="0" loading="lazy"><figcaption>image-20210713235235219</figcaption></figure>
<blockquote>
<p><strong>注意</strong>：<strong>如果权重修改为0，则该实例永远不会被访问，默认都是1</strong></p>
<p>在服务器升级的时候，先把要升级的服务器进行权重设置。</p>
</blockquote>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714000101516.png" alt="image-20210714000101516" tabindex="0" loading="lazy"><figcaption>image-20210714000101516</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714000414781.png" alt="image-20210714000414781" tabindex="0" loading="lazy"><figcaption>image-20210714000414781</figcaption></figure>
<p>我们可以点击页面新增按钮，添加一个namespace：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714000440143.png" alt="image-20210714000440143" tabindex="0" loading="lazy"><figcaption>image-20210714000440143</figcaption></figure>
<p>然后，填写表单：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714000505928.png" alt="image-20210714000505928" tabindex="0" loading="lazy"><figcaption>image-20210714000505928</figcaption></figure>
<p>就能在页面看到一个新的namespace：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714000522913.png" alt="image-20210714000522913" tabindex="0" loading="lazy"><figcaption>image-20210714000522913</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714000830703.png" alt="image-20210714000830703" tabindex="0" loading="lazy"><figcaption>image-20210714000830703</figcaption></figure>
<figure><img src="@source/src/基础微服务/assets/image-20210714000837140.png" alt="image-20210714000837140" tabindex="0" loading="lazy"><figcaption>image-20210714000837140</figcaption></figure>
<p>此时访问order-service，因为namespace不同，会导致找不到userservice，控制台会报错：</p>
<figure><img src="@source/src/基础微服务/assets/image-20210714000941256.png" alt="image-20210714000941256" tabindex="0" loading="lazy"><figcaption>image-20210714000941256</figcaption></figure>
...
<figure><img src="@source/src/基础微服务/assets/image-20210714001728017.png" alt="image-20210714001728017" tabindex="0" loading="lazy"><figcaption>image-20210714001728017</figcaption></figure>
<ul>
<li>
