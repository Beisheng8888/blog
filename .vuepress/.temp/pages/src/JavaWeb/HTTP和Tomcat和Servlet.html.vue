<template><div><h1 id="http-tomcat-servlet" tabindex="-1"><a class="header-anchor" href="#http-tomcat-servlet" aria-hidden="true">#</a> HTTP&amp;Tomcat&amp;Servlet</h1>
...
<p>​	Web是全球广域网，也称为万维网(www)，能够通过浏览器访问的网站。==<br>
在我们日常的生活中，经常会使用浏览器去访问<code v-pre>百度</code>、<code v-pre>京东</code>、<code v-pre>123</code>等这些网站，这些网站统称为Web网站。如下就是通过浏览器访问123官网的界面:</p>
<p>​	知道了什么是Web，那么JavaWeb又是什么呢？顾名思义==JavaWeb就是用Java技术来解决相关web互联网领域的技术栈。</p>
<p>​	等学习完JavaWeb之后，你就可以使用Java语言开发我们上述所说的网站。而国内很多大型网站公司也是首选Java语言来解决web互联网相关的问题。那都有哪些公司的系统是使用Java语言的呢?<br>
<img src="@source/src/JavaWeb/assets/20210717183958532.png" alt="" loading="lazy"><br>
...
<p>什么是B/S架构?<br>
B/S 架构：Browser/Server，浏览器/服务器 架构模式，它的特点是，客户端只需要浏览器，应用程序的逻辑和数据都存储在服务器端。浏览器只需要请求服务器，获取Web资源，服务器把Web资源发送给浏览器即可。大家可以通过下面这张图来回想下我们平常的上网过程:<br>
<img src="@source/src/JavaWeb/assets/1627031933553.png" alt="1627031933553" loading="lazy"></p>
<ul>
...
<li>在日常上网的过程中，我们除了看到这些好看的页面以外，还会碰到很多动态内容，比如我们常见的百度登录效果:<br>
<img src="@source/src/JavaWeb/assets/1627037814180.png" alt="1627037814180" loading="lazy"><br>
...
<li>动态资源虽然可以处理逻辑，但是当用户来登录百度的时候，就需要输入<code v-pre>用户名</code>和<code v-pre>密码</code>,这个时候我们就又需要解决的一个问题是，用户在注册的时候填入的用户名和密码、以及我们经常会访问到一些数据列表的内容展示(如下图所示)，这些数据都存储在哪里?我们需要的时候又是从哪里来取呢?<br>
<img src="@source/src/JavaWeb/assets/1627038674340.png" alt="1627038674340" loading="lazy"></li>
</ul>
<h4 id="_1-2-4-数据库" tabindex="-1"><a class="header-anchor" href="#_1-2-4-数据库" aria-hidden="true">#</a> 1.2.4 数据库</h4>
<ul>
<li>数据库主要负责存储数据。</li>
<li>整个Web的访问过程就如下图所示:<br>
<img src="@source/src/JavaWeb/assets/1627039320220.png" alt="1627039320220" loading="lazy"><br>
...
<li>Web服务器软件有很多，我们中将学习的是目前最为常用的<mark>Tomcat</mark>服务器</li>
</ul>
<p>到这为止，关于JavaWeb中用到的技术栈我们就介绍完了，这里面就只有HTTP协议、Servlet、JSP以及Tomcat这些知识是没有学习过的，所以整个Web核心主要就是来学习这些技术。</p>
<h3 id="_1-3-web核心安排" tabindex="-1"><a class="header-anchor" href="#_1-3-web核心安排" aria-hidden="true">#</a> 1.3 Web核心安排</h3>
<figure><img src="@source/src/JavaWeb/assets/1627043194238.png" alt="1627043194238" tabindex="0" loading="lazy"><figcaption>1627043194238</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627046235092.png" alt="1627046235092" tabindex="0" loading="lazy"><figcaption>1627046235092</figcaption></figure>
<blockquote>
...
<figure><img src="@source/src/JavaWeb/assets/1627050004221.png" alt="1627050004221" tabindex="0" loading="lazy"><figcaption>1627050004221</figcaption></figure>
<ul>
<li>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>Host: 表示请求的主机名
User-Agent: 浏览器版本,例如Chrome浏览器的标识类似Mozilla/5.0 ...Chrome/79，IE浏览器的标识类似Mozilla/5.0 (Windows NT ...)like Gecko；
Accept：表示浏览器能接收的资源类型，如text/*，image/*或者*/*表示所有；
Accept-Language：表示浏览器偏好的语言，服务器可以据此返回不同语言的网页；
Accept-Encoding：表示浏览器可以支持的压缩类型，例如gzip, deflate等。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><mark>这些数据有什么用处?</mark></p>
...
<figure><img src="@source/src/JavaWeb/assets/1627050930378.png" alt="1627050930378" tabindex="0" loading="lazy"><figcaption>1627050930378</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627278511902.png" alt="1627278511902" tabindex="0" loading="lazy"><figcaption>1627278511902</figcaption></figure>
<p>使用IDEA打开</p>
<figure><img src="@source/src/JavaWeb/assets/1627278583127.png" alt="1627278583127" tabindex="0" loading="lazy"><figcaption>1627278583127</figcaption></figure>
<p>打开后，可以点击项目中的<code v-pre>html\19-表单验证.html</code>，使用浏览器打开，通过修改页面中form表单的method属性来测试GET请求和POST请求的参数携带方式。</p>
<figure><img src="@source/src/JavaWeb/assets/1627278725007.png" alt="1627278725007" tabindex="0" loading="lazy"><figcaption>1627278725007</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627053710214.png" alt="1627053710214" tabindex="0" loading="lazy"><figcaption>1627053710214</figcaption></figure>
<ul>
<li>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>Content-Type：表示该响应内容的类型，例如text/html，image/jpeg；
...
<p>参考: 资料/1.HTTP/《<a href="http://xn--vvr80uk5ak57bv7f.md" target="_blank" rel="noopener noreferrer">响应状态码.md<ExternalLinkIcon/></a>》</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng</span><span class="token punctuation">;</span>
...
<p>Web服务器是一个应该程序（<mark>软件</mark>），对HTTP协议的操作进行封装，使得程序员不必直接对协议进行操作，让Web开发更加便捷。主要功能是&quot;提供网上信息浏览服务&quot;。</p>
<figure><img src="@source/src/JavaWeb/assets/1627058356051.png" alt="1627058356051" tabindex="0" loading="lazy"><figcaption>1627058356051</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627060368806.png" alt="1627060368806" tabindex="0" loading="lazy"><figcaption>1627060368806</figcaption></figure>
...
<li>
<p>Tomcat的官网: <a href="https://tomcat.apache.org/" target="_blank" rel="noopener noreferrer">https://tomcat.apache.org/<ExternalLinkIcon/></a> 从官网上可以下载对应的版本进行使用。</p>
</li>
</ul>
<p><strong>Tomcat的LOGO</strong></p>
<figure><img src="@source/src/JavaWeb/assets/1627176045795.png" alt="1627176045795" tabindex="0" loading="lazy"><figcaption>1627176045795</figcaption></figure>
<p><strong>小结</strong></p>
...
<p>Tomcat总共分两部分学习，先来学习Tomcat的基本使用，包括Tomcat的<mark>下载、安装、卸载、启动和关闭</mark>。</p>
<h4 id="_3-2-1-下载" tabindex="-1"><a class="header-anchor" href="#_3-2-1-下载" aria-hidden="true">#</a> 3.2.1 下载</h4>
<p>直接从官网下载</p>
<figure><img src="@source/src/JavaWeb/assets/1627178001030.png" alt="1627178001030" tabindex="0" loading="lazy"><figcaption>1627178001030</figcaption></figure>
...
<p><mark>注意</mark>，Tomcat在解压缩的时候，解压所在的目录可以任意，但最好解压到一个不包含中文和空格的目录，因为后期在部署项目的时候，如果路径有中文或者空格可能会导致程序部署失败。</p>
</li>
<li>
<p>打开<code v-pre>apache-tomcat-8.5.68</code>目录就能看到如下目录结构，每个目录中包含的内容需要认识下,</p>
<figure><img src="@source/src/JavaWeb/assets/1627178815892.png" alt="1627178815892" tabindex="0" loading="lazy"><figcaption>1627178815892</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627179006011.png" alt="1627179006011" tabindex="0" loading="lazy"><figcaption>1627179006011</figcaption></figure>
<p>启动后，通过浏览器访问 <code v-pre>http://localhost:8080</code>能看到Apache Tomcat的内容就说明Tomcat已经启动成功。</p>
<figure><img src="@source/src/JavaWeb/assets/1627199957728.png" alt="1627199957728" tabindex="0" loading="lazy"><figcaption>1627199957728</figcaption></figure>
<p><mark>注意</mark>: 启动的过程中，控制台有中文乱码，需要修改conf/logging.prooperties</p>
<figure><img src="@source/src/JavaWeb/assets/1627199827589.png" alt="1627199827589" tabindex="0" loading="lazy"><figcaption>1627199827589</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627200509883.png" alt="1627200509883" tabindex="0" loading="lazy"><figcaption>1627200509883</figcaption></figure>
<blockquote>
...
<figure><img src="@source/src/JavaWeb/assets/1627200780590.png" alt="1627200780590" tabindex="0" loading="lazy"><figcaption>1627200780590</figcaption></figure>
</li>
<li>
<p>Tomcat启动的时候，启动窗口一闪而过: 需要检查JAVA_HOME环境变量是否正确配置</p>
</li>
</ul>
<figure><img src="@source/src/JavaWeb/assets/1627201248802.png" alt="1627201248802" tabindex="0" loading="lazy"><figcaption>1627201248802</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627201572748.png" alt="1627201572748" tabindex="0" loading="lazy"><figcaption>1627201572748</figcaption></figure>
<p>但是呢随着项目的增大，项目中的资源也会越来越多，项目在拷贝的过程中也会越来越费时间，该如何解决呢?</p>
</li>
</ul>
</li>
<li>
<p>一般JavaWeb项目会被打包称<mark>war</mark>包，然后将war包放到Webapps目录下，Tomcat会自动解压缩war文件</p>
<ul>
<li>
...
<figure><img src="@source/src/JavaWeb/assets/1627201868752.png" alt="1627201868752" tabindex="0" loading="lazy"><figcaption>1627201868752</figcaption></figure>
</li>
</ul>
</li>
</ul>
...
<figure><img src="@source/src/JavaWeb/assets/1627202865978.png" alt="1627202865978" tabindex="0" loading="lazy"><figcaption>1627202865978</figcaption></figure>
</li>
<li>
<p>开发完成部署的Web项目</p>
<figure><img src="@source/src/JavaWeb/assets/1627202903750.png" alt="1627202903750" tabindex="0" loading="lazy"><figcaption>1627202903750</figcaption></figure>
<ul>
<li>开发项目通过执行Maven打包命令<mark>package</mark>,可以获取到部署的Web项目目录</li>
...
<li>
<p>创建Maven项目</p>
<figure><img src="@source/src/JavaWeb/assets/1627227574092.png" alt="1627227574092" tabindex="0" loading="lazy"><figcaption>1627227574092</figcaption></figure>
</li>
<li>
<p>选择使用Web项目骨架</p>
<figure><img src="@source/src/JavaWeb/assets/1627227650406.png" alt="1627227650406" tabindex="0" loading="lazy"><figcaption>1627227650406</figcaption></figure>
</li>
<li>
<p>输入Maven项目坐标创建项目</p>
<figure><img src="@source/src/JavaWeb/assets/1627228065007.png" alt="1627228065007" tabindex="0" loading="lazy"><figcaption>1627228065007</figcaption></figure>
</li>
<li>
<p>确认Maven相关的配置信息后，完成项目创建</p>
<figure><img src="@source/src/JavaWeb/assets/1627228413280.png" alt="1627228413280" tabindex="0" loading="lazy"><figcaption>1627228413280</figcaption></figure>
</li>
<li>
<p>删除pom.xml中多余内容，只留下面的这些内容，注意打包方式 jar和war的区别</p>
<figure><img src="@source/src/JavaWeb/assets/1627228584625.png" alt="1627228584625" tabindex="0" loading="lazy"><figcaption>1627228584625</figcaption></figure>
</li>
<li>
<p>补齐Maven Web项目缺失的目录结构，默认没有java和resources目录，需要手动完成创建补齐，最终的目录结果如下</p>
<figure><img src="@source/src/JavaWeb/assets/1627228673162.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>
</li>
</ol>
...
<li>
<p>创建Maven项目</p>
<figure><img src="@source/src/JavaWeb/assets/1627229111549.png" alt="1627229111549" tabindex="0" loading="lazy"><figcaption>1627229111549</figcaption></figure>
</li>
<li>
<p>选择不使用Web项目骨架</p>
<figure><img src="@source/src/JavaWeb/assets/1627229137316.png" alt="1627229137316" tabindex="0" loading="lazy"><figcaption>1627229137316</figcaption></figure>
</li>
<li>
<p>输入Maven项目坐标创建项目</p>
<figure><img src="@source/src/JavaWeb/assets/1627229371251.png" alt="1627229371251" tabindex="0" loading="lazy"><figcaption>1627229371251</figcaption></figure>
</li>
<li>
<p>在pom.xml设置打包方式为war,默认是不写代表打包方式为jar</p>
<figure><img src="@source/src/JavaWeb/assets/1627229428161.png" alt="1627229428161" tabindex="0" loading="lazy"><figcaption>1627229428161</figcaption></figure>
</li>
<li>
<p>补齐Maven Web项目缺失webapp的目录结构</p>
<figure><img src="@source/src/JavaWeb/assets/1627229584134.png" alt="1627229584134" tabindex="0" loading="lazy"><figcaption>1627229584134</figcaption></figure>
</li>
<li>
<p>补齐Maven Web项目缺失WEB-INF/web.xml的目录结构</p>
<figure><img src="@source/src/JavaWeb/assets/1627229676800.png" alt="1627229676800" tabindex="0" loading="lazy"><figcaption>1627229676800</figcaption></figure>
</li>
<li>
<p>补充完后，最终的项目结构如下:</p>
<figure><img src="@source/src/JavaWeb/assets/1627229478030.png" alt="1627229478030" tabindex="0" loading="lazy"><figcaption>1627229478030</figcaption></figure>
</li>
</ol>
...
<figure><img src="@source/src/JavaWeb/assets/1627204022604.png" alt="1627204022604" tabindex="0" loading="lazy"><figcaption>1627204022604</figcaption></figure>
<blockquote>
<p>3.掌握不使用骨架的方式创建Maven Web项目</p>
</blockquote>
<figure><img src="@source/src/JavaWeb/assets/1627204076090.png" alt="1627204076090" tabindex="0" loading="lazy"><figcaption>1627204076090</figcaption></figure>
...
<li>
<p>打开添加本地Tomcat的面板</p>
<figure><img src="@source/src/JavaWeb/assets/1627229992900.png" alt="1627229992900" tabindex="0" loading="lazy"><figcaption>1627229992900</figcaption></figure>
</li>
<li>
<p>指定本地Tomcat的具体路径</p>
</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1627230313062.png" alt="1627230313062" tabindex="0" loading="lazy"><figcaption>1627230313062</figcaption></figure>
<ol start="3">
<li>
<p>修改Tomcat的名称，此步骤可以不改，只是让名字看起来更有意义，HTTP port中的端口也可以进行修改，比如把8080改成80</p>
<figure><img src="@source/src/JavaWeb/assets/1627230366658.png" alt="1627230366658" tabindex="0" loading="lazy"><figcaption>1627230366658</figcaption></figure>
</li>
<li>
<p>将开发项目部署项目到Tomcat中</p>
<figure><img src="@source/src/JavaWeb/assets/1627230913259.png" alt="1627230913259" tabindex="0" loading="lazy"><figcaption>1627230913259</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627233265351.png" alt="1627233265351" tabindex="0" loading="lazy"><figcaption>1627233265351</figcaption></figure>
</li>
<li>
<p>启动成功后，可以通过浏览器进行访问测试</p>
<figure><img src="@source/src/JavaWeb/assets/1627232743706.png" alt="1627232743706" tabindex="0" loading="lazy"><figcaption>1627232743706</figcaption></figure>
</li>
<li>
<p>最终的注意事项</p>
<figure><img src="@source/src/JavaWeb/assets/1627232916624.png" alt="1627232916624" tabindex="0" loading="lazy"><figcaption>1627232916624</figcaption></figure>
</li>
</ol>
<p>至此，IDEA中集成本地Tomcat进行项目部署的内容我们就介绍完了，整体步骤如下，大家需要按照流程进行部署操作练习。</p>
<figure><img src="@source/src/JavaWeb/assets/1627205657117.png" alt="1627205657117" tabindex="0" loading="lazy"><figcaption>1627205657117</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1627233963315.png" alt="1627233963315" tabindex="0" loading="lazy"><figcaption>1627233963315</figcaption></figure>
<p><mark>注意:</mark></p>
<ul>
...
<figure><img src="@source/src/JavaWeb/assets/1627234184076.png" alt="1627234184076" tabindex="0" loading="lazy"><figcaption>1627234184076</figcaption></figure>
<ul>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>plugins</span><span class="token punctuation">></span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>plugin</span><span class="token punctuation">></span></span>
            ...
            <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>configuration</span><span class="token punctuation">></span></span>
                ...
                <span class="token comment">&lt;!--解决get方式用url传参的时候的中文乱码问题，此问题仅在tomcat7及以下版本出现--></span>
...
<figure><img src="@source/src/JavaWeb/assets/1627234763207.png" alt="1627234763207" tabindex="0" loading="lazy"><figcaption>1627234763207</figcaption></figure>
<ul>
<li>
...
<figure><img src="@source/src/JavaWeb/assets/1627234972853.png" alt="1627234972853" tabindex="0" loading="lazy"><figcaption>1627234972853</figcaption></figure>
</li>
</ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/demo1"</span><span class="token punctuation">)</span>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>http://localhost:8080/web-demo/demo1
...
<figure><img src="@source/src/JavaWeb/assets/1627236923139.png" alt="1627236923139" tabindex="0" loading="lazy"><figcaption>1627236923139</figcaption></figure>
<ul>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>默认情况，Servlet会在第一次访问被容器创建，但是如果创建Servlet比较耗时的话，那么第一个访问的人等待的时间就比较长，用户的体验就比较差，那么我们能不能把Servlet的创建放到服务器启动的时候来创建，具体如何来配置?
...
<li>
<p><mark>初始化</mark>：在Servlet实例化之后，容器将调用Servlet的<mark>init()<mark>方法初始化这个对象，完成一些如加载配置文件、创建连接等初始化的工作。该方法只</mark>调用一次</mark></p>
</li>
<li>
<p><mark>请求处理</mark>：<mark>每次</mark>请求Servlet时，Servlet容器都会调用Servlet的==service()==方法对请求进行处理。每当tomcat调用共service方法时，都会开启一个新的线程执行内部的所有逻辑。</p>
<blockquote>
<p>service是多线程执行的，所以尽量不要在servlet的成员位置定义变量，然后在service中修改。</p>
</blockquote>
</li>
<li>
<p><mark>服务终止</mark>：当需要释放内存或者容器关闭时，容器就会调用Servlet实例的==destroy()==方法完成资源的释放。在destroy()方法调用之后，容器会释放这个Servlet实例，该实例随后会被Java的垃圾收集器所回收</p>
</li>
</ol>
</li>
<li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><mark>注意:如何才能让Servlet中的destroy方法被执行？</mark></p>
<figure><img src="@source/src/JavaWeb/assets/1627239292226.png" alt="1627239292226" tabindex="0" loading="lazy"><figcaption>1627239292226</figcaption></figure>
</li>
</ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token class-name">ServletConfig</span> config<span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">void</span> <span class="token function">destroy</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>剩下的两个方法是:</p>
<ul>
<li>获取Servlet信息</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> <span class="token function">getServletInfo</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">ServletConfig</span> <span class="token function">getServletConfig</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1627240593506.png" alt="1627240593506" tabindex="0" loading="lazy"><figcaption>1627240593506</figcaption></figure>
<p>因为我们将来开发B/S架构的web项目，都是针对HTTP协议，所以我们自定义Servlet,会通过继承<mark>HttpServlet</mark></p>
<p>具体的编写格式如下:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/demo4"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/demo5"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1627272805178.png" alt="1627272805178" tabindex="0" loading="lazy"><figcaption>1627272805178</figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<p>/aaa</p>
<p>/Aaa     区分大小写</p>
<p>/aaa/bbb/ccc   支持层级目录</p>
<figure><img src="@source/src/JavaWeb/assets/1627273174144.png" alt="1627273174144" tabindex="0" loading="lazy"><figcaption>1627273174144</figcaption></figure>
...
<li>
<p>目录匹配</p>
<p>/aaa/*      路径只要以/aaa/开头即可。后面的*代表任意字符串</p>
<p>/*      所有路径都会匹配</p>
<figure><img src="@source/src/JavaWeb/assets/1627273184095.png" alt="1627273184095" tabindex="0" loading="lazy"><figcaption>1627273184095</figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<li>
<p>扩展名匹配</p>
<p>指定一个固定的扩展名，前面的字符串任意。</p>
</li>
</ul>
<blockquote>
<p><strong>不能</strong>以/开头编写。</p>
</blockquote>
</li>
</ul>
<blockquote>
<figure><img src="@source/src/JavaWeb/assets/1627273194118.png" alt="1627273194118" tabindex="0" loading="lazy"><figcaption>1627273194118</figcaption></figure>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/JavaWeb/assets/1627274483755.png" alt="1627274483755" tabindex="0" loading="lazy"><figcaption>1627274483755</figcaption></figure>
<ol start="2">
<li>如果路径配置的是<code v-pre>*.do</code>,那么在*.do的前面不能加<code v-pre>/</code>,否则会报错</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1627274368245.png" alt="1627274368245" tabindex="0" loading="lazy"><figcaption>1627274368245</figcaption></figure>
<ul>
<li>
<p>任意匹配</p>
<figure><img src="@source/src/JavaWeb/assets/1627273201370.png" alt="1627273201370" tabindex="0" loading="lazy"><figcaption>1627273201370</figcaption></figure>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>beisheng<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>访问路径`<a href="http://localhost:8080/demo-web/%E4%BB%BB%E6%84%8F" target="_blank" rel="noopener noreferrer">http://localhost:8080/demo-web/任意<ExternalLinkIcon/></a></p>
<p>/ 叫做缺省匹配，默认匹配。default。如果有一个请求，请求的路径没有任何一个url-pattern与之匹配，也就是没有一个Servlet接受该请求。那么该请求就会给缺省路径的Servlet处理。所以这样的Servlet在一个项目中最多只能有一个。但是在Tomcat中，自带一个Servlet配置为了/。</p>
<p><mark>注意:</mark><code v-pre>/</code>和<code v-pre>/*</code>的区别?</p>
<ol>
<li>
...
<p><strong>小结</strong></p>
<ol>
<li>urlPattern总共有四种配置方式，分别是精确匹配、目录匹配、扩展名匹配、缺省匹配</li>
<li>五种配置的优先级为 精确匹配 &gt; 目录匹配&gt; 扩展名匹配  &gt; 缺省匹配</li>
</ol>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>web-app</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://xmlns.jcp.org/xml/ns/javaee<span class="token punctuation">"</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-class</span><span class="token punctuation">></span></span>com.beisheng.web.ServletDemo13<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-class</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
