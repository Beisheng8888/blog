<template><div><h1 id="jsp" tabindex="-1"><a class="header-anchor" href="#jsp" aria-hidden="true">#</a> JSP</h1>
...
<p>上图的用户名是动态展示，也就是谁登陆就展示谁的用户名。只用 <code v-pre>servlet</code> 如何实现呢？里已经提供好了一个 <code v-pre>LoginServlet</code> ，该 <code v-pre>servlet</code> 就是实现这个功能的，现将资料中的 <code v-pre>LoginServlet.java</code> 拷贝到 <code v-pre>request-demo</code> 项目中来演示。接下来启动服务器并访问登陆页面</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818102205544.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>输入了 <code v-pre>zhangsan</code> 用户的登陆信息后点击 <code v-pre>登陆</code> 按钮，就能看到如下图效果</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818102313898.png" alt="image-20210818102313898" tabindex="0" loading="lazy"><figcaption>image-20210818102313898</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818102506754.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818103127245.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>重新启动服务器并进行测试，发现也可以实现同样的功能。那么 <code v-pre>login.jsp</code> 又是如何实现的呢？那我们来看看 <code v-pre>login.jsp</code> 的代码</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818103352432.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818104316457.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818105519970.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818110122438.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818111039350.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818112613589.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>打开 <code v-pre>hello_jsp.java</code> 文件，来查看里面的代码</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818112724462.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818113118802.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818114008998.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>以前我们自己写 <code v-pre>servlet</code> 时，这部分代码是由我们自己来写，现在有了 <code v-pre>jsp</code> 后，由tomcat完成这部分功能。</p>
<blockquote>
<p>jsp在第一次被访问的时候，由Tomcat翻译为一个Servlet的java文件，然后编译执行。之后如果jsp的内容不改变，则不会重新编译，仅执行。直到jsp发生改变，又会再下次访问时重新翻译及编译执行。</p>
</blockquote>
...
<p>JSP 脚本有如下三个分类：</p>
<ul>
<li>&lt;%      %&gt;：（代码块）内容会直接放到_jspService()方法之中</li>
<li>&lt;%=    %&gt;：（表达式）内容会放到out.print()中，作为out.print()的参数</li>
<li>&lt;%!     %&gt;：（声明）内容会放到_jspService()方法之外，被类直接包含</li>
</ul>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818123606231.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>在 <code v-pre>hello.jsp</code> 中书写</p>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%=&quot;hello&quot;%&gt;
&lt;%=i%&gt;
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818123820571.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>在 <code v-pre>hello.jsp</code> 中书写</p>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%!
    void  show(){}
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818123946272.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>使用JSP脚本展示品牌数据</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818125203390.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>说明：</p>
<ul>
...
<ul>
<li>
<p>将资料 <code v-pre>资料\1. JSP案例素材</code> 中的 <code v-pre>Brand.java</code> 文件放置到项目的 <code v-pre>com.beisheng.pojo</code> 包下</p>
</li>
<li>
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;table border=&quot;1&quot; cellspacing=&quot;0&quot; width=&quot;800&quot;&gt;
    &lt;tr&gt;
        &lt;th&gt;序号&lt;/th&gt;
        &lt;th&gt;品牌名称&lt;/th&gt;
        &lt;th&gt;企业名称&lt;/th&gt;
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%@ page import=&quot;com.beisheng.pojo.Brand&quot; %&gt;
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818145450748.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818150346332.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol>
<li>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818151232955.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
</li>
<li>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818152536484.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
</li>
</ul>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818152857407.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<h4 id="jsp中注释的写法" tabindex="-1"><a class="header-anchor" href="#jsp中注释的写法" aria-hidden="true">#</a> jsp中注释的写法</h4>
<blockquote>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;!--html注释 --&gt;
&lt;%-- jsp的注释
&lt;%
  //  java的注释
    /**/
...
<h4 id="jsp的指令" tabindex="-1"><a class="header-anchor" href="#jsp的指令" aria-hidden="true">#</a> jsp的指令</h4>
<blockquote>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%--page页面相关参数设置，都在page中。其他属性保持默认即可，isELIgnored一定要手动设置为false，否则在低版本tomcat中，jsp会默认忽略EL表达式--%&gt;
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;c:if test=&quot;${flag == 1}&quot;&gt;
    男
&lt;/c:if&gt;
&lt;c:if test=&quot;${flag == 2}&quot;&gt;
    女
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818153646575.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%@ taglib prefix=&quot;c&quot; uri=&quot;http://java.sun.com/jsp/jstl/core&quot; %&gt;
...
<p><mark>注意：</mark> 在该页面已经要引入 JSTL核心标签库</p>
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;c:forEach items=&quot;${brands}&quot; var=&quot;brand&quot;&gt;
    &lt;tr align=&quot;center&quot;&gt;
        &lt;td&gt;${brand.id}&lt;/td&gt;
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;c:forEach begin=&quot;0&quot; end=&quot;10&quot; step=&quot;1&quot; var=&quot;i&quot;&gt;
    ${i}
&lt;/c:forEach&gt;
...
<ul>
<li>
<p>M：Model，业务模型，处理业务，数据封装</p>
</li>
<li>
<p>V：View，视图，界面展示，用户交互</p>
</li>
<li>
<p>C：Controller，控制器，处理请求，调用模型和视图</p>
</li>
</ul>
<figure><img src="@source/src/JavaWeb/assets/image-20210818163348642.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818164301154.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
<li>数据访问层/持久层/DAO层：对数据库的CRUD基本操作</li>
...
<li>表现层/web层/控制层：接收请求，封装数据，调用业务逻辑层，响应数据</li>
</ul>
...
<ul>
<li>表现层： <code v-pre>com.beisheng.controller</code> 或者 <code v-pre>com.beisheng.web</code></li>
<li>业务逻辑层：<code v-pre>com.beisheng.service</code></li>
<li>数据访问层：<code v-pre>com.beisheng.dao</code> 或者 <code v-pre>com.beisheng.mapper</code></li>
</ul>
<p>后期我们还会学习一些框架，不同的框架是对不同层进行封装的</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210818165439826.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<blockquote>
<p>职责单一原则</p>
</blockquote>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818165808589.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818171702401.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>这个功能我们之前一直在做，而这个案例是将学习的所有的内容（包含 MVC模式 和 三层架构）进行应用，并将整个流程贯穿起来。</p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818173155335.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<h4 id="_8-1-3-创建表" tabindex="-1"><a class="header-anchor" href="#_8-1-3-创建表" aria-hidden="true">#</a> 8.1.3  创建表</h4>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">-- 删除tb_brand表</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Brand</span> <span class="token punctuation">{</span>
    <span class="token comment">// id 主键</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>configuration</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mappers</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>configuration</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 <code v-pre>resources</code> 下创建放置映射配置文件的目录结构 <code v-pre>com/beisheng/mapper</code>，并在该目录下创建映射配置文件 <code v-pre>BrandMapper.xml</code></p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8" ?></span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818174441917.png" alt="image-20210818174441917" tabindex="0" loading="lazy"><figcaption>image-20210818174441917</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818174800783.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>在 <code v-pre>com.beisheng</code> 包下创建 <code v-pre>utils</code> 包，并在该包下创建名为 <code v-pre>SqlSessionFactoryUtils</code> 工具类</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BrandService</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210818182952394.png" alt="image-20210818182952394" tabindex="0" loading="lazy"><figcaption>image-20210818182952394</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819190221889.png" alt="image-20210819190221889" tabindex="0" loading="lazy"><figcaption>image-20210819190221889</figcaption></figure>
<h3 id="_8-3-添加" tabindex="-1"><a class="header-anchor" href="#_8-3-添加" aria-hidden="true">#</a> 8.3  添加</h3>
<figure><img src="@source/src/JavaWeb/assets/image-20210819192049571.png" alt="image-20210819192049571" tabindex="0" loading="lazy"><figcaption>image-20210819192049571</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819192737982.png" alt="image-20210819192737982" tabindex="0" loading="lazy"><figcaption>image-20210819192737982</figcaption></figure>
<p>接下来我们根据流程来实现功能：</p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819220701121.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>点击 <code v-pre>提交</code> 按钮，就能看到如下页面，里面就包含我们刚添加的数据</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210819220738074.png" alt="image-20210819220738074" tabindex="0" loading="lazy"><figcaption>image-20210819220738074</figcaption></figure>
<h3 id="_8-4-修改" tabindex="-1"><a class="header-anchor" href="#_8-4-修改" aria-hidden="true">#</a> 8.4  修改</h3>
<figure><img src="@source/src/JavaWeb/assets/image-20210819223202473.png" alt="image-20210819223202473" tabindex="0" loading="lazy"><figcaption>image-20210819223202473</figcaption></figure>
<p>点击每条数据后面的 <code v-pre>编辑</code> 按钮会跳转到修改页面，如下图：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210819223314230.png" alt="image-20210819223314230" tabindex="0" loading="lazy"><figcaption>image-20210819223314230</figcaption></figure>
<p>在该修改页面我们可以看到将 <code v-pre>编辑</code> 按钮所在行的数据 <mark>回显</mark> 到表单，然后需要修改那个数据在表单中进行修改，然后点击 <code v-pre>提交</code> 的按钮将数据提交到后端，后端再将数据存储到数据库中。</p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819223830713.png" alt="image-20210819223830713" tabindex="0" loading="lazy"><figcaption>image-20210819223830713</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819224243778.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>具体代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/selectByIdServlet"</span><span class="token punctuation">)</span>
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>品牌名称：&lt;input name=&quot;brandName&quot; value=&quot;${brand.brandName}&quot;&gt;&lt;br&gt;
企业名称：&lt;input name=&quot;companyName&quot; value=&quot;${brand.companyName}&quot;&gt;&lt;br&gt;
排序：&lt;input name=&quot;ordered&quot; value=&quot;${brand.ordered}&quot;&gt;&lt;br&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p><code v-pre>textarea</code> 标签要进行数据回显，需要在标签体中使用 <code v-pre>EL表达式</code></p>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>描述信息：&lt;textarea rows=&quot;5&quot; cols=&quot;20&quot; name=&quot;description&quot;&gt;${brand.description} &lt;/textarea&gt;&lt;br&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
...
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>状态：
...
<figure><img src="@source/src/JavaWeb/assets/image-20210819225948187.png" alt="image-20210819225948187" tabindex="0" loading="lazy"><figcaption>image-20210819225948187</figcaption></figure>
<p>在修改页面进行数据修改，点击 <code v-pre>提交</code> 按钮，会将数据提交到后端程序，后端程序会对表中的数据进行修改操作，然后重新进行数据的查询操作。整体流程如下：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210819230242938.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>具体的代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/updateServlet"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UpdateServlet</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><mark>存在问题：update.jsp 页面提交数据时是没有携带主键数据的，而后台修改数据需要根据主键进行修改。</mark></p>
<p>针对这个问题，我们不希望页面将主键id展示给用户看，但是又希望在提交数据时能将主键id提交到后端。此时我们就想到了在学习 HTML 时学习的隐藏域，在 <code v-pre>update.jsp</code> 页面的表单中添加如下代码：</p>
<div class="language-jsp line-numbers-mode" data-ext="jsp"><pre v-pre class="language-jsp"><code>&lt;%--隐藏域，提交id--%&gt;
