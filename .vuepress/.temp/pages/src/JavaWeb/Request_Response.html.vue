<template><div><h2 id="request-response" tabindex="-1"><a class="header-anchor" href="#request-response" aria-hidden="true">#</a> Request&amp;Response</h2>
...
<img src="@source/src/JavaWeb/assets/1628735216156.png" alt="1628735216156" loading="lazy"></p>
<p>此时，我们就需要思考一个问题request和response这两个参数的作用是什么?</p>
<figure><img src="@source/src/JavaWeb/assets/1628735746602.png" alt="1628735746602" tabindex="0" loading="lazy"><figcaption>1628735746602</figcaption></figure>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/demo3"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628738273049.png" alt="1628738273049" tabindex="0" loading="lazy"><figcaption>1628738273049</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628740441008.png" alt="1628740441008" tabindex="0" loading="lazy"><figcaption>1628740441008</figcaption></figure>
<p>从上图中可以看出，ServletRequest和HttpServletRequest都是Java提供的，所以我们可以打开JavaEE提供的API文档[参考: 资料/JavaEE7-api.chm],打开后可以看到:</p>
<figure><img src="@source/src/JavaWeb/assets/1628741839475.png" alt="1628741839475" tabindex="0" loading="lazy"><figcaption>1628741839475</figcaption></figure>
<p>所以ServletRequest和HttpServletRequest是继承关系，并且两个都是接口，接口是无法创建对象，这个时候就引发了下面这个问题:</p>
<figure><img src="@source/src/JavaWeb/assets/1628742224589.png" alt="1628742224589" tabindex="0" loading="lazy"><figcaption>1628742224589</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/demo2"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628743040046.png" alt="1628743040046" tabindex="0" loading="lazy"><figcaption>1628743040046</figcaption></figure>
<p><strong>小结</strong></p>
<ul>
...
<p>HTTP请求数据总共分为三部分内容，分别是<mark>请求行、请求头、请求体</mark>，对于这三部分内容的数据，分别该如何获取，首先我们先来学习请求行数据如何获取?</p>
...
<figure><img src="@source/src/JavaWeb/assets/1628748240075.png" alt="1628748240075" tabindex="0" loading="lazy"><figcaption>1628748240075</figcaption></figure>
<p>对于这三部分内容，request对象都提供了对应的API方法来获取，具体如下:</p>
<ul>
<li>获取请求方式: <code v-pre>GET</code></li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getMethod()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>获取虚拟目录(项目访问路径): <code v-pre>/request-demo</code></li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getContextPath()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>获取URL(统一资源定位符): <code v-pre>http://localhost:8080/request-demo/req1</code></li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>StringBuffer getRequestURL()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>获取URI(统一资源标识符): <code v-pre>/request-demo/req1</code></li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getRequestURI()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>获取请求参数(GET方式): <code v-pre>username=zhangsan&amp;password=123</code></li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getQueryString()
...
<figure><img src="@source/src/JavaWeb/assets/1628762794935.png" alt="1628762794935" tabindex="0" loading="lazy"><figcaption>1628762794935</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628768652535.png" alt="1628768652535" tabindex="0" loading="lazy"><figcaption>1628768652535</figcaption></figure>
<p>所以根据请求头名称获取对应值的方法为:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getHeader(String name)
...
<figure><img src="@source/src/JavaWeb/assets/1628769145524.png" alt="1628769145524" tabindex="0" loading="lazy"><figcaption>1628769145524</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628768665185.png" alt="1628768665185" tabindex="0" loading="lazy"><figcaption>1628768665185</figcaption></figure>
<p>对于请求体中的数据，Request对象提供了如下两种方式来获取其中的数据，分别是:</p>
<ul>
<li>获取字节输入流，如果前端发送的是字节数据，比如传递的是文件数据，则使用该方法</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>ServletInputStream getInputStream()
该方法可以获取字节
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li>获取字符输入流，如果前端发送的是纯文本数据，则使用该方法</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>BufferedReader getReader()
...
<figure><img src="@source/src/JavaWeb/assets/1628770516387.png" alt="1628770516387" tabindex="0" loading="lazy"><figcaption>1628770516387</figcaption></figure>
<p>点击<code v-pre>提交</code>按钮后，就可以在控制台看到前端所发送的请求数据</p>
<figure><img src="@source/src/JavaWeb/assets/1628770585480.png" alt="1628770585480" tabindex="0" loading="lazy"><figcaption>1628770585480</figcaption></figure>
<p><strong>小结</strong></p>
...
<li>请求体
<ul>
<li>注意: <mark>浏览器发送的POST请求才有请求体</mark></li>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/req1"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RequestDemo1</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628776252445.png" alt="1628776252445" tabindex="0" loading="lazy"><figcaption>1628776252445</figcaption></figure>
<ul>
<li>如何解决上述重复代码的问题呢?</li>
</ul>
<figure><img src="@source/src/JavaWeb/assets/1628776433318.png" alt="1628776433318" tabindex="0" loading="lazy"><figcaption>1628776433318</figcaption></figure>
<p>当然，也可以在doGet中调用doPost,在doPost中完成参数的获取和打印,另外需要注意的是，doGet和doPost方法都必须存在，不能删除任意一个。</p>
<p><mark>GET请求和POST请求获取请求参数的方式不一样，在获取请求参数这块该如何实现呢?</mark></p>
<p>要想实现，我们就需要<mark>思考</mark>:</p>
<p>GET请求方式和POST请求方式区别主要在于获取请求参数的方式不一样，是否可以提供一种<mark>统一</mark>获取请求参数的方式，从而<mark>统一</mark>doGet和doPost方法内的代码?</p>
<p>解决方案一:</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/req1"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RequestDemo1</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628778931277.png" alt="1628778931277" tabindex="0" loading="lazy"><figcaption>1628778931277</figcaption></figure>
<p>(2)把获取到的内容进行分割，内容如下:</p>
<figure><img src="@source/src/JavaWeb/assets/1628779067793.png" alt="1628779067793" tabindex="0" loading="lazy"><figcaption>1628779067793</figcaption></figure>
<p>(3)把分割后端数据，存入到一个Map集合中:</p>
<figure><img src="@source/src/JavaWeb/assets/1628779368501.png" alt="1628779368501" tabindex="0" loading="lazy"><figcaption>1628779368501</figcaption></figure>
<p><strong>注意</strong>:因为参数的值可能是一个，也可能有多个，所以Map的值的类型为String数组。</p>
<p>基于上述理论，request对象为我们提供了如下方法:</p>
<ul>
<li>获取所有参数Map集合</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>Map&lt;String,String[]> getParameterMap()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>根据名称获取参数值（数组）</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String[] getParameterValues(String name)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>根据名称获取参数值(单个值)</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>String getParameter(String name)
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/JavaWeb/assets/1628780937599.png" alt="1628780937599" tabindex="0" loading="lazy"><figcaption>1628780937599</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628780965283.png" alt="1628780965283" tabindex="0" loading="lazy"><figcaption>1628780965283</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628781031437.png" alt="1628781031437" tabindex="0" loading="lazy"><figcaption>1628781031437</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628781176434.png" alt="1628781176434" tabindex="0" loading="lazy"><figcaption>1628781176434</figcaption></figure>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class RequestDemo1 extends HttpServlet {
    @Override
...
<figure><img src="@source/src/JavaWeb/assets/1628781419752.png" alt="1628781419752" tabindex="0" loading="lazy"><figcaption>1628781419752</figcaption></figure>
<p>由于格式固定，所以我们可以使用IDEA提供的模板来制作一个Servlet的模板，这样我们后期在创建Servlet的时候就会更高效，具体如何实现:</p>
<p>(1)按照自己的需求，修改Servlet创建的模板内容</p>
<figure><img src="@source/src/JavaWeb/assets/1628781545912.png" alt="1628781545912" tabindex="0" loading="lazy"><figcaption>1628781545912</figcaption></figure>
<p>（2）使用servlet模板创建Servlet类</p>
<figure><img src="@source/src/JavaWeb/assets/1628782117420.png" alt="1628782117420" tabindex="0" loading="lazy"><figcaption>1628782117420</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628784323297.png" alt="1628784323297" tabindex="0" loading="lazy"><figcaption>1628784323297</figcaption></figure>
<p>（4）查看控制台打印内容</p>
<figure><img src="@source/src/JavaWeb/assets/1628784356157.png" alt="1628784356157" tabindex="0" loading="lazy"><figcaption>1628784356157</figcaption></figure>
<p>（5）把req.html页面的请求方式改成post,再次发送请求和中文参数</p>
<figure><img src="@source/src/JavaWeb/assets/1628784425182.png" alt="1628784425182" tabindex="0" loading="lazy"><figcaption>1628784425182</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628829610823.png" alt="1628829610823" tabindex="0" loading="lazy"><figcaption>1628829610823</figcaption></figure>
<p>(1)浏览器通过HTTP协议发送请求和数据给后台服务器（Tomcat)</p>
<p>(2)浏览器在发送HTTP的过程中会对中文数据进行URL<mark>编码</mark></p>
...
<p>(4)后台服务器(Tomcat)接收到<code v-pre>%E5%BC%A0%E4%B8%89</code>后会默认按照<code v-pre>ISO-8859-1</code>进行URL<mark>解码</mark></p>
...
<p>分析完上面的问题后，我们会发现，其中有两个我们不熟悉的内容就是<mark>URL编码</mark>和<mark>URL解码</mark>，什么是URL编码，什么又是URL解码呢?</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1110 0101 1011 1100 1010 0000 1110 0100 1011 1000 1000 1001
...
<figure><img src="@source/src/JavaWeb/assets/1628833310473.png" alt="1628833310473" tabindex="0" loading="lazy"><figcaption>1628833310473</figcaption></figure>
<p>就可以获取张和三分别对应的10进制，然后在使用计算器，选择程序员模式，计算出对应的二进制数据结果:</p>
<figure><img src="@source/src/JavaWeb/assets/1628833496171.png" alt="1628833496171" tabindex="0" loading="lazy"><figcaption>1628833496171</figcaption></figure>
<p>在计算的十六进制结果中，每两位前面加一个%,就可以获取到<code v-pre>%E5%BC%A0%E4%B8%89</code>。</p>
<p>当然你从上面所提供的网站中就已经能看到编码16进制的结果了:</p>
<figure><img src="@source/src/JavaWeb/assets/1628833310474.png" alt="1628833310473" tabindex="0" loading="lazy"><figcaption>1628833310473</figcaption></figure>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>public class URLDemo {
...
<figure><img src="@source/src/JavaWeb/assets/1628846824194.png" alt="1628846824194" tabindex="0" loading="lazy"><figcaption>1628846824194</figcaption></figure>
<p>从上图可以看住，</p>
<ul>
<li>
...
<figure><img src="@source/src/JavaWeb/assets/1628849231208.png" alt="1628849231208" tabindex="0" loading="lazy"><figcaption>1628849231208</figcaption></figure>
...
<p>另外需要说明一点的是<mark>Tomcat8.0之后，已将GET请求乱码问题解决，设置默认的解码方式为UTF-8</mark></p>
<p><strong>小结</strong></p>
<ol>
<li>中文乱码解决方案</li>
</ol>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>request.setCharacterEncoding("UTF-8");
注意:设置的字符集要和页面保持一致
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>通用方式（GET/POST）：需要先解码，再编码</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>new String(username.getBytes("ISO-8859-1"),"UTF-8");
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<ol start="2">
<li>URL编码实现方式:</li>
...
<li>
<p>编码:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>URLEncoder.encode(str,"UTF-8");
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
<li>
<p>解码:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>URLDecoder.decode(s,"ISO-8859-1");
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<h3 id="_2-5-request请求转发" tabindex="-1"><a class="header-anchor" href="#_2-5-request请求转发" aria-hidden="true">#</a> 2.5 Request请求转发</h3>
<ol>
<li><mark>请求转发(forward):一种在服务器内部的资源跳转方式。</mark></li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1628851404283.png" alt="1628851404283" tabindex="0" loading="lazy"><figcaption>1628851404283</figcaption></figure>
<p>(1)浏览器发送请求给服务器，服务器中对应的资源A接收到请求</p>
<p>(2)资源A处理完请求后将请求发给资源B</p>
<p>(3)资源B处理完后将结果响应给浏览器</p>
<p>(4)请求从资源A到资源B的过程就叫<mark>请求转发</mark></p>
<ol start="2">
<li>请求转发的实现方式:</li>
</ol>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>req.getRequestDispatcher("资源B路径").forward(req,resp);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>具体如何来使用，我们先来看下需求:</p>
<figure><img src="@source/src/JavaWeb/assets/1628854783523.png" alt="1628854783523" tabindex="0" loading="lazy"><figcaption>1628854783523</figcaption></figure>
<p>针对上述需求，具体的实现步骤为:</p>
<blockquote>
...
<figure><img src="@source/src/JavaWeb/assets/1628855192876.png" alt="1628855192876" tabindex="0" loading="lazy"><figcaption>1628855192876</figcaption></figure>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>void setAttribute(String name,Object o);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>根据key获取值</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>Object getAttribute(String name);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>根据key删除该键值对</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>void removeAttribute(String name);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>接着上个需求来:</p>
<figure><img src="@source/src/JavaWeb/assets/1628856995417.png" alt="1628856995417" tabindex="0" loading="lazy"><figcaption>1628856995417</figcaption></figure>
<blockquote>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/req5"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">RequestDemo5</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"demo5..."</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>访问<code v-pre>http://localhost:8080/request-demo/req5</code>,就可以在控制台看到如下内容:</p>
<figure><img src="@source/src/JavaWeb/assets/1628857213364.png" alt="1628857213364" tabindex="0" loading="lazy"><figcaption>1628857213364</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628857365153.png" alt="1628857365153" tabindex="0" loading="lazy"><figcaption>1628857365153</figcaption></figure>
</li>
<li>
<p>只能转发到当前服务器的内部资源</p>
...
<p>虽然后台从<code v-pre>/req5</code>转发到<code v-pre>/req6</code>，但是这个<mark>只有一次请求</mark></p>
</li>
</ul>
...
<figure><img src="@source/src/JavaWeb/assets/1628857632899.png" alt="1628857632899" tabindex="0" loading="lazy"><figcaption>1628857632899</figcaption></figure>
<ul>
<li>Request:使用request对象来<mark>获取</mark>请求数据</li>
<li>Response:使用response对象来<mark>设置</mark>响应数据</li>
</ul>
<p>Reponse的继承体系和Request的继承体系也非常相似:</p>
<figure><img src="@source/src/JavaWeb/assets/1628857761317.png" alt="1628857761317" tabindex="0" loading="lazy"><figcaption>1628857761317</figcaption></figure>
...
<p>HTTP响应数据总共分为三部分内容，分别是<mark>响应行、响应头、响应体</mark>，对于这三部分内容的数据，respone对象都提供了哪些方法来进行设置?</p>
<ol>
<li>响应行</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1628858926498.png" alt="1628858926498" tabindex="0" loading="lazy"><figcaption>1628858926498</figcaption></figure>
<p>对于响应头，比较常用的就是设置响应状态码:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>void setStatus(int sc);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="2">
<li>响应头</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1628859051368.png" alt="1628859051368" tabindex="0" loading="lazy"><figcaption>1628859051368</figcaption></figure>
<p>设置响应头键值对：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>void setHeader(String name,String value);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="3">
<li>响应体</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1628859268095.png" alt="1628859268095" tabindex="0" loading="lazy"><figcaption>1628859268095</figcaption></figure>
<p>对于响应体，是通过字符、字节输出流的方式往浏览器写，</p>
<p>获取字符输出流:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>PrintWriter getWriter();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>获取字节输出流</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>ServletOutputStream getOutputStream();
...
<ol>
<li><mark>Response重定向(redirect):一种资源跳转方式。</mark></li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/1628859860279.png" alt="1628859860279" tabindex="0" loading="lazy"><figcaption>1628859860279</figcaption></figure>
<p>(1)浏览器发送请求给服务器，服务器中对应的资源A接收到请求</p>
<p>(2)资源A现在无法处理该请求，就会给浏览器响应一个302的状态码+location的一个访问资源B的路径</p>
<p>(3)浏览器接收到响应状态码为302就会重新发送请求到location对应的访问地址去访问资源B</p>
<p>(4)资源B接收到请求后进行处理并最终给浏览器响应结果，这整个过程就叫<mark>重定向</mark></p>
<ol start="2">
<li>重定向的实现方式:</li>
</ol>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>resp.setStatus(302);
...
<figure><img src="@source/src/JavaWeb/assets/1628861030429.png" alt="1628861030429" tabindex="0" loading="lazy"><figcaption>1628861030429</figcaption></figure>
<p>针对上述需求，具体的实现步骤为:</p>
<blockquote>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/resp1"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/resp2"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628861404699.png" alt="1628861404699" tabindex="0" loading="lazy"><figcaption>1628861404699</figcaption></figure>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>resposne.sendRedirect("/request-demo/resp2")
...
<figure><img src="@source/src/JavaWeb/assets/1628861893130.png" alt="1628861893130" tabindex="0" loading="lazy"><figcaption>1628861893130</figcaption></figure>
</li>
<li>
...
<p>介绍完<mark>请求重定向</mark>和<mark>请求转发</mark>以后，接下来需要把这两个放在一块对比下:</p>
<figure><img src="@source/src/JavaWeb/assets/1628862170296.png" alt="1628862170296" tabindex="0" loading="lazy"><figcaption>1628862170296</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/1628862652700.png" alt="1628862652700" tabindex="0" loading="lazy"><figcaption>1628862652700</figcaption></figure>
...
<p>答案:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>1.超链接，从浏览器发送，需要加
2.表单，从浏览器发送，需要加
3.转发，是从服务器内部跳转，不需要加
4.重定向，是由浏览器进行跳转，需要加。
...
<figure><img src="@source/src/JavaWeb/assets/1628863270545.png" alt="1628863270545" tabindex="0" loading="lazy"><figcaption>1628863270545</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ResponseDemo3</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/JavaWeb/assets/1628863905362.png" alt="1628863905362" tabindex="0" loading="lazy"><figcaption>1628863905362</figcaption></figure>
<ol start="2">
<li>返回一串html字符串，并且能被浏览器解析</li>
</ol>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>PrintWriter writer = response.getWriter();
//content-type，告诉浏览器返回的数据类型是HTML类型数据，这样浏览器才会解析HTML标签
response.setHeader("content-type","text/html");
writer.write("&lt;h1>aaa&lt;/h1>");
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/JavaWeb/assets/1628864140820.png" alt="1628864140820" tabindex="0" loading="lazy"><figcaption>1628864140820</figcaption></figure>
<p>==注意:==一次请求响应结束后，response对象就会被销毁掉，所以不要手动关闭流。</p>
<ol start="3">
<li>返回一个中文的字符串<code v-pre>你好</code>，需要注意设置响应数据的编码为<code v-pre>utf-8</code></li>
</ol>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>//设置响应的数据格式及数据的编码
response.setContentType("text/html;charset=utf-8");
writer.write("你好");
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/JavaWeb/assets/1628864390263.png" alt="1628864390263" tabindex="0" loading="lazy"><figcaption>1628864390263</figcaption></figure>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ResponseDemo4</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/src/JavaWeb/assets/1628864883564.png" alt="1628864883564" tabindex="0" loading="lazy"><figcaption>1628864883564</figcaption></figure>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>//fis:输入流
//os:输出流
IOUtils.copy(fis,os);
...
<p>接下来我们通过两个比较常见的案例，一个是<mark>注册</mark>，一个是<mark>登录</mark>来对学习的内容进行一个实战演练，首先来实现用户登录。</p>
...
<figure><img src="@source/src/JavaWeb/assets/1628865728305.png" alt="1628865728305" tabindex="0" loading="lazy"><figcaption>1628865728305</figcaption></figure>
<ol>
...
<figure><img src="@source/src/JavaWeb/assets/1628866248169.png" alt="1628866248169" tabindex="0" loading="lazy"><figcaption>1628866248169</figcaption></figure>
<ol start="2">
<li>创建db1数据库，创建tb_user表，创建User实体类</li>
</ol>
<p>2.1 将<code v-pre>资料\1. 登陆注册案例\2. MyBatis环境\tb_user.sql</code>中的sql语句执行下:</p>
<figure><img src="@source/src/JavaWeb/assets/1628866403891.png" alt="1628866403891" tabindex="0" loading="lazy"><figcaption>1628866403891</figcaption></figure>
<p>2.2 将<code v-pre>资料\1. 登陆注册案例\2. MyBatis环境\User.java</code>拷贝到com.beisheng.pojo</p>
<figure><img src="@source/src/JavaWeb/assets/1628866560738.png" alt="1628866560738" tabindex="0" loading="lazy"><figcaption>1628866560738</figcaption></figure>
<ol start="3">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>configuration</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mappers</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>configuration</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>4.2 在com.beisheng.mapper包下创建UserMapper接口</p>
...
<p><mark>注意：在resources下创建UserMapper.xml的目录时，要使用/分割</mark></p>
<figure><img src="@source/src/JavaWeb/assets/1628867237329.png" alt="1628867237329" tabindex="0" loading="lazy"><figcaption>1628867237329</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/loginServlet"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/1628867761245.png" alt="1628867761245" tabindex="0" loading="lazy"><figcaption>1628867761245</figcaption></figure>
<p>4.2 如果用户名和密码输入正确，则</p>
<figure><img src="@source/src/JavaWeb/assets/1628867801708.png" alt="1628867801708" tabindex="0" loading="lazy"><figcaption>1628867801708</figcaption></figure>
<p>至此用户的登录功能就已经完成了~</p>
...
<figure><img src="@source/src/JavaWeb/assets/1628867904783.png" alt="1628867904783" tabindex="0" loading="lazy"><figcaption>1628867904783</figcaption></figure>
<ol>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/registerServlet"</span><span class="token punctuation">)</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> resource <span class="token operator">=</span> <span class="token string">"mybatis-config.xml"</span><span class="token punctuation">;</span>
<span class="token class-name">InputStream</span> inputStream <span class="token operator">=</span> <span class="token class-name">Resources</span><span class="token punctuation">.</span><span class="token function">getResourceAsStream</span><span class="token punctuation">(</span>resource<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SqlSessionFactoryUtils</span> <span class="token punctuation">{</span>
