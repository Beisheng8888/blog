<template><div><h1 id="filter-listener-ajax" tabindex="-1"><a class="header-anchor" href="#filter-listener-ajax" aria-hidden="true">#</a> Filter&amp;Listener&amp;Ajax</h1>
<h2 id="filter-listener-ajax-1" tabindex="-1"><a class="header-anchor" href="#filter-listener-ajax-1" aria-hidden="true">#</a> Filter&amp;Listener&amp;Ajax</h2>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823184519509.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>而在访问到这些资源之前可以使过滤器拦截来下，也就是说在访问资源之前会先经过 Filter，如下图</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823184657328.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>拦截器拦截到后可以做什么功能呢？</p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823185720197.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>当我点击该按钮，居然可以看到品牌的数据</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823185932418.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>这显然和我们的要求不符。我们希望实现的效果是用户如果登陆过了就跳转到品牌数据展示的页面；如果没有登陆就跳转到登陆页面让用户进行登陆，要实现这个效果需要在每一个资源中都写上这段逻辑，而像这种通用的操作，我们就可以放在过滤器中进行实现。这个就是<mark>权限控制</mark>，以后我们还会进行细粒度权限控制。过滤器还可以做 <code v-pre>统一编码处理</code>、 <code v-pre>敏感字符处理</code> 等等…</p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823191006878.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
</li>
<li>
<p>配置Filter拦截资源的路径：在类上定义 <code v-pre>@WebFilter</code> 注解。而注解的 <code v-pre>value</code> 属性值 <code v-pre>/*</code> 表示拦截所有的资源</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823191037163.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
</li>
<li>
<p>在doFilter方法中输出一句话，并放行</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823191200201.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<blockquote>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823191855765.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823192353031.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>接下来编写过滤器。过滤器是 Web 三大组件之一，所以我们将 <code v-pre>filter</code> 创建在 <code v-pre>com.beisheng.web.filter</code> 包下，起名为 <code v-pre>FilterDemo</code></p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823193759365.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//放行</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823194830074.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823195434581.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>接下来我们通过代码验证一下，在 <code v-pre>doFilter()</code> 方法前后都加上输出语句，如下</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823195828596.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>同时在 <code v-pre>hello.jsp</code> 页面加上输出语句，如下</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823200028284.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>执行访问该资源打印的顺序是按照我们标记的标号进行打印的话，说明我们上边总结出来的流程是没有问题的。启动服务器访问 <code v-pre>hello.jsp</code> 页面，在控制台打印的内容如下：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210823200202153.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823215835812.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823221222468.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<blockquote>
<p>过滤器链组成：来了一个请求，如果这个请求的路径和多个过滤器的过滤路径都匹配，此时这些过滤器就会组成一个过滤器链，封装为一个对象叫FilterChain。过滤器链中过滤器的顺序，如果是注解配置，和类名排序相关。如果是配置文件配置，和filter-mapping 的顺序一致。</p>
<p>过滤器的执行顺序：chain.doFilter()这个方法，内部会判断当前过滤器链中是否有下一个过滤器节点，如果有，就执行其doFilter方法，如果没有，就放行到目标资源执行</p>
<figure><img src="@source/src/JavaWeb/assets/image-20211222103050565.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
</blockquote>
<p>责任链设计模式：</p>
<p>优点：</p>
<p>各个节点互相独立，解耦性强。</p>
<p>便于维护，随时可以增加或删除节点而不影响整体的执行逻辑</p>
<p>缺点：</p>
<p>链式结构必须从头到尾遍历执行</p>
<p>链式结构容易产生循环调用的死循环节点</p>
<blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// DispatcherType用于指定拦截的请求类型。默认是REQUEST，也就是新请求会被拦截。如果加上FORWARD，则转发的请求也会被拦截。</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823223214525.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>在 <code v-pre>brand-demo</code> 工程创建 <code v-pre>com.beisheng.web.filter</code>  包，在该下创建名为 <code v-pre>LoginFilter</code> 的过滤器</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebFilter</span><span class="token punctuation">(</span><span class="token string">"/*"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823224843179.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823225411925.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//判断访问资源路径是否和登录注册相关</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823230820586.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<blockquote>
<p>ServletContext对象是web中作用范围最大的一个域对象。application域。作用范围是整个web项目。在一个项目中，有且只有一个对象。它在服务器启动项目时创建，每个项目创建一个。在服务器关闭时销毁。</p>
<p>一般我们很少使用这个域对象存储数据。我们一般使用此对象，感知其创建销毁，变相的获取服务器启动和关闭的状态。</p>
<p>该对象可以由Request、Servlet、ServletContextEvent这些对象获取ServletContext。</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//根据一个资源的web路径获取其磁盘绝对路径的方式</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-代码演示" tabindex="-1"><a class="header-anchor" href="#_2-3-代码演示" aria-hidden="true">#</a> 2.3  代码演示</h3>
...
<p><mark>-   <code v-pre>AJAX</code> (Asynchronous JavaScript And XML)：异步的 JavaScript 和 XML。</mark></p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823235114367.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210823235006847.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
<li><strong>异步交互</strong>：可以在<mark>不重新加载整个页面</mark>的情况下，与服务器交换数据并<mark>更新部分网页</mark>的技术，如：搜索联想、用户名是否可用校验，等等…</li>
</ol>
<figure><img src="@source/src/JavaWeb/assets/image-20210824000706401.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>上图所示的效果我们经常见到，在我们输入一些关键字（例如 <code v-pre>奥运</code>）后就会在下面联想出相关的内容，而联想出来的这部分数据肯定是存储在百度的服务器上，而我们并没有看出页面重新刷新，这就是 <mark>更新局部页面</mark> 的效果。再如下图：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210824001015706.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210824001443897.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>​	浏览器页面在发送请求给服务器，在服务器处理请求的过程中，浏览器页面不能做其他的操作。只能等到服务器响应结束后才能，浏览器页面才能继续做其他的操作。</p>
<ul>
<li>
<p>异步发送请求过程如下</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210824001608916.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>在项目的创建 <code v-pre>com.beisheng.web.servlet</code> ，并在该包下创建名为  <code v-pre>AjaxServlet</code> 的servlet</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/ajaxServlet"</span><span class="token punctuation">)</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code> <span class="token keyword">var</span> xhttp<span class="token punctuation">;</span>
...
<li>
<p>发送请求</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//建立连接</span>
...
<li>
<p>获取响应</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhttp<span class="token punctuation">.</span><span class="token function-variable function">onreadystatechange</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210824005956117.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>我们可以通过 <code v-pre>开发者模式</code> 查看发送的 AJAX 请求。在浏览器上按 <code v-pre>F12</code> 快捷键</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210824010247642.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210824010438260.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210824201415745.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>整体流程如下：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210829183854285.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/selectUserServlet"</span><span class="token punctuation">)</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//1. 给用户名输入框绑定 失去焦点事件</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//2. 发送ajax请求</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 获取用户名的值</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xhttp<span class="token punctuation">.</span><span class="token function">open</span><span class="token punctuation">(</span><span class="token string">"GET"</span><span class="token punctuation">,</span> <span class="token string">"http://localhost:8080/ajax-demo/selectUserServlet?username="</span><span class="token operator">+</span>username<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//判断</span>
...
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>js/axios-0.18.0.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>
...
<p><code v-pre>then()</code> 需要传递一个匿名函数。我们将 <code v-pre>then()</code> 中传递的匿名函数称为 <mark>回调函数</mark>，意思是该匿名函数在发送请求时不会被调用，而是在成功响应后调用的函数。而该回调函数中的 <code v-pre>resp</code> 参数是对响应的数据进行封装的对象，通过 <code v-pre>resp.data</code> 可以获取到响应的数据。</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/axiosServlet"</span><span class="token punctuation">)</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>axios<span class="token punctuation">.</span><span class="token function">post</span><span class="token punctuation">(</span><span class="token string">"http://localhost:8080/ajax-demo/axiosServlet"</span><span class="token punctuation">,</span><span class="token string">"username=zhangsan"</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">resp</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token function">alert</span><span class="token punctuation">(</span>resp<span class="token punctuation">.</span>data<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="补充" tabindex="-1"><a class="header-anchor" href="#补充" aria-hidden="true">#</a> 补充：</h4>
<ol>
<li>
<p>promise</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// axios请求发送后，返回一个promise对象。</span>
...
<p>​			主要关注的是data部分，也就是响应回的数据（响应体）。JSON格式的数据，JSON对象。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-json" tabindex="-1"><a class="header-anchor" href="#_5-json" aria-hidden="true">#</a> 5，JSON</h2>
<h3 id="_5-1-概述" tabindex="-1"><a class="header-anchor" href="#_5-1-概述" aria-hidden="true">#</a> 5.1  概述</h3>
<p><mark>概念：<code v-pre>JavaScript Object Notation</code>。JavaScript 对象表示法.</mark></p>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210830232718632.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>大家还记得 <code v-pre>ajax</code> 的概念吗？ 是 <mark>异步的 JavaScript 和 xml</mark>。这里的 xml就是以前进行数据传递的方式，如下：</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>student</span><span class="token punctuation">></span></span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> 变量名 <span class="token operator">=</span> <span class="token string">'{"key":value,"key":value,...}'</span><span class="token punctuation">;</span>
...
<p>示例：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> jsonStr <span class="token operator">=</span> <span class="token string">'{"name":"zhangsan","age":23,"addr":["北京","上海","西安"]}'</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210831223339530.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<ul>
<li><code v-pre>parse(str)</code> ：将 JSON串转换为 js 对象。使用方式是： <mark><code v-pre>var jsObject = JSON.parse(jsonStr);</code></mark></li>
<li><code v-pre>stringify(obj)</code> ：将 js 对象转换为 JSON 串。使用方式是：<mark><code v-pre>var jsonStr = JSON.stringify(jsObject)</code></mark></li>
</ul>
<p>代码演示：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>en<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> jsObject <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token literal-property property">name</span><span class="token operator">:</span><span class="token string">"张三"</span><span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210831104901912.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FastJsonDemo</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210830234803335.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<h3 id="_6-2-查询所有功能" tabindex="-1"><a class="header-anchor" href="#_6-2-查询所有功能" aria-hidden="true">#</a> 6.2  查询所有功能</h3>
<figure><img src="@source/src/JavaWeb/assets/image-20210831085332612.png" alt="image-20210831085332612" tabindex="0" loading="lazy"><figcaption>image-20210831085332612</figcaption></figure>
<p>如上图所示就该功能的整体流程。前后端需以 JSON 格式进行数据的传递；由于此功能是查询所有的功能，前端发送 ajax 请求不需要携带参数，而后端响应数据需以如下格式的 json 数据</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210831090839336.png" alt="image-20210831090839336" tabindex="0" loading="lazy"><figcaption>image-20210831090839336</figcaption></figure>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210831091604457.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p><mark>注意：</mark></p>
<ul>
...
<p>在 <code v-pre>com.beisheng.web</code> 包下创建名为 <code v-pre>SelectAllServlet</code> 的 <code v-pre>servlet</code>，具体的逻辑如下：</p>
<ul>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/selectAllServlet"</span><span class="token punctuation">)</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210831093617083.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p><img src="@source/src/JavaWeb/assets/image-20210831093938057.png" alt="img" loading="lazy"><br>
而表头行是固定的，所以先定义初始值是表头行数据的字符串，如下</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//获取数据</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>tableData <span class="token operator">+=</span> <span class="token string">"\n"</span> <span class="token operator">+</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 设置表格数据</span>
...
<figure><img src="@source/src/JavaWeb/assets/image-20210831100117014.png" alt="image-20210831100117014" tabindex="0" loading="lazy"><figcaption>image-20210831100117014</figcaption></figure>
...
<p>具体的前后端交互的流程如下：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210831100329698.png" alt="image-20210831100329698" tabindex="0" loading="lazy"><figcaption>image-20210831100329698</figcaption></figure>
<p><mark>说明：</mark></p>
<p>前端需要将用户输入的数据提交到后端，这部分数据需要以 json 格式进行提交，数据格式如下：</p>
<figure><img src="@source/src/JavaWeb/assets/image-20210831101234467.png" alt="image-20210831101234467" tabindex="0" loading="lazy"><figcaption>image-20210831101234467</figcaption></figure>
<h4 id="_6-3-1-后端实现" tabindex="-1"><a class="header-anchor" href="#_6-3-1-后端实现" aria-hidden="true">#</a> 6.3.1  后端实现</h4>
<p>在 <code v-pre>com.beisheng.web</code> 包下创建名为 <code v-pre>AddServlet</code> 的 <code v-pre>servlet</code>，具体的逻辑如下：</p>
<ul>
<li>
<p>获取请求参数</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span><span class="token string">"/addServlet"</span><span class="token punctuation">)</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//1. 给按钮绑定单击事件</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 将表单数据转为json</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 获取表单数据</span>
