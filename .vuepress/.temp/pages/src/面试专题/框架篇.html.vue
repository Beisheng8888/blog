...
<figure><img src="@source/src/面试专题/img/image-20210902181639048.png" alt="image-20210902181639048" tabindex="0" loading="lazy"><figcaption>image-20210902181639048</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902182004819.png" alt="image-20210902182004819" tabindex="0" loading="lazy"><figcaption>image-20210902182004819</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902182541925.png" alt="image-20210902182541925" tabindex="0" loading="lazy"><figcaption>image-20210902182541925</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902183232114.png" alt="image-20210902183232114" tabindex="0" loading="lazy"><figcaption>image-20210902183232114</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902183520307.png" alt="image-20210902183520307" tabindex="0" loading="lazy"><figcaption>image-20210902183520307</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902183819984.png" alt="image-20210902183819984" tabindex="0" loading="lazy"><figcaption>image-20210902183819984</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902183943469.png" alt="image-20210902183943469" tabindex="0" loading="lazy"><figcaption>image-20210902183943469</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902184343872.png" alt="image-20210902184343872" tabindex="0" loading="lazy"><figcaption>image-20210902184343872</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902184641623.png" alt="image-20210902184641623" tabindex="0" loading="lazy"><figcaption>image-20210902184641623</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210902185052433.png" alt="image-20210902185052433" tabindex="0" loading="lazy"><figcaption>image-20210902185052433</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210903085238916.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
<li>
...
<figure><img src="@source/src/面试专题/img/image-20210903085454603.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
<li>构造方法的循环依赖如图所示，显然无法用前面的方法解决</li>
</ul>
<figure><img src="@source/src/面试专题/img/image-20210903085906315.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210903091627659.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
<li>思路2
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210903091743366.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
<li>示例1：用 @Lazy 为构造方法参数生成代理</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">App60_1</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">App60_2</span> <span class="token punctuation">{</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">App60_3</span> <span class="token punctuation">{</span>
...
<figure><img src="@source/src/面试专题/img/image-20210903100752165.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>作用是保证单例对象仅被创建一次</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210903100914140.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210903101849924.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p>解决思路如下：</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210903103030877.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210903103628639.png" alt="image-20210903103628639" tabindex="0" loading="lazy"><figcaption>image-20210903103628639</figcaption></figure>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>packag tx<span class="token punctuation">.</span>app<span class="token punctuation">.</span>service<span class="token punctuation">;</span>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">tx<span class="token punctuation">.</span>app<span class="token punctuation">.</span>controller</span><span class="token punctuation">;</span>
...
<figure><img src="@source/src/面试专题/img/image-20210903120436365.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210903120800185.png" alt="image-20210903120800185" tabindex="0" loading="lazy"><figcaption>image-20210903120800185</figcaption></figure>
<ul>
<li>
...
<figure><img src="@source/src/面试专题/img/image-20210903140657163.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210903141017502.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>将 HandlerMethod 连同匹配到的拦截器，生成调用链对象 HandlerExecutionChain 返回</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210903141124911.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>遍历HandlerAdapter 处理器适配器，找到能处理 HandlerMethod 的适配器对象，开始调用</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210903141204799.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p><strong>调用阶段</strong></p>
<ol>
<li>执行拦截器 preHandle</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210903141445870.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
<li>
...
<figure><img src="@source/src/面试专题/img/image-20210903141658199.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>
<p>第 2 步没有异常</p>
<p>① 返回 ModelAndView</p>
...
<figure><img src="@source/src/面试专题/img/image-20210903141749830.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>第 2 步有异常，进入 HandlerExceptionResolver 异常处理流程</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210903141844185.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="5">
<li>
...
<li>下面列出了视频中重点提及的注解，考虑到大部分注解你已经比较熟悉了，仅对个别的作简要说明</li>
</ul>
</blockquote>
