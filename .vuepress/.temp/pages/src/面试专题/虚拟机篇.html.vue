...
<figure><img src="@source/src/面试专题/img/image-20210831165728217.png" alt="image-20210831165728217" tabindex="0" loading="lazy"><figcaption>image-20210831165728217</figcaption></figure>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831170457337.png" alt="image-20210831170457337" tabindex="0" loading="lazy"><figcaption>image-20210831170457337</figcaption></figure>
<p>从这张图学到三点</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831170512418.png" alt="image-20210831170512418" tabindex="0" loading="lazy"><figcaption>image-20210831170512418</figcaption></figure>
<p>从这张图可以学到</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831173130717.png" alt="image-20210831173130717" tabindex="0" loading="lazy"><figcaption>image-20210831173130717</figcaption></figure>
<p>解释：</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831173045700.png" alt="image-20210831173045700" tabindex="0" loading="lazy"><figcaption>image-20210831173045700</figcaption></figure>
<p>解释：</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831173118634.png" alt="image-20210831173118634" tabindex="0" loading="lazy"><figcaption>image-20210831173118634</figcaption></figure>
<p>解释：</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831173148816.png" alt="image-20210831173148816" tabindex="0" loading="lazy"><figcaption>image-20210831173148816</figcaption></figure>
<p>解释：</p>
<ul>
...
<figure><img src="@source/src/面试专题/img/image-20210831173155481.png" alt="image-20210831173155481" tabindex="0" loading="lazy"><figcaption>image-20210831173155481</figcaption></figure>
<blockquote>
<p><em><strong>官方参考文档</strong></em></p>
<ul>
<li><a href="https://docs.oracle.com/en/java/javase/11/tools/java.html#GUID-3B1CE181-CD30-4178-9602-230B800D4FAE" target="_blank" rel="noopener noreferrer">https://docs.oracle.com/en/java/javase/11/tools/java.html#GUID-3B1CE181-CD30-4178-9602-230B800D4FAE<ExternalLinkIcon/></a></li>
</ul>
</blockquote>
...
<p>标记清除法</p>
<figure><img src="@source/src/面试专题/img/image-20210831211008162.png" alt="image-20210831211008162" tabindex="0" loading="lazy"><figcaption>image-20210831211008162</figcaption></figure>
<p>解释：</p>
<ol>
...
<p>标记整理法</p>
<figure><img src="@source/src/面试专题/img/image-20210831211641241.png" alt="image-20210831211641241" tabindex="0" loading="lazy"><figcaption>image-20210831211641241</figcaption></figure>
<p>解释：</p>
<ol>
...
<p>标记复制法</p>
<figure><img src="@source/src/面试专题/img/image-20210831212125813.png" alt="image-20210831212125813" tabindex="0" loading="lazy"><figcaption>image-20210831212125813</figcaption></figure>
<p>解释：</p>
<ol>
...
<figure><img src="@source/src/面试专题/img/image-20210831213622704.png" alt="image-20210831213622704" tabindex="0" loading="lazy"><figcaption>image-20210831213622704</figcaption></figure>
<ol start="2">
<li>当伊甸园内存不足，标记伊甸园与 from（现阶段没有）的存活对象</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213640110.png" alt="image-20210831213640110" tabindex="0" loading="lazy"><figcaption>image-20210831213640110</figcaption></figure>
<ol start="3">
<li>将存活对象采用复制算法复制到 to 中，复制完毕后，伊甸园和 from 内存都得到释放</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213657861.png" alt="image-20210831213657861" tabindex="0" loading="lazy"><figcaption>image-20210831213657861</figcaption></figure>
<ol start="4">
<li>将 from 和 to 交换位置</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213708776.png" alt="image-20210831213708776" tabindex="0" loading="lazy"><figcaption>image-20210831213708776</figcaption></figure>
<ol start="5">
<li>经过一段时间后伊甸园的内存又出现不足</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213724858.png" alt="image-20210831213724858" tabindex="0" loading="lazy"><figcaption>image-20210831213724858</figcaption></figure>
<ol start="6">
<li>标记伊甸园与 from（现阶段没有）的存活对象</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213737669.png" alt="image-20210831213737669" tabindex="0" loading="lazy"><figcaption>image-20210831213737669</figcaption></figure>
<ol start="7">
<li>将存活对象采用复制算法复制到 to 中</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213804315.png" alt="image-20210831213804315" tabindex="0" loading="lazy"><figcaption>image-20210831213804315</figcaption></figure>
<ol start="8">
<li>复制完毕后，伊甸园和 from 内存都得到释放</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213815371.png" alt="image-20210831213815371" tabindex="0" loading="lazy"><figcaption>image-20210831213815371</figcaption></figure>
<ol start="9">
<li>将 from 和 to 交换位置</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831213826017.png" alt="image-20210831213826017" tabindex="0" loading="lazy"><figcaption>image-20210831213826017</figcaption></figure>
<ol start="10">
...
<figure><img src="@source/src/面试专题/img/image-20210831215016566.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
<li>该对象的引用已经处理完成，用黑色表示，黑色引用的对象变为灰色</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215033510.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>依次类推</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215105280.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>沿着引用链都标记了一遍</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215146276.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="5">
<li>最后为标记的白色对象，即为垃圾</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215158311.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p><strong>并发漏标问题</strong></p>
<p>比较先进的垃圾回收器都支持<strong>并发标记</strong>，即在标记过程中，用户线程仍然能工作。但这样带来一个新的问题，如果用户线程修改了对象引用，那么就存在漏标问题。例如：</p>
<ol>
<li>如图所示标记工作尚未完成</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215846876.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
<li>用户线程同时在工作，断开了第一层 3、4 两个对象之间的引用，这时对于正在处理 3 号对象的垃圾回收线程来讲，它会将 4 号对象当做是白色垃圾</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215904073.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>但如果其他用户线程又建立了 2、4 两个对象的引用，这时因为 2 号对象是黑色已处理对象了，因此垃圾回收线程不会察觉到这个引用关系的变化，从而产生了漏标</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831215919493.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>如果用户线程让黑色对象引用了一个新增对象，一样会存在漏标问题</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831220004062.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210831222639754.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
<li>创建了一些对象，挑出一些空闲区域作为伊甸园区存储这些对象</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222653802.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>当伊甸园需要垃圾回收时，挑出一个空闲区域作为幸存区，用复制算法复制存活对象，需要暂停用户线程</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222705814.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>复制完成，将之前的伊甸园内存释放</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222724999.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="5">
<li>随着时间流逝，伊甸园的内存又有不足</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222737928.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="6">
<li>将伊甸园以及之前幸存区中的存活对象，采用复制算法，复制到新的幸存区，其中较老对象晋升至老年代</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222752787.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="7">
<li>释放伊甸园以及之前幸存区的内存</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222803281.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<p><strong>G1 回收阶段 - 并发标记与混合收集</strong></p>
<ol>
<li>当老年代占用内存超过阈值后，触发并发标记，这时无需暂停用户线程</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222813959.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="2">
...
<figure><img src="@source/src/面试专题/img/image-20210831222828104.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="3">
<li>混合收集阶段中，参与复制的有 eden、survivor、old，下图显示了伊甸园和幸存区的存活对象复制</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222841096.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="4">
<li>下图显示了老年代和幸存区晋升的存活对象的复制</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222859760.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
<ol start="5">
<li>复制完成，内存得到释放。进入下一轮的新生代回收、并发标记、混合收集</li>
</ol>
<figure><img src="@source/src/面试专题/img/image-20210831222919182.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<p>下面面试题的回答是错误的</p>
<figure><img src="@source/src/面试专题/img/image-20210901110910016.png" alt="image-20210901110910016" tabindex="0" loading="lazy"><figcaption>image-20210901110910016</figcaption></figure>
<p>错在哪了？</p>
<ul>
<li>
...
<figure><img src="@source/src/面试专题/img/image-20210901111903574.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210901111957328.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210901112107707.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210901112157901.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>
...
<figure><img src="@source/src/面试专题/img/image-20210901121032813.png" alt="image-20210901121032813" tabindex="0" loading="lazy"><figcaption>image-20210901121032813</figcaption></figure>
<ol start="3">
...
<figure><img src="@source/src/面试专题/img/image-20210901122228916.png" alt="image-20210901122228916" tabindex="0" loading="lazy"><figcaption>image-20210901122228916</figcaption></figure>
<ol start="6">
