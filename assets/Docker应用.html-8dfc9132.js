import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as s,e}from"./app-09f7810b.js";const i={},t=e(`<h1 id="docker应用篇" tabindex="-1"><a class="header-anchor" href="#docker应用篇" aria-hidden="true">#</a> Docker应用篇</h1><p>启动docker</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl start <span class="token function">docker</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28),l=[t];function p(c,r){return n(),s("div",null,l)}const u=a(i,[["render",p],["__file","Docker应用.html.vue"]]);export{u as default};
